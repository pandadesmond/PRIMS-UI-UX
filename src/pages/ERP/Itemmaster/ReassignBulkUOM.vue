...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignBULK_UOM = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignBULK_UOM', dispatch_response_reassignBULK_UOM);
        var status = dispatch_response_reassignBULK_UOM.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignBULK_UOM.response.detail;
          console.log('results_Reassign_bulkuom', results);
          for(var index in results)
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignBULK_UOM.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignBULK_UOM.response.detail
            }
        };

        this.results = dispatch_response_reassignBULK_UOM.response.detail;
