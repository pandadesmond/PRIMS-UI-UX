<template>
          ...
          <div class="card_section_two card_section_second_content col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="q-pr-xs row items-center" style="padding-bottom: 24px;">
              ...
              <div class="div-container col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 " align="right">
                  <Button_icon :flat="false" :font_color="'white'" :color="'#1E90FF'" :text="page_function == 'Itemmaster' ? $language('D0204') : ''" :outline="false" size="16px"
                   v-on:receiveClick="handleShowCreateItemMaster" icon="add" :border_radius="'8px'" :hoverColor="'linear-gradient(0deg, rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), #1E90FF'" padding='6px' style="width:120px;height:42px" class="bold-font"/>
    ...
    <div class="container_top col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center" style="padding: 8px; font-size: 10px ; color:#757575; font-weight:700;  ">
