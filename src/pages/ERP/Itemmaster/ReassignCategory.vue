...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignCategory = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignCategory', dispatch_response_reassignCategory);
        var status = dispatch_response_reassignCategory.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignCategory.response.detail;
          console.log('results_Reassign_Category', results);
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignCategory.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignCategory.response.detail
            }
        };

        this.results = dispatch_response_reassignCategory.response.detail;
