                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right: 10px; padding-top: 10px;">
                        ...
                        <LabelSelectVerticalGeneral
                          ...
                          :pass_label_value="'Category From'"
                          v-on:receiveChange="handleChange"
      ...
      <q-card-actions class="dialog_action justify-between" style="padding-bottom: 10px;">
        <span class="q-pl-xs">
          ...
          <span class="q-pl-xs">
              ...
              v-on:receiveClick="handleCreateReassignUOM"/>
          </span>
      ...
      var payload = {
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
            ...
            "TransType": "Category",
            "TransGuid": this.$route.query.TransGuid,
        },
      }

      var object_pass = {
          "dispatch": 'itemmaster/trigger_post_get_req_chg_category_c',
          "getter": 'itemmaster/get_req_chg_category_c',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_get_req_chg_category_c = await this.$dispatch(object_pass);
        var status = dispatch_response_get_req_chg_category_c.status

        if(status){
          this.json.RefNo = dispatch_response_get_req_chg_category_c.response.detail[0].RefNo,
          this.json.Category_From = dispatch_response_get_req_chg_category_c.response.detail[0].Category_From,
          this.json.Category_To = dispatch_response_get_req_chg_category_c.response.detail[0].Category_To,
          this.EffectiveDate = dispatch_response_get_req_chg_category_c.response.detail[0].EffectiveDate,
          this.json.send_by = dispatch_response_get_req_chg_category_c.response.detail[0].send_by,
          this.json.send_at = dispatch_response_get_req_chg_category_c.response.detail[0].send_at,
          this.json.approved_by = dispatch_response_get_req_chg_category_c.response.detail[0].approved_by,
          this.json.approved_at = dispatch_response_get_req_chg_category_c.response.detail[0].approved_at,
          this.json.posted_by = dispatch_response_get_req_chg_category_c.response.detail[0].posted_by,
          this.json.posted_at = dispatch_response_get_req_chg_category_c.response.detail[0].posted_at
        }
    },
    async handleCreateReassignUOM(){
