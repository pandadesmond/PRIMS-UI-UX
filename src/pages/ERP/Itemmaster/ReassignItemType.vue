...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignItemType = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignItemType', dispatch_response_reassignItemType);
        var status = dispatch_response_reassignItemType.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignItemType.response.detail;
          console.log('results_Reassign_itemtype', results);
          for(var index in results)
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignItemType.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignItemType.response.detail
            }
        };

        this.results = dispatch_response_reassignItemType.response.detail;
