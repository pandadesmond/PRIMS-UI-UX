                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeSendBy"
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeApprovedBy"
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Datepicker
                                ...
                                :disable="false"
                                :autoclose="true"
                                v-on:receiveChange="handleChangeApprovedAt"
                                :daterange="json.approved_at"
                                :componentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangePostedBy"
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Datepicker
                                ...
                                :disable="false"
                                :autoclose="true"
                                v-on:receiveChange="handleChangePostedAt"
                                :daterange="json.posted_at"
                                :componentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
