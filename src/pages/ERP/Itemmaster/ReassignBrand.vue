...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignBrand = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignBrand', dispatch_response_reassignBrand);
        var status = dispatch_response_reassignBrand.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignBrand.response.detail;
          console.log('results_Reassign_brand', results);
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignBrand.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignBrand.response.detail
            }
        };

        this.results = dispatch_response_reassignBrand.response.detail;
