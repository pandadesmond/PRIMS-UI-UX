  ...
  <div v-if="$q.screen.width > 599" class="card_sides">
    ...
    <q-card style="max-height: 100%;">
      ...
      <q-card-section class="theme_color dialog_header header_top">
        ...
        <div v-if="page_function == 'CreateItemmaster'" class="text-subtitle1 header_text">{{ this.$language('D0202') }}</div>
        <div v-if="page_function == 'EditItemmaster'" class="text-subtitle1 header_text">
          {{ this.$language('D0202') }}<br>
          <span class="text-caption">
            {{ this.$language('D0203') }} : {{ json.Itemcode }} | Department: {{ json.Dept }} | Sub-Department: {{json.SubDept}} | Category: {{json.Category}}<br>
          </span>
        </div>
      </q-card-section>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <div class="row dialog_separator">
                        ...
                        <!-- <div v-if="page_function == 'CreateItemmaster'" dir="rtl" class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 input_wrapper_right">
                          <Button_icon :flat="true" :font_color="'white'" :color="'#094161'" :icon="'search'" :outline="false" size="13px"
                          v-on:receiveClick="searchItemCode" style="margin-top: -2px;" :tooltip_message="json.vendor_code != '' && json.vendor_code != null ? 'Search Item Code' : 'Select Supplier First'" :disable="json.vendor_code != '' && json.vendor_code != null ? false : true"/>
                        </div> -->
                        ...
                        <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :readonly="false"
                              v-on:change="handleChange"
                              v-model="json.Category"
                              :dbComponentBehavior="dbComponentBehavior ? page_function == 'CreateItemmaster' ? dbComponentBehavior.text_right_readonly : dbComponentBehavior.text_right : oridbComponentBehavior.text" /> -->
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :no_label="false"
                              label="Size"
                              :readonly="json.BillStatus==1 ? true : page_function == 'CreateItemmaster'"
                              v-on:change="handleChange"
                              v-model="json.Size"
                              :dbComponentBehavior="dbComponentBehavior ? page_function == 'CreateItemmaster' ? dbComponentBehavior.text_right_readonly :  dbComponentBehavior.text_right : oridbComponentBehavior.text" /> -->
                            </div>
  ...
  <div v-else class="card_sides">
    <q-card style="min-height: 100vh;">
      <q-card-section class="header_top">
        ...
        <div v-if="page_function == 'CreateItemmaster'" class="text-subtitle1 header_text" style="padding-top: 10px;">Item Master</div>
        <div v-if="page_function == 'EditItemmaster'" class="text-subtitle1 header_text">Item Master
        <br>Item Code: {{ json.Itemcode }}</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                        ...
                        <div :class="page_function == 'CreateItemmaster' ? 'col-xs-12 col-sm-10 col-md-5 col-lg-5 col-xl-5' : 'col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4'" class="input_wrapper_right">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :autofocusclick="true"
                              :no_label="true"
                              :readonly="page_function !== 'EditItemmaster' &&json.vendor_code != '' && json.vendor_code != null ?  false : true"
                              v-on:change="handleChange"
                              v-model="json.Itemcode"
                              :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                      ...
                      <div class="row dialog_separator">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">UOM</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="false"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 input_wrapper_right">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Ctn Qty</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Category</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                                    :readonly="false"
                        ...
                        <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Manufacturer</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                                  :readonly="false"
                        ...
                        <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Brand</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                                      :readonly="false"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Origin</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="false"
                        ...
                        <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Points</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Size</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="false"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Item Type</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="false"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Yield Ratio</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Old Code</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                                :autofocusclick="true"
    ...
    <div v-if="json.step == 1 || json.step == 3" class="dialog_action_bottom" :style="page_function == 'EditItemmaster' ? 'height: 65px;' : 'height: 40px;'">
    ...
    <div v-if="json.step == 2" class="dialog_action_bottom" :style="page_function == 'EditItemmaster' && json.BillStatus== 0  ? 'height: 65px;' : 'height: 40px;'">
      ...
      <div  v-if="json.BillStatus == 0" class="row q-py-xs">
    ...
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
          <div v-if="!edit_child" class="text-subtitle1 header_text" style="margin-top: 5px;">Purchase Order Detail<br></div>
          <div v-else class="text-subtitle1 header_text" style="margin-top: 5px;">Edit Purchase Order Detail<br></div>
        </div>
  ...
  <q-dialog v-model="show_barcode_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    ...
    <q-card v-else style="width: 350px; max-width: 60vw; margin-top: 5%;">
      ...
      <q-card-section class="upload_container">
        <q-form ref="save_edit_pochild_form">
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="row dialog_separator">
                         <div v-if="edit_barcode" class="col-xs-6 col-sm-3 col-md-12 col-lg-12 col-xl-12 four_column_left" :class="!edit_child ? 'two_column_left': ''">
                            <div class="row dialog_separator">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <Input
                                :autofocusclick="true"
                          ...
                          <div class="col-xs-6 col-sm-3 col-md-12 col-lg-12 col-xl-12 four_column_left" :class="!edit_child ? 'two_column_left': ''">
                            <div class="row dialog_separator">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <Input
                                :autofocusclick="true"
      ...
      <q-card-actions class="dialog_action" style="padding-left: 20px;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
            <Button_icon  :readonly="false" :flat="true" :font_color="'white'" :color="'#094161'" :text="'ADD'" :outline="false" size="15px"
...
export default{
  ...
  async created () {
    ...
    var supcus = await this.getSupcus(Spayload);
    var um = await this.getUM(payload);
    var dept = await this.getDepartment(payloadDept);

    var manufacturer = await this.getManufacturer(payloadDept)
    var origin_results = await this.getOrigin(payload)
    var variant   = await this.getVariant(payloadVariant)
    var item_size = await this.getItemSize(payloadSize)
    var item_type_results = await this.getItemType(payload)
    var price_type_results = await this.getPriceType(ppayload)
    var um_results = um.detail
   // console.log('um_results',um_results)
    var supcus_results = supcus.data;
    var dept_results =dept.detail ;
    var variant_results   = variant.detail
 ...
 //   console.log('dept_results',dept_results)
  ...
  item_size_list.sort((a, b) => (a.value < b.value ? -1 : 1));
    ...
    if(this.page_function == 'EditItemmaster')
    {
      ...
      var payloadManufacturer = {
          skip: 0,
          limit: 99999999,
          MCode: manufacturer_code,
          language : 'EN'
      }
      ...
      var brand = await this.getBrand(payloadManufacturer)
      ...
      for(var i in category_results)
      {
        ...
        category_description.push(obj1);
      }
    ...
    for(var i in brand_results)
    {
      ...
      this.category_options = category_description

      var filtered_transmain = data.response;
     // filtered_transmain.weighing_chk = 0
     // filtered_transmain.hamper = 0
    //  filtered_transmain.serial_no = 0
   //   filtered_transmain.no_promotion = 0
   //   filtered_transmain.symbol_prc  = ""
  ...
  methods: {
    ...
    async handleChangeCalculation(type)
    {
      ...
      this.json.carton_cost = (Number(carton_cost)).toFixed(2);
      this.json.carton_price = (Number(carton_cost)).toFixed(2);

      // var carton_price = this.json.carton_price ? this.json.carton_price : 0;

      //all need to add in auto change fixed decimals 2

      var carton_qty = this.json.carton_qty ? this.json.carton_qty : 0;
      ...
      var selling_price_each_unit = this.json.selling_price_each_unit ? this.json.selling_price_each_unit : 0;
      ...
      // {
        ...
        var after_margin = Number(price_after_tax) * (1+(Number(margin)/100));
console.log(price_after_tax);
console.log((1+(Number(margin)/100)));
console.log(after_margin);
//put readonly to certain field
        if(rounding > 0)
        {
      ...
      async handleModifyItemcode(){
        ...
        if(!this.search_supplier)
        {
          ...
          this.showAddLoading = true;
          this.edit_child = false;
       //   this.json.Itemcode = this.selected_row.Itmecode
      ...
      table_function(payload){
          ...
          this.$nextTick(async ()=>{
            ...
            {
              data = await this.getBarcode(payload);
      ...
      async handleAddBarcode(){
        ...
        await this.$store.dispatch('itemmaster/trigger_update_barcode', payload).then(() => {
          ...
          else
          {
            ...
            console.log('jsonBarcode',this.jsonBarcode);
