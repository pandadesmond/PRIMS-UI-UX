...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignPriceType = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignPriceType', dispatch_response_reassignPriceType);
        var status = dispatch_response_reassignPriceType.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignPriceType.response.detail;
          console.log('results_Reassign_pricetype', results);
          for(var index in results)
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignPriceType.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignPriceType.response.detail
            }
        };

        this.results = dispatch_response_reassignPriceType.response.detail;
