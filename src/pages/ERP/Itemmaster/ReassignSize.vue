...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignSize = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignSize', dispatch_response_reassignSize);
        var status = dispatch_response_reassignSize.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignSize.response.detail;
          console.log('results_Reassign_size', results);
          for(var index in results)
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignSize.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignSize.response.detail
            }
        };

        this.results = dispatch_response_reassignSize.response.detail;
