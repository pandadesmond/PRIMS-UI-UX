<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateItemmaster' ? 'chip-container_2' : 'chip-container_1'">
      ...
      <!-- <Chip :icon="'chevron_left'" :square="true" :label="'Edit IM' +' / '+json.Itemcode" text-color="grey-10" class="chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/> -->
       <div class="text-subtitle1 header_text">
          Edit Item Master/{{json.Itemcode}}
          <!-- Item Master -->
        </div>
...
<!-- {{last_enter_field}} -->
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="justify-center col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2 " style="text-align: right;align-content: end"> 
        <div class="justify-center items-center" style="padding-right: 10px">
          <q-btn-group> 
            <q-btn-dropdown auto-close rounded color="primary" label="Action" split size="12px" no-caps>
              <!-- dropdown content goes here -->
              <q-list>
                <q-item clickable style="padding: 0px">                        
                    <q-btn flat no-caps :label="'Post'" color="primary" @click="handlePostTransmain" style="width: 100%" />
                </q-item>
                <q-separator  />
                <q-item clickable style="padding: 0px">                        
                    <q-btn flat :label="'Unpost'" color="primary" @click="handlePostTransmain" no-caps style="width: 100%"/>
                </q-item>
              </q-list>
            </q-btn-dropdown>
          </q-btn-group>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <!-- <q-input class="new_input" outlined v-model="json.ItemLink" :dense="dense" /> -->
                            <Input v-model:pass_value="json.Itemcode" v-on:receiveChange="handleChangeItemcode" :dbComponentBehavior="dbComponentBehavior.number"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            ...
                            <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChangeBarcode" :dbComponentBehavior="dbComponentBehavior.text_right"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <Input v-model:pass_value="json.PackSize" v-on:receiveChange="handleChangePackSize" :dbComponentBehavior="dbComponentBehavior.text_right"/>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-left: 3px;">
                            ...
                            <Input v-model:pass_value="json.UM" v-on:receiveChange="handleChangePackSize" :dbComponentBehavior="dbComponentBehavior.text_right"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            ...
                            <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChangeStatus" :dbComponentBehavior="dbComponentBehavior.text"/>
                          </div>
                        </div>
                    </div>
                  ...
                  <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <!-- <q-input class="new_input" outlined v-model="json.Itemcode" :dense="dense" /> -->
                            <Input v-model:pass_value="json.Itemcode" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text_right"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            ...
                            <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text_right"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <!-- <q-input class="new_input" outlined v-model="pending_wording" :dense="dense" /> -->
                            <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text"/>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-left: 3px;">
                            <!-- <q-input class="new_input" outlined v-model="pending_wording" :dense="dense" /> -->
                            <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text"/>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            ...
                            <Input v-model:pass_value="json.ItemType" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text"/>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div style="width: 83.6%;" >
                            <!-- <q-input class="new_input" outlined v-model="pending_wording" :dense="dense" /> -->
                            <Input v-model:pass_value="json.Description" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text_desc"/>
                          </div>
                        </div>
                    </div>
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            <div class="row">
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text" style="border-top-right-radius: 0px;"/>
                              </div>
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-left: 3px;">
                                <!-- <q-input class="new_input" outlined v-model="pending_wording" :dense="dense" /> -->
                                <Input v-model:pass_value="pending_wording" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text"/>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            ...
                            <Input v-model:pass_value="json.price_type" v-on:receiveChange="handleChange" :dbComponentBehavior="dbComponentBehavior.text"/>
                          </div>
                        </div>
                    </div>
                  ...
                  <q-tab-panel name="Information" style="padding: 0px; padding-top: 10px; color: grey" class="no-scroll">
                    ...
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection('Basic')" no-caps square dense :class="[active_section == 'Basic' ? 'active_section_button' : 'inactive_section_button' ]">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection('Additional')" no-caps unelevated square dense push label="Additional" :class="[active_section == 'Additional' ? 'active_section_button' : 'inactive_section_button' ]" />

                        <q-btn @click="handleActiveClickSection('Barcode')" no-caps unelevated square dense push label="Barcode" :class="[active_section == 'Barcode' ? 'active_section_button' : 'inactive_section_button' ]"/>

                        <q-btn @click="handleActiveClickSection('Attribute')" no-caps unelevated square dense push label="Attribute" :class="[active_section == 'Attribute' ? 'active_section_button' : 'inactive_section_button' ]"/>

                        <q-btn @click="handleActiveClickSection('Miscellaneous')" no-caps unelevated square dense push label="Miscellaneous" :class="[active_section == 'Miscellaneous' ? 'active_section_button' : 'inactive_section_button' ]"/>

                        <q-btn @click="handleActiveClickSection('Parent & Child')" no-caps unelevated square dense push label="Parent & Child" :class="[active_section == 'Parent & Child' ? 'active_section_button' : 'inactive_section_button' ]"/>

                        <q-btn @click="handleActiveClickSection('Assortment')" no-caps unelevated square dense push label="Assortment" :class="[active_section == 'Assortment' ? 'active_section_button' : 'inactive_section_button' ]"/> -->
                    ...
                    <div class="row" v-if="active_section == 'Basic'">
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangePriceExcTax"
                              :dbComponentBehavior="dbComponentBehavior.number"
                              label="test"
                            />
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangeSellingPrice"
                              :dbComponentBehavior="dbComponentBehavior.number"
                              label="test"
                            />
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangePending_wording"
                              :dbComponentBehavior="dbComponentBehavior.number"
                              label="test"
                            />
                          </div>
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangeListedCost"
                              :dbComponentBehavior="dbComponentBehavior.text_right"
                              label="test"
                            />
                          </div>

                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-left: 3px;">
                            <!-- <b>GP %</b>
                            <q-input class="new_input" outlined v-model="pending_wording" :dense="dense" input-class="text-right"/> -->
                            ...
                            <LabelInputVerticalGeneral
                              v-model:pass_value="pending_wording"
                              :pass_label_value="'GP %'"
                              v-on:receiveChange="handleReceiveChangeGP"
                              :dbComponentBehavior="dbComponentBehavior.text_right"
                              label="test"
                            />
                          </div>
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangeMovingAvgCost"
                              :dbComponentBehavior="dbComponentBehavior.text_right"
                              label="test"
                            />
                          </div>
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangeLastGRCost"
                              :dbComponentBehavior="dbComponentBehavior.text_right"
                              label="test"
                            />
                          </div>
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <LabelInputVerticalGeneral
                              ...
                              v-on:receiveChange="handleReceiveChangeFIFOCost"
                              :dbComponentBehavior="dbComponentBehavior.number"
                              label="test"
                            />
                          </div>
                      ...
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom: 10px; padding-right: 10px;">
                        <div class="row" style="align-items: center;">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <!-- <b>Manufacturer</b>
                            <q-input class="new_input" outlined v-model="json.Manufacturer" :dense="dense" /> -->
                            <LabelInputVerticalGeneral
                    ...
                    <div class="row" v-if="active_section == 'Additional'">
...
<!-- 
                      ...
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom: 10px;">
                        <div class="row" style="height: 100%;">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <b>Remark</b>
                            <q-input class="new_input_custom" outlined v-model="pending_wording" :dense="dense" />
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <b>label Info</b>
                            <q-input class="new_input_custom" outlined v-model="json.Itemcode" :dense="dense" />
                            <!-- <LabelInputVerticalGeneral
                              v-model:pass_value="pending_wording"
                    ...
                    <div class="row" v-if="active_section == 'Barcode'">
                  ...
                  <q-tab-panel name="Configuration" style="padding: 0px; padding-top: 10px; color: grey">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection2('Status')" no-caps square dense :class="[active_section2 == 'Status' ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                          Status
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection2('Item Type')" no-caps unelevated square dense push label="Item Type" :class="[active_section2 == 'Item Type' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection2('Price Type')" no-caps unelevated square dense push label="Price Type" :class="[active_section2 == 'Price Type' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection2('Restriction')" no-caps unelevated square dense push label="Restriction" :class="[active_section2 == 'Restriction' ? 'active_section_button' : 'inactive_section_button' ]"/> -->
                  ...
                  <q-tab-panel name="Replenishment" style="padding: 0px; padding-top: 10px; color: grey" class="no-scroll">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <Button v-on:receiveClick="handleActiveClickSection3('Basic_Replenishment')"
                          :pass_label="'Basic_Replenishment'"
                          :pass_no_caps="true"
                          :pass_square="true"
                          :pass_dense="true"
                          :class="[active_section3 == 'Basic_Replenishment' ? 'active_section_button' : 'inactive_section_button']"
                        />
                        ...
                        <!-- <q-btn @click="handleActiveClickSection3('Basic_Replenishment')" no-caps square dense :class="[active_section3 == 'Basic_Replenishment' ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                          Basic
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection3('Banner/Site')" no-caps unelevated square dense push label="Banner/Site" :class="[active_section3 == 'Banner/Site' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                      </div>
                    </div>

                    <div class="row" v-if="active_section3 == 'Basic_Replenishment'">
                  ...
                  <q-tab-panel name="Purchase" style="padding: 0px; padding-top: 10px; color: grey">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection6('Supplier')" no-caps unelevated square dense push label="Supplier" :class="[active_section6 == 'Supplier' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection4('Cost Change')" no-caps unelevated square dense push label="Cost Change" :class="[active_section6 == 'Cost Change' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection6('Purchase Promo')" no-caps square dense :class="[active_section6 == 'Purchase Promo' ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                          Purchase Promo
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection6('Purchase Order')" no-caps unelevated square dense push label="Purchase Order" :class="[active_section6 == 'Purchase Order' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection6('Goods Receiving')" no-caps unelevated square dense push label="Goods Receiving" :class="[active_section6 == 'Goods Receiving' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection6('IBT Purchase')" no-caps unelevated square dense push label="IBT Purchase" :class="[active_section6 == 'IBT Purchase' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                      
                      </div>
                    </div>

                    <div class="row" v-if="active_section6 == 'Supplier'">
...
<div style="width: 100%; overflow-y: auto;">
                  ...
                  <q-tab-panel name="Sales Info" style="padding: 0px; padding-top: 10px; color: grey">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        />
                        <!-- <q-btn @click="handleActiveClickSection7(`Today's Price`)" no-caps square dense :class="[active_section7 == `Today's Price` ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                            Today's Price
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection7('Price Change')" no-caps unelevated square dense push label="Price Change" :class="[active_section7 == 'Price Change' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection7('3+1 Month')" no-caps square dense :class="[active_section7 == '3+1 Month' ? 'active_section_button' : 'inactive_section_button' ]">3+1 Month</q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection7('Monthly')" no-caps unelevated square dense push label="Monthly" :class="[active_section7 == 'Monthly' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection7('Weekly')" no-caps unelevated square dense push label="Weekly" :class="[active_section7 == 'Weekly' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection7('Daily')" no-caps unelevated square dense push label="Daily" :class="[active_section7 == 'Daily' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection7('POS Sales')" no-caps unelevated square dense push label="POS Sales" :class="[active_section7 == 'POS Sales' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection7('AR Sales')" no-caps unelevated square dense push label="AR Sales" :class="[active_section7 == 'AR Sales' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection7('IBT Sales')" no-caps unelevated square dense push label="IBT Sales" :class="[active_section7 == 'IBT Sales' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                      </div>
                    </div>
                  </q-tab-panel>

                  <q-tab-panel name="Promotion" style="padding: 0px; padding-top: 10px; color: grey">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection5('Promo Discount')" no-caps square dense :class="[active_section5 == 'Promo Discount' ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                          Promo Discount
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection5('Multi Buy')" no-caps unelevated square dense push label="Multi Buy" :class="[active_section5 == 'Multi Buy' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection5('Mix & Match')" no-caps unelevated square dense push label="Mix & Match" :class="[active_section5 == 'Mix & Match' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection5('Price Break')" no-caps unelevated square dense push label="Price Break" :class="[active_section5 == 'Price Break' ? 'active_section_button' : 'inactive_section_button' ]"/> -->

                        <!-- <q-btn @click="handleActiveClickSection5('Permanent Discount')" no-caps unelevated square dense push label="Permanent Discount" :class="[active_section5 == 'Permanent Discount' ? 'active_section_button' : 'inactive_section_button' ]"/> -->
                  ...
                  <q-tab-panel name="Inventory" style="padding: 0px; padding-top: 10px; color: grey">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        ...
                        <!-- <q-btn @click="handleActiveClickSection8('QOH by Site')" no-caps square dense :class="[active_section8 == 'QOH by Site' ? 'active_section_button' : 'inactive_section_button' ]">
                          <div style="display: flex; align-items: center;">
                          QOH by Site
                          </div>
                        </q-btn> -->

                        <!-- <q-btn @click="handleActiveClickSection8('Movement by Site')" no-caps unelevated square dense push label="Movement by Site" :class="[active_section8 == 'Movement by Site' ? 'active_section_button' : 'inactive_section_button' ]" /> -->

                        <!-- <q-btn @click="handleActiveClickSection8('Movement by Location')" no-caps unelevated square dense push label="Movement by Location" :class="[active_section8 == 'Movement by Location' ? 'active_section_button' : 'inactive_section_button' ]"/> -->
...
export default{
  data() {
    return {
      ...
      active_section3:'Basic_Replenishment',
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditItemmaster' || this.page_function == 'CreateEditIM_new')
    {
...
console.log(data);
  ...
  methods: {
    handleReceiveChangePriceIncTax(pass_payload)
    {
      alert(pass_payload);
    },
      ...
      table_function(payload){
          ...
          this.$nextTick(async ()=>{
            ...
            for (const index in data.data) {
              data.data[index].primary = true;
              data.data[index].type = 'NA'
            }
