...
<!-- {{last_enter_field}} -->
    <q-card style="max-height: 100%; border-radius: 7px;">
      <q-card-section class="upload_container" style="font-size: 10px;padding-left: 10px; padding-right: 10px;">
      ...
      <!--Article No :label="$language('D0101')" -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                          <div class="row" style="align-items: center;">
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                              <Span> <b>{{$language('D0101')}} </b></span>
                            </div>
      ...
      <!--Pack Size :label="$language('D0100')" -->
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                          <div class="row" style="align-items: center;">
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <Span> <b>{{$language('D0100')}} </b> </span>
                        </div>
    ...
    <!-- BULK UOM :label="$language('D0185')"  -->
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                              <Span> <b>{{$language('D0185')}} </b></span>
                            </div>
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                              <!-- Bulk UOM -->
                              <SelectFilter
                    ...
                    <div class="row" style="margin-bottom: 10px;">
    <!--Item code :label="$language('D0203')" -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <Span> <b>{{$language('D0203')}}</b> </span>
                              </div>
                              <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
    ...
    <!--UOM :label="$language('D0173')" -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right: 10px;">
                      <div class="row" style="align-items: center;">
                          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                              <Span> <b>{{$language('D0173')}}</b></span>
                            </div>
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                              <!-- UOM -->
                              <SelectFilter
    ...
    <!-- Outsource/Consign -->
                      ...
                      <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                  <Span> <b>Receive</b>  </span><!--(pending save to web trans c)-->
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                  <Toggle size="xs" v-model="is_receiving" style="padding-bottom: 4px;" />
                                </div>
                  ...
                  <div class="component_div2">
                    <q-toolbar class="bg-white q-pl-sm custom_toolbar">
                      ...
                      >
                        ...
                        <q-tab v-if="page_function == 'EditItemmaster'" name="detail" label="Detail" content-class="custom_tab_font"/>
                        <q-tab v-if="page_function == 'EditItemmaster'" name="branchInfo" label="branchInfo" content-class="custom_tab_font"/>
                        <q-tab v-if="page_function == 'EditItemmaster'" name="SupplierItem" label="SupplierItem" content-class="custom_tab_font"/>
                      </q-tabs>
                    </q-toolbar>
                    <q-separator />

                    <q-tab-panels v-model="tab" :animated="false">
                      <q-tab-panel name="hierarchy" class="q-px-xs">
...
<!-- Sub Department :label="'Sub-Department'" -->
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <q-card flat>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  ...
                                  v-model:pass_value="json.sub_class"
                                  :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text : oridbComponentBehavior.select"
...
<!-- Manufacturer :label="$language('D0207')"  -->
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <b>{{$language('D0207')}}</b>
...
<!-- Remarks -->                     
  ...
  <!--Price type :label="$language('D0163')" -->
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <b>{{$language('D0163')}}</b>
  ...
  <!-- weight Indicator -->
                      ...
                      <q-tab-panel name="pricecost" class="q-px-xs">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                            <div class="row">
<!-- label="Price Inc Tax" -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              ...
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    :readonly="page_function == 'EditItemmaster' ? true: false"
                                    v-on:change="handleChange"
                                    v-model="json.Price_exc_tax "
                                    :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                                  </div>
                                </div>
                              </div>
<!-- label="Rec Price Inc Tax" -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <b>Rec Price Inc Tax</b>
                                    <!-- $language('D0221') -->
                                    <Input
                                    :autofocusclick="true"
                                    :no_label="false"
                                    ...
                                    :readonly="page_function == 'EditItemmaster' ? true: false"
                                    v-on:change="handleChange"
                                    v-model="json.Rec_price_inc_tax "
                                    :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                                  </div>
                                </div>
                              </div>
<!-- label="Rec Price Exc Tax" -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <b>Rec Price Exc Tax</b>
                                    <!-- $language('D0221') -->
                                    <Input
                                    :autofocusclick="true"
                                    :no_label="false"
                                    ...
                                    :readonly="page_function == 'EditItemmaster' ? true: false"
                                    v-on:change="handleChange"
                                    v-model="json.Rec_price_exc_tax "
                                    :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                              </div>
                              </div>
                              </div>
                              ...
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    :readonly="page_function == 'EditItemmaster' ? true: false"
                                    v-on:change="handleChange"
                                    v-model="json.TargetGP"
                                    :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                                  </div>
                                </div>
                              </div>
<!--member points :label="$language('D0209')"  -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <b>{{$language('D0209')}}</b>
                              ...
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    :readonly="page_function == 'EditItemmaster' ? true: false"
                                    v-on:change="handleChange"
                                    v-model="json.ConsignCost "
                                    :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                                  </div>
                                </div>
                              </div>
<!--:label="'Point Multiply'"  -->
                                  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                    <div class="row" style="align-items: center;">
                                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <b>Point Multiply</b>
                                  ...
                                  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                    <div class="row" style="align-items: center;">
                                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        :readonly="false"
                                        v-on:change="handleChange"
                                        v-model="json.GSTVATSupply"
                                        :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.input_number : oridbComponentBehavior.text" />
                                      </div>
                                    </div>
                                  </div>
<!--:label="'GST/VAT Purchase'"  -->
                                  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                    <div class="row" style="align-items: center;">
                                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <b>GST/VAT Purchase</b>
                                        <!-- GST/VAT Purchase -->
                                        <Input
                                        :autofocusclick="true"
                                        :no_label="false"
...
<!--:label="'GST Tax Code'"  -->
                      ...
                      <q-tab-panel name="additional" class="q-px-xs">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                            <div class="row">
<!-- Item Package -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                              ...
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    :readonly="false"
                                    v-on:change="handleChange"
                                    v-model="json.no_promotion"
                                    :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text : oridbComponentBehavior.text" />
                                  </div>
                                  </div>
                              </div>
<!-- Old code :label="$language('D0212')""-->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <b>{{$language('D0212')}}</b>
...
<!-- yield ratio :label="$language('D0211')" -->
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 10px;">
                                <div class="row" style="align-items: center;">
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <b>{{$language('D0211')}}</b>
...
<!-- Updted By -->
                  ...
                  <div class="row" style="align-items: center;">
                      ...
                      <q-tab-panel v-if="page_function == 'EditItemmaster'" name="detail" class="q-px-xs">
                        <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <PurchaseTable
                          hide_footer
                      ...
                      <q-tab-panel v-if="page_function == 'EditItemmaster'" name="branchInfo" class="q-px-xs">
                        <div class="row">
                      ...
                      <q-tab-panel v-if="page_function == 'EditItemmaster'" name="SupplierItem" class="q-px-xs">
                        <div class="row">
                      <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <PurchaseTable
                          hide_footer
...
<!--Carton Cost (newly added) H.PriceList  -->
...
<!--Discount By Amount (newly added) Disc RP  -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;padding-left: 10px;">
                      <Input
                      :autofocusclick="true"
...
<!--Price Per Unit (newly added) Harga Beli/Unit  -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;">
                      <Input
                      :autofocusclick="true"
...
<!--Amount with tax (newly added) Harga+PPN  -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;padding-left: 10px;">
                      <Input
                      :autofocusclick="true"
...
<!--Rounding (newly added) Pembulatan  -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;padding-left: 10px;">
                      <Input
                      :autofocusclick="true"
...
<!-- Selling Price (newly added) Harga Jual Standard -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;">
                      <Input
                      :autofocusclick="true"
                      :no_label="false"
...
<!--Amount Include Tax (newly added) Kalkulasi Include  -->
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px;padding-left: 10px;">
                      <Input
                      :autofocusclick="true"
...
<!-- Tax SST -->
  ...
  <div v-else class="card_sides">
    <div :class="page_function == 'CreateItemmaster' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateItemmaster'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditItemmaster'" :icon="'chevron_left'" :square="true" :label="'Edit IM' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
          <!-- <Chip v-if="page_function == 'EditItemmaster'" :icon="'chevron_left'" :square="true" :label="$language('D0203') +' : '+ json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/> -->
      </div>
    <q-card class="card-container" style="min-height: 100vh;">
      <!-- <q-card-section class="header_top">
        ...
        <br>{{ $language('D0203') }} : {{ json.Itemcode }}</div>
      </q-card-section>Item Code -->
...
<!--Article No-->
                        <div class="row col-12">
                          <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{ $language('D0212') }}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Old Code-->
                                <Input
                                  :autofocusclick="true"
                                  :no_label="false"
...
<!--Variant-->                    
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row ">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{ $language('D0210') }}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Item Type-->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
...
<!-- Size -->
                        <div class="row col-12">
                          <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0192')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Brand-->
                                <SelectFilter
                                        :readonly="false"
                                        :no_label="false"
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{ $language('D0191') }}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Size-->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
                        ...
                        <div class="row col-12 mobile_section_font">Supplier & Manufacturer Information</div>
<!-- supplier -->
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" >
                            <div class="row" :class="$q.screen.width < 1024 ? '' : ''">
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Supplier-->
                                <SelectFilter
                                :readonly="page_function=='EditItemmaster' ? true: false"
                                :no_label="false"
...
<!-- manufacturer -->
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0208')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Origin-->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
                          ...
                          <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0207')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Manufacturer-->
                                <SelectFilter
                                    :readonly="false"
                                    :no_label="false"
                        ...
                        <q-separator class="separator-style"></q-separator>
                        <div class="row col-12 mobile_section_font">Pricing & Cost Information</div>
<!-- selling price -->
<!-- price per unit -->
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                        ...
                        <div class="row col-12">
                          <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row ">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0163')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Price Type-->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
                          ...
                          <div  class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0209')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Points-->
                                <Input
                                :autofocusclick="true"
                                :no_label="false"
                        ...
                        <q-separator class="separator-style"></q-separator>
                        <div class="row col-12 mobile_section_font">Tax Information</div>
                        <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <div class="row">
                            <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="row col-12">
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-sm" style="">
                                <Input
                                :autofocusclick="true"
                                :label="'Tax Amount (newly added)'"
                                :no_label="false"
                        ...
                        <q-separator class="separator-style"></q-separator>
                        <div class="row col-12 mobile_section_font">Department & Category Information</div>
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row" :class="$q.screen.width<1024 ? '': ''">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="row col-12">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0196')}} </span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Category-->
                                <SelectFilter
                                      :readonly="false"
                                      :no_label="false"
                        ...
                        <q-separator class="separator-style"></q-separator>
                        <div class="row col-12 mobile_section_font">Packaging & Unit Information</div>
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                          <div class="row">
                            <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="row col-12">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0185')}} </span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!-- Bulk UOM-->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-sm">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0173')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--UOM -->
                                <SelectFilter
                                :readonly="false"
                                :no_label="false"
                        ...
                        <div class="row col-12">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="row">
                              <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <span class="mobile_font">{{$language('D0211')}}</span>
                              </div> -->
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--Yield Ratio-->
                                <Input
                                :autofocusclick="true"
                                :no_label="false"
                      ...
                      <!-- <div class="row" v-if="item_calculation" style=""> -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                          <!-- <div class="row" style="gap:16px"> -->
                            ...
                            <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 10px; padding-right: 10px;">
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="row">
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <Textarea class="ignore_height" :no_label="false" :label="Remark" :readonly="json.BillStatus==1" v-on:receiveChange="handleChange" v-model="json.remark"
                                    :dbComponentBehavior="dbComponentBehavior.remark" :pass_label="$language('D0055')"/>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-top:16px">
                              ...
                              <span style="font-family: InterfontSemiBold; font-weight:600; font-size:14px;">Receive (pending save to web trans c)</span>
                ...
                <q-step
                  ...
                  :done="json.step > 2"
                >
                <div v-if="page_function == 'EditItemmaster'" class="row" style="padding-top:16px;gap:16px">
                  <div v-if="results.length != 0" class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="gap:16px">
                    <q-card @click="selectCard(index)" v-for="(result,index) in results" :key="index" flat bordered class="card_design q-mb-md"  style="width: 100%; border-radius:8px;padding:16px"
                      :class="{'selected-card': selectedCardIndex === index}">
                        <q-card-section style="padding: 5px;" >


                                <div class="row q-px-sm">
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="font-size:14px; font-family:InterfontBold;font-weight:700; color: #29292A">
                                    {{ result.Barcode }}
                                  </div>

                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 text-caption" style="color:#757575; font-size:12px, font-weight: 500; font-family: InterfontMedium">
                                    {{ result.barDesc }}
                                  </div>
                                  <div class=" col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right" style="font-size:14px;font-weight:700; font-family:InterfontBold; color: #29292A">
                        ...
                        <q-card-section v-show="selectedCardIndex === index">
                            ...
                            <q-card-section class="text-subtitle2" align="right">
                              ...
                              <q-btn no-caps flat color="red-7" label="Delete"  @click="handleDelete(index)" style="font-family:InterfontSemiBold; font-size: 14px;font-weight: 600;"/>
                            </q-card-section>
                          </q-card-section>
                    </q-card>
                ...
                <div v-if="page_function == 'EditItemmaster'" class="row">
                  <div v-if="branch_results.length != 0" class="card_section_two col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <q-card v-for="(result,index) in branch_results" :key="index" @click="selectCard(index)" :class="{'selected-card': selectedCardIndex === index}" flat bordered class="card_design q-mb-sm"  style="width: 100%; border-radius:6px;">
                        <q-card-section   style="padding: 5px;" >
                                <div class="row q-px-sm">
                        ...
                        <q-card-section v-show="selectedCardIndex === index">
                            <!-- <q-separator />"'#B22222'" -->
                            <q-card-section class="text-subtitle2" align="right">
                              <q-btn no-caps flat color="primary" label="View"  @click="handleViewBranchDetail(result)" style="font-family:InterfontSemiBold; font-size: 14px;font-weight: 600;"/>
                              <!-- <q-btn no-caps flat color="red-7" label="Delete"  @click="handleDelete(index)" style="font-family:InterfontSemiBold; font-size: 14px;font-weight: 600;"/> -->
                            </q-card-section>
                          </q-card-section>
                    </q-card>
    ...
    <div v-if="json.step == 1 || json.step == 3" class="" :style="page_function == 'EditItemmaster' ? 'height: 45px;' : 'height: 40px;'">
      ...
      <!-- <div class="q-px-sm q-py-xs">
        <Button_icon :readonly="page_function.startsWith('Edit') && deepEqual(ori_json, json)" class="full-width" style="height: 30px;" :small_round="true" :text="page_function.startsWith('Create') ? 'Generate Item Master' : 'Update Item Master'" :flat="false" :font_color="'white'" :color="'primary'" :outline="false" size="13px" @click="handleCreateIM"/>
      </div> -->
      <ButtonMobile
      :json="json" 
      :ori_json="ori_json"
      :page_function="page_function"
      @create-im="handleCreateIM"      
      @convert-new="handleConvertNew"
    />
    
    </div>

    <div v-if="json.step == 2" class="" style="height: 46px;">
<!--65px-->
      <ButtonMobile
      :json="json" 
      :ori_json="ori_json" 
...
<!-- navigation mobile Item Master -->
      <!-- <div class="dialog_mobile_detail">
              <div class="row full-height items-center">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4" align="center" > 
                  <Button_icon :icon="'add'" :border_radius="'30px;'" :flat="false" :font_color="'white'" :color="'primary'" :outline="false" size="13px"
  ...
  <q-dialog v-model="delete_child" persistent position="top">
    <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
      ...
      <q-card-section style="padding: 32px 24px">
        ...
        <span class="confirmation_line_font">Are you sure to delete this barcode?</span>
      </q-card-section>
      ...
      <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
        ...
        <q-btn flat :label="$language('D0156')" size="12px" font_color="'white'" color="'#D81111'" class="confirm_delete_button" @click="handleDeleteLine" /> <!-- OK -->
      </q-card-actions>
    ...
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
          <div v-if="!edit_child" class="text-subtitle1 header_text" style="margin-top: 0px;">Add Barcode<br></div>
          <div v-else class="text-subtitle1 header_text" style="">Edit Barcode<br></div>
        </div>
    ...
    <q-card v-else style="width: 700px; max-width: 98vw; margin-top: 5%;">
      ...
      <q-card-actions v-if="json.BillStatus == 0" class="dialog_action" style="padding-left: 20px;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
            ...
            v-on:receiveClick="handleChild('save&add')" class="custom_primary_button"/>

            <span class="q-pl-xs"/>

            <Button_icon :readonly="false" :flat="true" :font_color="'white'" :color="'#1E90FF'" :text="'SAVE'" :outline="false" size="16px"
            v-on:receiveClick="handleChild('save')" class="custom_primary_button"/>
          </div>
      </q-card-actions>
  ...
  <q-dialog v-model="supplier_item_list_popup" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card style="width: 1200px; max-width: 98vw; margin-top: 5%;">
      ...
      <q-card-actions v-if="$q.screen.width > 599" class="dialog_action" style="padding-left: 20px;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
            <Button_icon :readonly="false" :flat="true" :font_color="'white'" :color="'#1E90FF'" :text="'SAVE'" :outline="false" size="16px"
            v-on:receiveClick="handleSilChild()" class="custom_primary_button"/>
          </div>
      </q-card-actions>
  ...
  <q-dialog v-model="show_barcode_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile" :style="{ textAlign: (!status && edit_barcode) ? 'center' : 'left' }">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div v-if="!edit_barcode" class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Add Barcode<br></div>
          <div v-else class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Edit Barcode<br></div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :autofocusclick="true"
                              :no_label="false"
                              :label="edit_barcode ? 'Old Barcode' : 'Barcode'"
...
<!-- add EDIT BARCODE -->
          <div class="full-width">
            <Button_icon class="full-width custom_primary_button" style="height: 30px;" :small_round="true" :text="'ADD'" :flat="false" :font_color="'white'" :color="'#1E90FF'" :outline="false" size="16px" @click="handleAddBarcode"/>
          </div>
    ...
    <q-card v-else style="width: 500px; max-width: 60vw; margin-top: 5%; border-radius:8px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="row input_wrapper_left_right" style="gap:16px;padding-top:16px">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " :class="!edit_child ? '': ''">
                         ...
                         <div v-if="edit_barcode" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " :class="!edit_child ? '': ''">
                            <div class="row ">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <Input
                                :autofocusclick="true"
...
<!-- EDIT BARCODE ADD BUTTON -->
      <q-card-actions class="dialog_action" style="padding-bottom: 16px;padding-right:16px;padding-top:0px">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
            ...
            v-on:receiveClick="handleAddBarcode" class="custom_primary_button"/>
          </div>
      </q-card-actions>
  ...
  <q-dialog v-model="show_branch_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
          <div class="text-subtitle1 mobile_dialog_bottom" style="padding: 16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Branch {{branch_details.branch}}<br></div>
        </div>
        <div class="custom_close_button">
                  ...
                  <div class="row dialog_separator">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                      <div class="row justify-center" style="padding: 16px">
                        <div class="dialog_separator row col-12" style="gap:16px">
<!-- Pricing and Cost Details -->
                          <div class="col-12">
                          <q-card bordered flat :style="isClickedPricing ? 'border: 2px solid #90A8D6; box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.30);' : ''"  @click="isClickedPricing = !isClickedPricing" style="overflow: hidden;">
                          <q-expansion-item
                            expand-separator
                            label="Pricing and Cost Details"
                            class="mobile_card_title"
                          >
                            <q-card>
                              <q-card-section>
                                <div class="row" style="gap:12px;padding: 0px 16px 16px">
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Price Inc Tax</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.price_inc_tax}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Price Exc Tax</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.sellingprice}}</span>
                                    </div>
                                  </div>

                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Today Prince Inc Tax</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.price_today_na}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Today Member Price Inc Tax</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.price_today_mb}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Listed Cost</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.stdcost}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Avg Cost</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.averagecost}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Last Cost</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.lastcost}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">FIFO Cost</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.fifocost}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Last Cost GP %</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.LastCostGP}}</span>
                                    </div>
                                  </div>
                                </div>
                              </q-card-section>
...
<!-- Category and Promotion Details -->
                          <div class="col-12">
                          <q-card bordered flat :style="isClickedCategory ? 'border: 2px solid #90A8D6; box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.30);' : ''"  @click="isClickedCategory = !isClickedCategory" style="overflow: hidden;">
                          <q-expansion-item
                            expand-separator
                            label="Category and Promotion Details"
                            class="mobile_card_title"
                          >
                            <q-card>
                              <q-card-section>
                                <div class="row" style="gap:12px;padding: 0px 16px 16px">
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Category Ranking</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.rank_cat_qty}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.rank_cat_amt}}</span>
                                    </div>
                                  </div>

                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Item Type</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.branch_itemtype}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Qty Promo</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.qty_promo}}</span>
                                    </div>
                                  </div>
                                  <div class="row col-12">
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                      <span class="mobile_card_item_title">Promo Day</span>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                      <span class="mobile_card_item_value">{{branch_details.day_promo}}</span>
                                    </div>
                                  </div>
                                </div>
...
<!-- Inventory details -->
                          <div class="col-12">
                          <q-card bordered flat :style="isClickedInventory ? 'border: 2px solid #90A8D6; box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.30);' : ''"  @click="isClickedInventory = !isClickedInventory" style="overflow: hidden;">
                          <q-expansion-item
                            expand-separator
                          ...
                          >
                            <q-card>
                              <q-card-section>
                                ...
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Transform Out</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_hp_out}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    <span class="mobile_card_item_title">IBT Sales</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_ibt_sales}}</span>
                                  </div>
                                </div>

                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">IBT GRN</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_ibt_grn}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Replenis hment ADS</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.ads_rep}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Opn</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_opn}}</span>
                                  </div>
                                </div>

                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Rec</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_rec}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">POS</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_pos}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    <span class="mobile_card_item_title">SI</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_si}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    <span class="mobile_card_item_title">Other</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_other}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Pending Return</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_tbr}}</span>
                                  </div>
                                </div>
                                 <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    <span class="mobile_card_item_title">Bal</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.QOH}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" >
                                    <span class="mobile_card_item_title">DOH</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.doh}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Qty Avail</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_avail}}</span>
                                  </div>
                                </div>
                                </div>
...
<!-- Order and Branch Details -->
                          <div class="col-12">
                          <q-card bordered flat :style="isClickedOrder ? 'border: 2px solid #90A8D6; box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.30);' : ''" @click="isClickedOrder = !isClickedOrder"  style="overflow: hidden;">
                          <q-expansion-item
                            expand-separator
                            label="Order and Branch Details"
                            class="mobile_card_title"
                          >
                            <q-card>
                              <q-card-section>
                                ...
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">SO Qty</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_so}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">PO Qty</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_po}}</span>
                                  </div>
                                </div>

                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Req Qty</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.qty_req}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">ADS</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.ads}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">AWS</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.aws}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">AMS</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.ams}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <span class="mobile_card_item_title">Branch</span>
                                  </div>
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.branch}}</span>
                                  </div>
                                </div>
                                </div>
...
<!-- Dates and System Details -->
                          <div class="col-12">
                          <q-card bordered flat :style="isClickedDates ? 'border: 2px solid #90A8D6; box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.30);' : ''" @click="isClickedDates = !isClickedDates" style="overflow: hidden;">
                          <q-expansion-item
                            expand-separator
                            label="Dates and System Details"
                            class="mobile_card_title"
                          >
                            <q-card>
                              <q-card-section>
                                <div class="row" style="gap:12px;padding: 0px 16px 16px">
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Date Start</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.date_start}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Date End</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.date_stop}}</span>
                                  </div>
                                </div>

                                <div class="row col-12">
                                  <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7" style="">
                                    <span class="mobile_card_item_title">1st GRN Date</span>
                                  </div>
                                  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.first_gr_date}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7" style="">
                                    <span class="mobile_card_item_title">Days Analysed</span>
                                  </div>
                                  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.days}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Last GR Qty</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.last_gr_qty}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Last GR Date</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.last_gr_date}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Created at</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.created_at}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Updated at</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.updated_at}}</span>
                                  </div>
                                </div>
                                <div class="row col-12">
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="">
                                    <span class="mobile_card_item_title">Recalculate at</span>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right">
                                    <span class="mobile_card_item_value">{{branch_details.recalc_at}}</span>
                                  </div>
                                </div>
                                </div>
  ...
  <q-dialog v-model="show_supplier_item_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
      ...
      <q-card v-else style="width: 864px; max-width: 98vw; margin-top: 2%;border-radius: 8px">
        ...
        <q-card-section class="upload_container2">
          <q-form ref="save_edit_pochild_form">
            <div class="row upload_separator_first">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="row dialog_separator">
                      ...
                      <div v-if="!edit_child" dir="rtl" class=" col-xs-2 col-sm-1 col-md-2 col-lg-2 col-xl-2" style="padding-top: 0px;">
                        ...
                        <Button_icon ref="searchButton" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="true" size="17px"
                        v-on:receiveClick="showSearchDialog()" :tooltip_message="'Search Item'" class="full-width button-padding2 search-button custom_primary_font"/>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="row items-center">
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4" style="">
                                    <span class="supplier_item_font">Block</span>
                                  </div>
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" style="">
                                    <Checkbox
                                      size="sm"
                                      :disable="false"
                                      :no_label="true"
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="row items-center">
                                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4" style="">
                                    <span class="supplier_item_font">Non Returnable</span>
                                  </div>
                                  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" style="">
                                    <Checkbox
                                      size="sm"
                          ...
                          <div class="row q-pt-md" style="gap:20px">
                            <div class="row col-12">
<!-- supplier -->           
...
<!-- net cost -->
  ...
  <!-- rsp before -->
        ...
        <q-card-actions class="dialog_action" style="padding-top: 0px;padding-right: 16px;padding-bottom:16px">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
              <Button_icon :readonly="false" :flat="true" :text="'SAVE'" :outline="false" size="16px"
              v-on:receiveClick="handleSupplierItem('save')" :class="{ 'primary_actions_button': edit_child, 'secondary_actions_button': !edit_child }"/>
              

              <span class="q-pl-md" v-if="!edit_child"/>
              <Button_icon v-if="!edit_child" :readonly="false" :flat="true" :font_color="'white'" :color="'#1E90FF'" :text="'ADD'" :outline="false" size="16px"
              v-on:receiveClick="handleSupplierItem('save&add')" class="custom_primary_button"/>
...
<q-dialog v-model="delete_child2" persistent position="top">
    <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
      ...
      <q-card-section style="padding: 16px">
        <!-- <span class="q-ml-sm custom_selection_font">{{general_body}}</span> -->
        <span class="confirmation_line_font">Are you sure to delete this Supplier?</span>
      </q-card-section>

      <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
        <q-btn flat :label="$language('D0116')" font_color="#29292A" color="#29292A" size="12px" class="dialog_confirm_cancel_button" v-close-popup /> <!-- CANCEL -->
        <q-btn flat :label="$language('D0156')" size="12px" font_color="'white'" color="'#D81111'" class="confirm_delete_button" @click="handleDeleteSupplierItemLine" /> <!-- OK -->
      </q-card-actions>
 ...
 <q-dialog v-model="receiving_methods" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card style="text-align:left;margin-top: 5%; height:120px">
        ...
        <div  class="row q-py-xs">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" @click="addButtonBarcode">
                <div class="row justify-center items-center" style="width: 100%; ">
                  <div class="">
                    <Button_icon style="border-radius: 15px;" :label="'Add Barcode'" class="dialog_detail_add_button" :flat="false" :icon="'add'" v-on:receiveClick="addButtonBarcode" :font_color="'white'" :color="'primary'" :outline="false"/>
...
@media screen and (max-width: 599px) {
  ...
  .mobile_card_item_value{
    font-family: InterfontSemiBold;
    font-weight: 600;
    font-size: 15px;
    color: #1E90FF;
  }
  .mobile_card_title >>>.q-item__label{
...
*.testing_sty >>> .q-item__label {
    white-space: nowrap;  /* Prevent the text from wrapping */
    overflow: hidden;     /* Hide the overflowing text */
    text-overflow: ellipsis; /* Add ellipsis (...) to the overflowing text */
}
  .dialog_action
{
  /* height: 55px; */
