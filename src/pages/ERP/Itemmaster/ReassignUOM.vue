...
console.log(visibleColumns);
        ...
        var dispatch_response_reassignUOM = await this.$dispatch(object_pass);
        console.log('dispatch_response_reassignUOM', dispatch_response_reassignUOM);
        var status = dispatch_response_reassignUOM.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_reassignUOM.response.detail;
          console.log('results_Reassign_uom', results);
          for(var index in results)
            ...
            this.table_data = {
            "data": {
            "count": dispatch_response_reassignUOM.response.total_row,
            "next": null,
            "previous": null,
            "results": dispatch_response_reassignUOM.response.detail
            }
        };

        this.results = dispatch_response_reassignUOM.response.detail;
