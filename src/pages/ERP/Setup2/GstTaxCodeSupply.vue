    ...
    showNotify(type, message) {
      ...
      async table_function(ori_payload){
          ...
          "pass_json":{
            ...
            "sort_by": payload.sort_by == "" ? "seq" : payload.sort_by == "default_status" ? "set_default" : payload.sort_by == "exampted_status" ? "IsExempted" : payload.sort_by == "active_status" ? "set_active" : payload.sort_by,
