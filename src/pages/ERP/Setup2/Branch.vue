<template>
  ...
  <div class="row main_container">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          :handleActionColumn="'BRANCH_CODE'"
...
export default {
  ...
  methods:{
      ...
      handleReceiveHandleEdit(pass_payload)
      {
          this.$router.push({
              ...
              name: "EditBranch",
              query: { BranchGuid: pass_payload.row.BRANCH_GUID}
          });
      },
      handleReceiveHandleDelete(pass_payload)
      {
        console.log('pass_payload', pass_payload);
        this.get_code_guid = pass_payload.row.BRANCH_GUID
      ...
      async table_function(ori_payload){
          ...
          "pass_json":{
            ...
            "sort_by": payload.sort_by == "" ? "BRANCH_CODE"  : payload.sort_by,
        ...
        //     xpayload.pass_json.SET_PRIORITY = Number(this.table_column[2].filter_value);
        //   }
        //   xpayload.pass_json.BRANCH_CODE = this.table_column[3].filter_value;
        //   xpayload.pass_json.BRANCH_NAME = this.table_column[4].filter_value;
        //   xpayload.pass_json.branch_desc = this.table_column[5].filter_value;
        //   if(this.table_column[6].filter_value != ''){
        //     xpayload.pass_json.SET_RATIO = Number(this.table_column[6].filter_value);
        //   }
        //   xpayload.pass_json.BRANCH_ADD = this.table_column[7].filter_value;
        //   xpayload.pass_json.BRANCH_TEL = this.table_column[8].filter_value;
        //   xpayload.pass_json.BRANCH_FAX = this.table_column[9].filter_value;
        //   xpayload.pass_json.SET_CUSTOMER_CODE = this.table_column[10].filter_value;
        //   xpayload.pass_json.SET_SUPPLIER_CODE = this.table_column[11].filter_value;
        //   xpayload.pass_json.company_name = this.table_column[12].filter_value;
        //   xpayload.pass_json.company_id = this.table_column[13].filter_value;
        //   if(this.table_column[14].filter_value != ''){
        //     xpayload.pass_json.CREATED_AT = this.table_column[14].filter_value;
        //   }
        //   xpayload.pass_json.CREATED_BY = this.table_column[15].filter_value;
        //   if(this.table_column[16].filter_value != ''){
        //     xpayload.pass_json.UPDATED_AT = this.table_column[16].filter_value;
        //   }
        //   xpayload.pass_json.UPDATED_BY = this.table_column[17].filter_value;
        //   xpayload.pass_json.script_database_tablename = this.table_column[18].filter_value;
        //   if(this.table_column[19].filter_value != ''){
        //     xpayload.pass_json.PeriodEndOn = Number(this.table_column[19].filter_value);
        //   }
        //   if(this.table_column[20].filter_value != ''){
        //     xpayload.pass_json.LastRecalDateTime = this.table_column[20].filter_value;
        //   }
        //   if(this.table_column[21].filter_value != ''){
        //     xpayload.pass_json.RecalTime = this.table_column[21].filter_value;
        //   }
        //   if(this.table_column[22].filter_value != ''){
        //     xpayload.pass_json.nontrade_as_stock = this.table_column[22].filter_value;
        //   }
        //   if(this.table_column[23].filter_value != ''){
        //     xpayload.pass_json.is_dc =  this.table_column[23].filter_value;
        //   }
        //   if(this.table_column[24].filter_value != ''){
        //     xpayload.pass_json.rep_all_ads = this.table_column[24].filter_value;
        //   }
        // }
        ...
        if(this.table_column.length != 0){
          ...
          if(this.table_column[1].filter_value != ''){
            xpayload.pass_json.SET_PRIORITY = Number(this.table_column[1].filter_value);
          }
          xpayload.pass_json.BRANCH_CODE = this.table_column[2].filter_value;
          xpayload.pass_json.BRANCH_NAME = this.table_column[3].filter_value;
          xpayload.pass_json.branch_desc = this.table_column[4].filter_value;
          if(this.table_column[5].filter_value != ''){
            xpayload.pass_json.SET_RATIO = Number(this.table_column[5].filter_value);
          }
          xpayload.pass_json.BRANCH_ADD = this.table_column[6].filter_value;
          if(this.table_column[7].filter_value != ''){
            xpayload.pass_json.BRANCH_TEL = this.table_column[7].filter_value;
          }
          if(this.table_column[8].filter_value != ''){
            xpayload.pass_json.BRANCH_FAX = this.table_column[8].filter_value;
          }
          xpayload.pass_json.SET_CUSTOMER_CODE = this.table_column[9].filter_value;
          xpayload.pass_json.SET_SUPPLIER_CODE = this.table_column[10].filter_value;
          xpayload.pass_json.company_name = this.table_column[11].filter_value;
          xpayload.pass_json.company_id = this.table_column[12].filter_value;
          if(this.table_column[13].filter_value != ''){
            xpayload.pass_json.CREATED_AT = this.table_column[13].filter_value;
          }
          xpayload.pass_json.CREATED_BY = this.table_column[14].filter_value;
          if(this.table_column[15].filter_value != ''){
            xpayload.pass_json.UPDATED_AT = this.table_column[15].filter_value;
          }
          xpayload.pass_json.UPDATED_BY = this.table_column[16].filter_value;
          xpayload.pass_json.script_database_tablename = this.table_column[17].filter_value;
          if(this.table_column[18].filter_value != ''){
            xpayload.pass_json.PeriodEndOn = Number(this.table_column[18].filter_value);
          }
          if(this.table_column[19].filter_value != ''){
            xpayload.pass_json.LastRecalDateTime = this.table_column[19].filter_value;
          }
          if(this.table_column[20].filter_value != ''){
            xpayload.pass_json.RecalTime = this.table_column[20].filter_value;
          }
          if(this.table_column[21].filter_value != ''){
            xpayload.pass_json.nontrade_as_stock = this.table_column[21].filter_value;
          }
          if(this.table_column[22].filter_value != ''){
            xpayload.pass_json.is_dc =  this.table_column[22].filter_value;
          }
          if(this.table_column[23].filter_value != ''){
            xpayload.pass_json.rep_all_ads = this.table_column[23].filter_value;
          }
        }
        ...
        var results = dispatch_response_get_cp_set_branch.response.detail;

        // for(var i in results){
        //   results[i].set_active = results[i].set_active == 1;
        //   results[i].nontrade_as_stock = results[i].nontrade_as_stock == 1;
        //   results[i].is_dc= results[i].is_dc == 1;
        //   results[i].rep_all_ads = results[i].rep_all_ads == 1
        // }
         ...
         // var results = data.data.detail;
          if(status == "failed"){
            this.table_data = {
              ...
              {
                  "data": {
                      "count": dispatch_response_get_cp_set_branch.response.total_row,
                      "next": null,
                      "previous": null,
                      "results": dispatch_response_get_cp_set_branch.response.detail
                  }
              };

              this.results = dispatch_response_get_cp_set_branch.response.detail;
          ...
          //   },
            ...
            {
                name: 'SET_CUSTOMER_CODE',
                required: true,
                label: 'Customer Code',
                header_align: 'center',
                align: 'left',
                sortable: true,
                field: 'SET_CUSTOMER_CODE',
                format_child: '',
                tooltip: '',
                filter_type: 'input',
                filter_options: [],
            ...
            {
                name: 'SET_SUPPLIER_CODE',
                required: true,
                label: 'Supplier Code',
                header_align: 'center',
                align: 'left',
                sortable: true,
                field: 'SET_SUPPLIER_CODE',
                format_child: '',
                tooltip: '',
                filter_type: 'input',
                filter_options: [],
            ...
            {
                name: 'script_database_tablename',
                required: true,
                label: 'Script Database Tablename',
                header_align: 'center',
                align: 'left',
                sortable: true,
                field: 'script_database_tablename',
                format_child: '',
                tooltip: '',
                filter_type: 'input',
                filter_options: [],
            ...
            {
              name: 'LastRecalDateTime',
              required: true,
              label: 'Last Recal Date',
              header_align: 'center',
              align: 'left',
              sortable: true,
              field: 'LastRecalDateTime',
              format_child: '',
              tooltip: '',
              headerStyle:'text-align: center; width: 1%;',
              // "headerStyle": "max-width: 50px; text-align: center;",
            ...
            {
              name: 'nontrade_as_stock',
              required: true,
              label: 'None Trade as stock',
              header_align: 'center',
              align: 'center',
              sortable: true,
              field: 'nontrade_as_stock',
              format_child: '',
              tooltip: '',
              headerStyle:'text-align: center; width: 1%;',
              // "headerStyle": "max-width: 50px; text-align: center;",
            ...
            },
            {
              name: 'rep_all_ads',
              required: true,
              label: 'Replenishment ADS Allocation',
              header_align: 'center',
              align: 'center',
              sortable: true,
              field: 'rep_all_ads',
  ...
  mounted()
  {
      this.filter_options = [
            ...
            {
                label: 'Customer Code',
                value: 'SET_CUSTOMER_CODE',
            },
            {
                label: 'Supplier Code',
                value: 'SET_SUPPLIER_CODE',
            },
            {
                label: 'Company Name',
                value: 'company_name',
            ...
            {
                label: 'Script Database Tablename',
                value: 'script_database_tablename',
            },
            {
                label: 'Period End On',
                value: 'PeriodEndOn',
