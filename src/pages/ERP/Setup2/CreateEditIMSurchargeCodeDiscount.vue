<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateSurchargeCode' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreateSurchargeCode'" class="text-subtitle1 header_text">
         New Surcharge Code / Discount
        </div>
        <div v-if="page_function == 'EditSurchargeCode'" class="text-subtitle1 header_text">
          Edit Surcharge Code / Discount > {{ json.Code }}
        </div>
    </div>
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ...
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.Calculate_by"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="calculateby_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeCalculate_by"
                                  v-model="json.Calculate_by "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Checkbox
                              ...
                              size="xs"
                              :disable="false"
                              v-model="json.fixed_value"
                              :true-value="1"
                              :false-value="0"
                              v-on:receiveChangenewVal="handleChangeFixedValue"/>
                          </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Surcharge Disc Type'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ref="selectComponent"
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.surcharge_disc_type"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="surcharge_disc_type_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangesurcharge_disc_type"
                                  v-model="json.surcharge_disc_type "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text_single : oridbComponentBehavior.text_single" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  v-model="json.surcharge_disc_value "
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Label :pass_value="'Issue Debit Note'" />
                          </div>
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Checkbox
                              :btm_padding="true"
                              ...
                              :true-value="1"
                              :false-value="0"
                              v-on:receiveChangenewVal="handleChangeDN"/>
                          </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Label :pass_value="'Issue Credit Note'" />
                          </div>
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <Checkbox
                            :btm_padding="true"
                            size="xs"
                            :disable="false"
                            v-model="json.issue_cn"
                            :true-value="1"
                            :false-value="0"
                            v-on:receiveChangenewVal="handleChangeIssueCN"/>
                          </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ...
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="tax_code_supply_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangetax_code_supply"
                                  v-model="json.tax_code_supply "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ...
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="tax_code_purchase_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangetax_code_purchase"
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'System Generated'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ref="selectComponent"
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.system_generate"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="system_generate_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <!-- <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangesystem_generate"
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ...
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.gl_code"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="glcode_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangedebit_acc_code"
                                  v-model="json.debit_acc_code "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Credit Acc Code'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ref="selectComponent"
                                ...
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="credit_acc_code_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangecredit_acc_code"
                                  v-model="json.credit_acc_code "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ...
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.landed_cost"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="landed_cost_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <!-- <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangelanded_cost"
                                  ...
                                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <Checkbox
                                      ...
                                      :true-value="1"
                                      :false-value="0"
                                      v-on:receiveChangenewVal="handleChangeLandedCost"/>
                                  </div>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Prorate by Unit Volume'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <!-- <SelectFilter
                                ref="selectComponent"
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.prorate_by_unit_volume"
                                :dbComponentBehavior="action_change_selecting ? dbComponentBehavior.select : dbComponentBehavior.text"
                                :options="prorate_by_unit_volume_options"
                                v-on:receiveChange="handleChangeCode"
                                :text_italic = "false"
                              /> -->
                              ...
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeProrateByUnitVolume"
                                  v-model="json.prorate_by_unit_volume "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />
                                  ...
                                  <!-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <Checkbox
                                      ...
                                      :true-value="1"
                                      :false-value="0"
                                      v-on:receiveChangenewVal="handleChangeProrateByUnitVolume"
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateSurchargeCode' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateSurchargeCode'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditSurchargeCode'" :icon="'chevron_left'" :square="true" :label="'Edit Surcharge Code' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
...
export default{
  data() {
    return {
      ...
      json:{
        ...
        credit_acc_code: '',
        landed_cost: 0,
        prorate_by_unit_volume: '',
      },
      type_options:[],
      code_options:[],
      calculateby_options:[],
      surcharge_disc_type_options:[],
      tax_code_purchase_options:[],
      tax_code_supply_options:[],
      system_generate_options:[],
      glcode_options:[],
      credit_acc_code_options:[],
      landed_cost_options:[],
      prorate_by_unit_volume_options:[],
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditSurchargeCode'){
  ...
  methods: {
    ...
    back(){
        ...
        this.$router.push("surchargecode");
    ...
    async fetchAllData(){
      var payload = {
        "pass_json":{
          ...
          "surcharge_disc_guid": this.$route.query.surcharge_disc_guid,
        },
      }

      var object_pass = {
          "dispatch": 'setup2_surchargecodediscount/trigger_get_specific_set_surcharge_discount_surcharge_discount_list',
        ...
        if(status){
          this.json.Type = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].code_Type,
          this.json.Code = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].Code,
          this.json.Description = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].Description,
          this.json.Calculate_by = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].Calculate_by,
          this.json.fixed_value = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].Fixed_Value,
          this.json.surcharge_disc_type = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].surcharge_disc_type,
          this.json.surcharge_disc_value = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].surcharge_disc_value,
          this.json.dn = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].dn,
          this.json.issue_cn = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].issue_cn,
          this.json.tax_code_purchase = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].tax_code_purchase,
          this.json.tax_code_supply = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].tax_code_supply,
          this.json.system_generate = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].system_generate,
          this.json.debit_acc_code = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].debit_acc_code,
          this.json.credit_acc_code = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].credit_acc_code,
          this.json.landed_cost = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].landed_cost,
          this.json.prorate_by_unit_volume = dispatch_response_set_surcharge_discount_surcharge_discount_list.response.detail[0].prorate_by_unit_volume
        }
    },
    ...
    handleChangeFixedValue(newVal){
      this.$nextTick(()=>{
        this.json.fixed_value = newVal;
      });
    },
    handleChangeDN(newVal){
      this.$nextTick(()=>{
        this.json.dn = newVal;
      });
    },
    handleChangeIssueCN(newVal){
      this.$nextTick(()=>{
        this.json.issue_cn = newVal;
      });
    },
    ...
    handleChangeLandedCost(newVal){
      this.$nextTick(()=>{
        this.json.landed_cost = newVal;
      });
    },
    handleChangeProrateByUnitVolume(newVal){
      this.$nextTick(()=>{
        this.json.prorate_by_unit_volume = newVal;
      });
    },
    ...
    async handleCreateSurcharge(){
      ...
      if(this.page_function == 'CreateSurchargeCode'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": this.language,
            "code_Type": this.json.Type,
            "Code": this.json.Code,
            "Description": this.json.Description,
            "Calculate_by": this.json.Calculate_by,
            "Fixed_Value": this.json.fixed_value ? 1 : 0,
            "surcharge_disc_type": this.json.surcharge_disc_type,
            "surcharge_disc_value": this.json.surcharge_disc_value,
            "system_generate": this.json.system_generate ? 1 : 0,
            "Created_by": this.user_name,
            "Updated_by": this.user_name,
            "dn": this.json.dn ? 1 : 0,
            "tax_code_purchase": this.json.tax_code_purchase,
            "tax_code_supply": this.json.tax_code_supply,
            "issue_cn": this.json.issue_cn ? 1 : 0,
            "debit_acc_code": this.json.debit_acc_code,
            "credit_acc_code": this.json.credit_acc_code,
            "landed_cost": this.json.landed_cost ? 1 : 0,
            "prorate_by_unit_volume": this.json.prorate_by_unit_volume,
            // "provision": this.json.
          }
        }

        var object_pass = {
          "dispatch": 'setup2_surchargecodediscount/trigger_create_set_surcharge_discount_surcharge_discount_list',
          "getter": 'setup2_surchargecodediscount/get_set_surcharge_discount_surcharge_discount_list',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_create_set_surcharge_discount_surcharge_discount_list = await this.$dispatch(object_pass);

        var status = dispatch_response_create_set_surcharge_discount_surcharge_discount_list.status

        if(status){
          this.showNotify('positive', 'Created Successfully')
          this.$router.push({name: "surchargecode", params:{data: JSON.stringify() }});
        }else{
          var get_error_message = JSON.parse(dispatch_response_create_set_surcharge_discount_surcharge_discount_list.response)
            if(get_error_message){
              this.showNotify('negative', get_error_message.detail);
            }else{
      ...
      }else if(this.page_function == 'EditSurchargeCode'){
        var payload = {
          "pass_json":{
            "surcharge_disc_guid": this.$route.query.surcharge_disc_guid,
            "outlet_guid": this.session_outlet_guid,
        ...
        var object_pass = {
          "dispatch": 'setup2_surchargecodediscount/trigger_patch_set_surcharge_discount_surcharge_discount_list',
          "getter": 'setup2_surchargecodediscount/get_set_surcharge_discount_surcharge_discount_list',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_patch_set_surcharge_discount_surcharge_discount_list = await this.$dispatch(object_pass);

        var status = dispatch_response_patch_set_surcharge_discount_surcharge_discount_list.status
        ...
        if(status){
          ...
          var get_error_message = JSON.parse(dispatch_response_patch_set_surcharge_discount_surcharge_discount_list.response)
              if(get_error_message){
                this.showNotify('negative', get_error_message.detail);
              }else{
