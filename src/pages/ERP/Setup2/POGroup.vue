      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="row top_row">
              ...
              <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 text_right">
                  <Button v-on:receiveClick="handleShowCreatePOGroup"
                  :pass_label="'Create'"
                  :pass_no_caps="true"
                  :pass_square="true"
                  :pass_dense="true"
  ...
  <q-dialog v-model="delete_pogroup" persistent position="top">
    <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
      ...
      <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
        ...
        <q-btn flat :label="$language('D0156')" size="12px" font_color="'white'" color="'#D81111'" class="confirm_delete_button" @click="handleDeletePOGroup" /> <!-- OK -->
      </q-card-actions>
...
export default {
  ...
  methods:{
      ...
      handleShowCreatePOGroup(){
        this.$router.push({ name: "CreatePOGroup" });
      },
      ...
      async table_function(ori_payload){
        ...
        if(this.table_column.length != 0){
          ...
          if(this.table_column[1].filter_value != ''){
            xpayload.pass_json.mcode_glcode = this.table_column[1].filter_value;
          }
          if(this.table_column[2].filter_value != ''){
            xpayload.pass_json.code_group = this.table_column[2].filter_value;
          }
          if(this.table_column[3].filter_value != ''){
            xpayload.pass_json.inactive = this.table_column[3].filter_value;
          }
          if(this.table_column[4].filter_value != ''){
            xpayload.pass_json.system_generate = this.table_column[4].filter_value;
          }
          if(this.table_column[5].filter_value != ''){
            xpayload.pass_json.date_from = this.table_column[5].filter_value;
          }
          if(this.table_column[6].filter_value != ''){
            xpayload.pass_json.date_to = this.table_column[6].filter_value;
          }
        }
