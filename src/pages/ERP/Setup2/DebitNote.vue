  ...
  <div class="row main_container">
      ...
      <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div v-if="!edit_hq" class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Add Debit Note Location<br></div>
          <div v-else class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Edit Debit Note Location<br></div>
      ...
      <q-card-section class="row items-center dialog_header_custom" style="padding-left: 10px;">
          <div v-if="edit_hq" class="text-h6">Edit Debit Note<br></div>
          <div v-else class="text-h6">Add Debit Note<br></div>
          <q-space />
  ...
  methods:{
      ...
      async genarateAddButton(){
        ...
        if(!this.edit_hq){
          ...
          // this.showNotify('negative', get_error_message.message)
