<template>
  <div class="row main_container">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div v-if="page_function == 'gsttaxcodepurchase'">GST Tax Code Purchase</div>
      <div v-else-if="page_function == 'gsttaxcodesupply'">GST Tax Code Supply</div>
...
export default {
  ...
  methods:{
    ...
    handleShowCreateItemMaster(){
      if(this.page_function == 'gsttaxcodepurchase'){
        this.$router.push({ name: "CreateGSTTaxCodePurchase" });
      }else if(this.page_function == 'gsttaxcodesupply'){
        this.$router.push({ name: "CreateGSTTaxCodeSupply" });
      }
    },
