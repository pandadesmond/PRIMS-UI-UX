<template>
  <div class="row main_container">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div v-if="page_function == 'goodreceivenote'">Goods Receive Note</div>
      <div v-else-if="page_function == 'debitnote'">Debit Note</div>
      <div v-else-if="page_function == 'creditnote'">Credit Note</div>
      <div v-else-if="page_function == 'transform'">Transform</div>
      <div v-else-if="page_function == 'ibtpicking'">IBT Picking</div>
      <div v-else-if="page_function == 'pocancellation'">PO Cancellation</div>
      <div v-else-if="page_function == 'socancellation'">SO Cancellation</div>
      <div v-else-if="page_function == 'reducetoclear'">Reduce To Clear</div>
      ...
      <div class="row top_row">
        ...
        <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 text_right">
          ...
          <Button
            v-on:receiveClick="handleClickFilter"
            :pass_label="'Filter'"
            :pass_no_caps="true"
            :pass_square="true"
            :pass_dense="true"
    ...
    <q-dialog v-model="show_hq_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
      ...
      <q-card-section class="row items-center dialog_header_custom">
          <div v-if="edit_hq" class="text-h6">
            <div v-if="page_function == 'goodreceivenote'">Edit Goods Receive Note</div>
            <div v-else-if="page_function == 'debitnote'">Edit Debit Note</div>
            <div v-else-if="page_function == 'creditnote'">Edit Credit Note</div>
            <div v-else-if="page_function == 'transform'">Edit Transform</div>
            <div v-else-if="page_function == 'ibtpicking'">Edit IBT Picking</div>
            <div v-else-if="page_function == 'pocancellation'">Edit PO Cancellation</div>
            <div v-else-if="page_function == 'socancellation'">Edit SO Cancellation</div>
            <div v-else-if="page_function == 'reducetoclear'">Edit Reduce To Clear</div>
          </div>

          <div v-else class="text-h6">
            <div v-if="page_function == 'goodreceivenote'">Add Goods Receive Note</div>
            <div v-else-if="page_function == 'debitnote'">Add Debit Note</div>
            <div v-else-if="page_function == 'creditnote'">Add Credit Note</div>
            <div v-else-if="page_function == 'transform'">Add Transform</div>
            <div v-else-if="page_function == 'ibtpicking'">Add IBT Picking</div>
            <div v-else-if="page_function == 'pocancellation'">Add PO Cancellation</div>
            <div v-else-if="page_function == 'socancellation'">Add SO Cancellation</div>
            <div v-else-if="page_function == 'reducetoclear'">Add Reduce To Clear</div>
          </div>
          <q-space />
...
export default {
  ...
  methods:{
    ...
    async table_function(ori_payload){
        ...
        if(this.page_function == 'goodreceivenote'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "GRN_REASON",
              "outlet_guid": this.session_outlet_guid,
        ...
        }else if(this.page_function == 'transform'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "Reason_transf",
              "outlet_guid": this.session_outlet_guid,
              "language": this.language,
              "limit": this.ori_params.params.limit,
              "skip": this.ori_params.params.skip,
        ...
        }else if(this.page_function == 'ibtpicking'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "IBTPicking",
              "outlet_guid": this.session_outlet_guid,
              "language": this.language,
              "limit": this.ori_params.params.limit,
              "skip": this.ori_params.params.skip,
        ...
        }else if(this.page_function == 'pocancellation'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "POCancel",
              "outlet_guid": this.session_outlet_guid,
        ...
        }else if(this.page_function == 'socancellation'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "SOCancel",
              "outlet_guid": this.session_outlet_guid,
        ...
        }else if(this.page_function == 'reducetoclear'){
          var xpayload = {
            "pass_json":{
              "TRANS_TYPE": "RTC",
              "outlet_guid": this.session_outlet_guid,
