<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateBranch' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreateBranch'" class="text-subtitle1 header_text">
         New Branch
        </div>
        <div v-if="page_function == 'EditBranch'" class="text-subtitle1 header_text">
          Edit Branch > {{ json.BRANCH_CODE }}
        </div>
    </div>
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeSetPriority"
                                v-model="json.SET_PRIORITY "
                                :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />
                          </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Location Group Code'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  :autofocusclick="false"
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeBranchCode"
                                  v-model="json.BRANCH_CODE "
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeBranchName"
                                  v-model="json.BRANCH_NAME "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Allocation Ratio'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  :autofocusclick="false"
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeSetRatio"
                                  v-model="json.SET_RATIO "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeBranchAdd"
                                  v-model="json.BRANCH_ADD "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeBranchTel"
                                  v-model="json.BRANCH_TEL "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.tel : oridbComponentBehavior.tel" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeBranchFax"
                                  v-model="json.BRANCH_FAX "
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.fax : oridbComponentBehavior.fax" />
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Customer Code'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <SelectFilter
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.SET_CUSTOMER_CODE"
                                :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.select"
                                :options="customercode_options"
                                v-on:receiveChange="handleChangeSetCustomerCode"
                                />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <SelectFilter
                                :readonly="false"
                                :no_label="false"
                                v-model:pass_value="json.SET_SUPPLIER_CODE"
                                :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.select"
                                :options="suppliercode_options"
                                v-on:receiveChange="handleChangeSetSupplierCode"
                                />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeCompanyName"
                                  v-model="json.company_name"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeCompanyID"
                                  v-model="json.company_id"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Script Database Tablename'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  :autofocusclick="false"
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeScriptDatabaseTablename"
                                  v-model="json.script_database_tablename"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Period End On'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  :autofocusclick="false"
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangePeriodEndOn"
                                  v-model="json.PeriodEndOn"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />
                            </div>
                          </div>
                      </div>
                      ...
                      <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Last Recal Date'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  :autofocusclick="false"
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeLastRecalDateTime"
                                  v-model="json.LastRecalDateTime"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div> -->
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                  ...
                                  :no_label="false"
                                  :readonly="false"
                                  v-on:change="handleChangeRecalTime"
                                  v-model="json.RecalTime"
                                  :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div> -->
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Label :pass_value="'None Trade as Stock'" />
                          </div>
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Checkbox
                              :btm_padding="true"
                              size="xs"
                              :disable="false"
                              v-model="json.nontrade_as_stock"
                              :true-value="1"
                              :false-value="0"
                              v-on:receiveChangenewVal="handleChangeNoneTradeasstock"/>
                          </div>
                          </div>
                      </div>
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Checkbox
                              ...
                              :true-value="1"
                              :false-value="0"
                              v-on:receiveChangenewVal="handleChangeDC"/>
                          </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Label :pass_value="'Replenishment ADS Allocation'" />
                          </div>
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <Checkbox
                              :btm_padding="true"
                              size="xs"
                              :disable="false"
                              v-model="json.rep_all_ads"
                              :true-value="1"
                              :false-value="0"
                              v-on:receiveChangenewVal="handleChangeReplenishmentADSAllocation"/>
                          </div>
                          </div>
                      </div>
      ...
      <q-card-actions class="dialog_action justify-between" style="padding-bottom: 10px;">
        <span class="q-pl-xs">
          ...
          <span class="q-pl-xs">
              ...
              v-on:receiveClick="handleCreateBranch"/>
          </span>
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateBranch' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateBranch'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditBranch'" :icon="'chevron_left'" :square="true" :label="'Edit Surcharge Code' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
...
export default{
  data() {
    return {
      ...
      customercode_options:[],
      suppliercode_options:[],
      step:1,
  ...
  async mounted()
  {
    ...
    await this.get_customer_code_options()
    await this.get_supplier_code_options()


    if(this.page_function === 'EditBranch'){
  ...
  methods: {
    async get_customer_code_options(){
      var payload = {
        "pass_json":{
          "Type": "C",
      ...
      var object_pass = {
        "dispatch": 'setup2_branch/trigger_get_supcus_read_supcus_all',
        "getter": 'setup2_branch/get_supcus_read_supcus_all',
        "app": this,
        "payload": payload,
      };

      var dispatch_response_get_supcus_read_supcus_all = await this.$dispatch(object_pass);

      var status = dispatch_response_get_supcus_read_supcus_all.status

      if(status){
        var get_supcus_read_supcus_all = dispatch_response_get_supcus_read_supcus_all.response.detail
        var arr = []
        for (var i in get_supcus_read_supcus_all){
          var obj = {
            "label": get_supcus_read_supcus_all[i].Code,
            "value": get_supcus_read_supcus_all[i].Code
          }
          this.customercode_options.push(obj)
        }
        // this.customercode_options = arr
      }
    },
    async get_supplier_code_options(){
      var payload = {
        "pass_json":{
          "Type": "S",
          "outlet_guid": this.session_outlet_guid,
      ...
      if(status){
        ...
        for (var i in get_supcus_read_supcus_all){
          ...
          this.suppliercode_options.push(obj)
        }
        // this.suppliercode_options = arr
      }
    },
    ...
    async fetchAllData(){
      var payload = {
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
          "language": this.language,
          "BRANCH_GUID": this.$route.query.BranchGuid,
        },
      }

      var object_pass = {
        "dispatch": 'setup2_branch/trigger_get_cp_set_branch',
        "getter": 'setup2_branch/get_cp_set_branch',
        "app": this,
        "payload": payload,
      };


      var dispatch_response_get_cp_set_branch = await this.$dispatch(object_pass);
      var status = dispatch_response_get_cp_set_branch.status

        if(status){
          this.json.set_active = dispatch_response_get_cp_set_branch.response.detail[0].set_active,
          this.json.SET_PRIORITY = dispatch_response_get_cp_set_branch.response.detail[0].SET_PRIORITY,
          this.json.company_name = dispatch_response_get_cp_set_branch.response.detail[0].company_name,
          this.json.BRANCH_NAME = dispatch_response_get_cp_set_branch.response.detail[0].BRANCH_NAME,
          this.json.BRANCH_CODE = dispatch_response_get_cp_set_branch.response.detail[0].BRANCH_CODE,
          this.json.branch_desc = dispatch_response_get_cp_set_branch.response.detail[0].branch_desc,
          this.json.SET_RATIO = dispatch_response_get_cp_set_branch.response.detail[0].SET_RATIO,
          this.json.BRANCH_ADD = dispatch_response_get_cp_set_branch.response.detail[0].BRANCH_ADD,
          this.json.BRANCH_TEL = dispatch_response_get_cp_set_branch.response.detail[0].BRANCH_TEL,
          this.json.BRANCH_FAX = dispatch_response_get_cp_set_branch.response.detail[0].BRANCH_FAX,
          this.json.SET_CUSTOMER_CODE = dispatch_response_get_cp_set_branch.response.detail[0].SET_CUSTOMER_CODE,
          this.json.SET_SUPPLIER_CODE = dispatch_response_get_cp_set_branch.response.detail[0].SET_SUPPLIER_CODE,
          this.json.company_id = dispatch_response_get_cp_set_branch.response.detail[0].company_id,
          this.json.script_database_tablename = dispatch_response_get_cp_set_branch.response.detail[0].script_database_tablename,
          this.json.PeriodEndOn = dispatch_response_get_cp_set_branch.response.detail[0].PeriodEndOn,
          this.json.nontrade_as_stock = dispatch_response_get_cp_set_branch.response.detail[0].nontrade_as_stock,
          this.json.is_dc = dispatch_response_get_cp_set_branch.response.detail[0].is_dc,
          this.json.rep_all_ads = dispatch_response_get_cp_set_branch.response.detail[0].rep_all_ads
        }
    },
    ...
    handleChangeSetPriority(newVal){
      this.$nextTick(()=>{
        this.json.SET_PRIORITY = newVal;
      });
    },
    handleChangeBranchCode(newVal){
      this.$nextTick(()=>{
        this.json.BRANCH_CODE = newVal;
      });
    },
    handleChangeBranchName(newVal){
      this.$nextTick(()=>{
        this.json.BRANCH_NAME = newVal;
      });
    },
    handleChangeDescription(newVal){
      this.$nextTick(()=>{
        this.json.branch_desc = newVal;
      });
    },
    handleChangeSetRatio(newVal){
      this.$nextTick(()=>{
        this.json.SET_RATIO = newVal;
      });
    },
    handleChangeBranchAdd(newVal){
      this.$nextTick(()=>{
        this.json.BRANCH_ADD = newVal;
      });
    },
    handleChangeBranchTel(newVal){
      this.$nextTick(()=>{
        this.json.BRANCH_TEL = newVal;
      });
    },
    handleChangeBranchFax(newVal){
      this.$nextTick(()=>{
        this.json.BRANCH_FAX = newVal;
      });
    },
    handleChangeSetCustomerCode(newVal){
      this.$nextTick(()=>{
        this.json.SET_CUSTOMER_CODE = newVal;
      });
    },
    handleChangeSetSupplierCode(newVal){
      this.$nextTick(()=>{
        this.json.SET_SUPPLIER_CODE = newVal;
      });
    },
    handleChangeCompanyName(newVal){
      this.$nextTick(()=>{
        this.json.company_name = newVal;
      });
    },
    handleChangeCompanyID(newVal){
      this.$nextTick(()=>{
        this.json.company_id = newVal;
      });
    },
    handleChangeScriptDatabaseTablename(newVal){
      this.$nextTick(()=>{
        this.json.script_database_tablename = newVal;
      });
    },
    handleChangePeriodEndOn(newVal){
      this.$nextTick(()=>{
        this.json.PeriodEndOn = newVal;
      });
    },
    handleChangeLastRecalDateTime(newVal){
      this.$nextTick(()=>{
        this.json.LastRecalDateTime = newVal;
      });
    },
    handleChangeRecalTime(newVal){
      this.$nextTick(()=>{
        this.json.RecalTime = newVal;
      });
    },
    handleChangeNoneTradeasstock(newVal){
      this.$nextTick(()=>{
        this.json.nontrade_as_stock = newVal;
      });
    },
    handleChangeDC(newVal){
      this.$nextTick(()=>{
        this.json.is_dc = newVal;
      });
    },
    handleChangeReplenishmentADSAllocation(newVal){
      this.$nextTick(()=>{
        this.json.rep_all_ads = newVal;
      });
    },
    ...
    async handleDeletePOGroup(){
      ...
      var payload = {
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
          "language": this.language,
          "BRANCH_GUID": this.get_code_guid,
        }
      }

      var object_pass = {
        "dispatch": 'setup2_branch/trigger_delete_cp_set_branch',
        "getter": 'setup2_branch/get_cp_set_branch',
        "app": this,
        "payload": payload,
      };

      var dispatch_response_delete_cp_set_branch = await this.$dispatch(object_pass);
      console.log('dispatch_response_delete_cp_set_branch', dispatch_response_delete_cp_set_branch);

      var status = dispatch_response_delete_cp_set_branch.status
      ...
      if(status){
        ...
        var get_error_message = JSON.parse(dispatch_response_delete_cp_set_branch.response)
    ...
    async handleCreateBranch(){
      ...
      if(this.page_function == 'CreateBranch'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": this.language,
            "set_active": this.json.set_active ? 1 : 0,
            "SET_PRIORITY": this.json.SET_PRIORITY,
            "company_name": this.json.company_name,
            "BRANCH_NAME": this.json.BRANCH_NAME,
            "BRANCH_CODE": this.json.BRANCH_CODE,
            "branch_desc": this.json.branch_desc,
            "SET_RATIO": this.json.SET_RATIO,
            "BRANCH_ADD": this.json.BRANCH_ADD,
            "BRANCH_TEL": this.json.BRANCH_TEL,
            "Created_by": this.user_name,
            "Updated_by": this.user_name,
            "BRANCH_FAX": this.json.BRANCH_FAX,
            "SET_CUSTOMER_CODE": this.json.SET_CUSTOMER_CODE,
            "SET_SUPPLIER_CODE": this.json.SET_SUPPLIER_CODE,
            "company_id": this.json.company_id,
            "script_database_tablename": this.json.script_database_tablename,
            "PeriodEndOn": this.json.PeriodEndOn,
            // "LastRecalDateTime": this.json.LastRecalDateTime,
            // "RecalTime": this.json.RecalTime,
            "nontrade_as_stock": this.json.nontrade_as_stock ? 1 : 0,
            "is_dc": this.json.is_dc ? 1 : 0,
            "rep_all_ads": this.json.rep_all_ads ? 1 : 0,
          }
        }

        var object_pass = {
          "dispatch": 'setup2_branch/trigger_create_cp_set_branch',
          "getter": 'setup2_branch/get_cp_set_branch',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_create_cp_set_branch = await this.$dispatch(object_pass);

        var status = dispatch_response_create_cp_set_branch.status

        if(status){
          this.showNotify('positive', 'Created Successfully')
          this.$router.push({name: "branch", params:{data: JSON.stringify() }});
        }else{
          var get_error_message = JSON.parse(dispatch_response_create_cp_set_branch.response)
          if(get_error_message){
            this.showNotify('negative', get_error_message.detail);
          }else{
      ...
      }else if(this.page_function == 'EditBranch'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": this.language,
        ...
        var object_pass = {
          "dispatch": 'setup2_branch/trigger_patch_cp_set_branch',
          "getter": 'setup2_branch/get_cp_set_branch',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_patch_cp_set_branch= await this.$dispatch(object_pass);

        var status = dispatch_response_patch_cp_set_branch.status

        if(status){
          this.showNotify('positive', 'Updated Successfully')
          // this.$router.push({name: "surchargecode", params:{data: JSON.stringify() }});
          // window.location.reload()
        }else{
          var get_error_message = JSON.parse(dispatch_response_patch_cp_set_branch.response)
          if(get_error_message){
            this.showNotify('negative', get_error_message.detail);
          }else{
            this.showNotify('nagative', 'Created Failed')
