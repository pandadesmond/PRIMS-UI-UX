<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateGSTTaxCodeSupply' ? 'chip-container_2' : 'chip-container_1'">
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateGSTTaxCodeSupply' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateGSTTaxCodeSupply'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditGSTTaxCodeSupply'" :icon="'chevron_left'" :square="true" :label="'Edit Surcharge Code' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
...
export default{
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditGSTTaxCodeSupply'){
  ...
  methods: {
    ...
    async handleCreateSurcharge(){
      ...
      if(this.page_function == 'CreateGSTTaxCodeSupply'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": "EN",
