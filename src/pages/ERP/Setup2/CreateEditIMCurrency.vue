<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateCurrency' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreateCurrency'" class="text-subtitle1 header_text">
         New Currency
        </div>
        <div v-if="page_function == 'EditCurrency'" class="text-subtitle1 header_text">
          Edit Currency > {{ $route.query.CurrencyCode }}
          <!-- Edit Currency / {{ $route.query.CurrencyCode }} -->
        </div>
    </div>
      <q-form ref="save_form">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="page_function == 'EditCurrency' ? true : false"
                      ...
                      <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px; padding-top: 10px;">
                        <div class="row" style="align-items: center;">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              <Label :pass_value="'Currency Sign'" />
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                :autofocusclick="false"
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeCurrencySign"
                                v-model="json.Currency_sign"
                                :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />
                            </div>
                          </div>
                      </div> -->
        ...
        <q-card flat class="card-container" style="max-height: 100%; padding: 10px;border-radius: 0px; padding-top: 0px;padding-left: 0px;">
          <q-card-section class="upload_container" style="font-size: 10px;">
            ...
            <q-card-actions class="dialog_action row" style="padding-left: 10px; padding-right: 0px;">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <q-toolbar class="bg-white q-pl-sm custom_toolbar" >
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
                        <Button
                          v-if="page_function == 'EditCurrency'"
                          v-on:receiveClick="addButtonCurrency"
                          :pass_label="'Create'"
                          :pass_no_caps="true"
                          :pass_square="true"
                          :pass_dense="true"
...
<!-- :row_per_page="[10,20,50,1000]" -->
                          ...
                          />
                          <!-- :handleActionColumn="'effective_date'" -->
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateCurrency' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateCurrency'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditCurrency'" :icon="'chevron_left'" :square="true" :label="'Edit Currency' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
  ...
  <q-dialog v-model="delete_child" persistent position="top">
    <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
      ...
      <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
        ...
        <q-btn flat :label="$language('D0156')" size="12px" font_color="'white'" color="'#D81111'" class="confirm_delete_button" @click="handleDeleteCurrencyC" /> <!-- OK -->
      </q-card-actions>
  ...
  <q-dialog v-model="show_barcode_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile" :style="{ textAlign: (!status && edit_barcode) ? 'center' : 'left' }">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div v-if="!edit_barcode" class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Add Currency<br></div>
          <div v-else class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Edit Currency<br></div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Datepicker
                                ...
                                :componentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required2 : oridbComponentBehavior.text" />
                            </div>
      ...
      <q-card-actions  class="dialog_action" style="padding-right:24px; padding-left: 24px;">
        <div class="row full-width">
          ...
          <div class="full-width">
            <Button_icon class="full-width custom_primary_button" style="height: 30px;" :small_round="true" :text="'ADD'" :flat="false" :font_color="'white'" :color="'#1E90FF'" :outline="false" size="16px" @click="handleCreateCurrency"/>
          </div>
    ...
    <q-card v-else style="width: 95vw; max-width: 950px; max-height: 90vh; margin-top: 5%;">
      <q-card-section class="row items-center dialog_header_custom">
          <div v-if="edit_barcode" class="text-h6">Edit Currency</div>
          <div v-else class="text-h6">Add Currency</div>
          <q-space />
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" :class="!edit_child ? '': ''">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row" style="align-items: center;">
                              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <Label :pass_value="'Currency Rate'" />
                              </div>
                              ...
                              <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <Input
                                  ...
                                  v-on:change="handleChangeRate"
                                  v-model="currency_rate"
                                  :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.input_number_no_require : oridbComponentBehavior.input_number_no_require" />
                              </div>
                            </div>
                          </div>
                        </div>
...
export default{
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditCurrency'){
  ...
  methods: {
    async fetchAllData(){
      ...
      var object_pass = {
        ...
        if(status){
          this.json.Code = dispatch_response_get_currency_read_currency.response.detail[0].currency_code,
          this.json.Description = dispatch_response_get_currency_read_currency.response.detail[0].currency_desc
          // this.json.Currency_sign = dispatch_response_get_currency_read_currency.response.detail[0].currency_sign
          // this.json.Default = dispatch_response_get_currency_read_currency.response.detail[0].currency_default ? 1 : 0
        }
    },
    ...
    async handleCreateCurrency(){
      ...
      if(this.page_function == 'CreateCurrency'){
        ...
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
          "language": this.language,
          "currency_code": this.json.Code,
          "currency_desc": this.json.Description,
          // "currency_sign": this.json.Currency_sign,
          // "currency_default": this.json.Default ? 1 : 0,
          "created_by": this.user_name
        }
      }

      var object_pass = {
          "dispatch": 'setup2_currency/trigger_create_currency_read_currency',
          "getter": 'setup2_currency/get_currency_read_currency',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_create_currency_read_currency= await this.$dispatch(object_pass);
        var status = dispatch_response_create_currency_read_currency.status

        if(status){
          this.showNotify('positive', 'Created Successfully')
          this.$router.push({
              name: "EditCurrency",
              query: { CurrencyCode: dispatch_response_create_currency_read_currency.response.currency_guid}
          });
        }else{
          var get_error_message = JSON.parse(dispatch_response_create_currency_read_currency.response)
      ...
      var object_pass = {
          "dispatch": 'setup2_currency/trigger_patch_currency_read_currency',
          "getter": 'setup2_currency/get_currency_read_currency',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_patch_currency_read_currency= await this.$dispatch(object_pass);
        var status = dispatch_response_patch_currency_read_currency.status

        if(status){
          this.showNotify('positive', 'Updated Successfully')
        }else{
          var get_error_message = JSON.parse(dispatch_response_patch_currency_read_currency.response)
          if(get_error_message){
            this.showNotify('negative', get_error_message.detail);
          }else{
            this.showNotify('nagative', 'Updated Failed')
    ...
    handleChangeEffectiveDate(newVal){
      this.$nextTick(()=>{
        this.effective_date = newVal;
      });
    },
    handleChangeRate(newVal){
      this.$nextTick(()=>{
        this.currency_rate = newVal;
      });
    },
    ...
    handleChangeCurrencySign(newVal){
      this.$nextTick(()=>{
        this.json.Currency_sign = newVal;
      });
    },
    handleChangeDefault(newVal){
      this.$nextTick(()=>{
        this.json.Default = newVal;
      });
    },

    addButtonCurrency(payload){
      this.showAddLoading = true
    ...
    handleReceiveHandleEdit(pass_payload){
      ...
      // this.currency_sign = pass_payload.row.currency_sign
      // this.currency_default = pass_payload.row.currency_default
    ...
    handleReceiveHandleDelete(pass_payload){
      this.get_detail_guid = pass_payload.row.detail_guid
      this.get_currency_guid = pass_payload.row.currency_guid

      // this.delete_child = true;
    },
   async handleDeleteCurrencyC(){
      ...
      var payload = {
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
          "language": this.language,
          "detail_guid": this.get_detail_guid,
          "currency_guid": this.get_currency_guid
        }
      }

      var object_pass = {
        "dispatch": 'setup2_currency/trigger_delete_currency_read_currency_c',
        "getter": 'setup2_currency/get_currency_read_currency_c',
        "app": this,
        "payload": payload,
      };

      var dispatch_response_delete_currency_read_currency_c = await this.$dispatch(object_pass);

      var status = dispatch_response_delete_currency_read_currency_c.status
      ...
      if(status){
        ...
        var get_error_message = JSON.parse(dispatch_response_delete_currency_read_currency_c.response)
        if(get_error_message){
          this.showNotify('negative', get_error_message.detail);
          this.deleteLoading = false
        }else{
    ...
    async handleAction(payload){
      ...
      // }else
        ...
        this.currency_rate = payload.currency_rate
    ...
    back(){
      ...
      else if(this.page_function.endsWith('Currency'))
      {
    ...
    async table_function(ori_payload){
        ...
        var object_pass = {
          "dispatch": 'setup2_currency/trigger_get_currency_read_currency_c',
          "getter": 'setup2_currency/get_currency_read_currency_c',
          "app": this,
          "payload": xpayload,
        };

        var dispatch_response_get_currency_read_currency_c = await this.$dispatch(object_pass);
        var status = dispatch_response_get_currency_read_currency_c.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_get_currency_read_currency_c.response.detail;
          ...
          if(this.page_function == 'CreateCurrency'){
              ...
              this.table_data = {
              "data": {
                "count": dispatch_response_get_currency_read_currency_c.response.total_row,
                "next": null,
                "previous": null,
                "results": dispatch_response_get_currency_read_currency_c.response.detail
              }
            };
          }


          this.results = dispatch_response_get_currency_read_currency_c.response.detail;
