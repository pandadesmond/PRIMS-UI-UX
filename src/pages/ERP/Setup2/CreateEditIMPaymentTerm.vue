<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreatePaymentTerm' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreatePaymentTerm'" class="text-subtitle1 header_text">
         New Payment Term
        </div>
        <div v-if="page_function == 'EditPaymentTerm'" class="text-subtitle1 header_text">
          Edit Payment Term > {{ $route.query.PaymentTermCode }}
        </div>
    </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="page_function == 'EditPaymentTerm' ? true : false"
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <q-toolbar class="bg-white q-pl-sm custom_toolbar" >
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
                        <Button
                          v-if="page_function == 'EditPaymentTerm'"
                          v-on:receiveClick="addButtonPaymentTerm"
                          :pass_label="'Create'"
                          :pass_no_caps="true"
                          :pass_square="true"
                          :pass_dense="true"
...
<!--
      ...
      <q-card-actions class="dialog_action justify-between" style="padding-bottom: 10px;">
        <span class="q-pl-xs">
          ...
          <span class="q-pl-xs">
              ...
              v-on:receiveClick="handleCreatePaymentTerm"/>
          </span>
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreatePaymentTerm' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreatePaymentTerm'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditPaymentTerm'" :icon="'chevron_left'" :square="true" :label="'Edit Payment Term' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
  ...
  <q-dialog v-model="delete_child" persistent position="top">
    <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
      ...
      <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
        ...
        <q-btn flat :label="$language('D0156')" size="12px" font_color="'white'" color="'#D81111'" class="confirm_delete_button" @click="handleDeletePaymentC" /> <!-- OK -->
      </q-card-actions>
  ...
  <q-dialog v-model="show_barcode_dialog" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile" :style="{ textAlign: (!status && edit_barcode) ? 'center' : 'left' }">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div v-if="!edit_barcode" class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Add Payment Term<br></div>
          <div v-else class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Edit Payment Term<br></div>
                      ...
                      <div class="row">
                        ...
                        <div class="row" style="align-items: center;">
                              ...
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      ...
                                      v-model="json.DayTo"
                                      :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />                        </div>
                                </div>
                            </div>
                              ...
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      ...
                                      :no_label="false"
                                      :readonly="false"
                                      v-on:change="handleChangePayType"
                                      v-model="json.PayType"
                                      :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text" />                        </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right: 10px; padding-top: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <Label :pass_value="'Interval Days'" />
                                  </div>
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      :autofocusclick="false"
                                      :no_label="false"
                                      :readonly="false"
                                      v-on:change="handleChangeIntervalDays"
                                      v-model="json.IntervalDays"
                                      :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />                        </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right: 10px; padding-top: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <Label :pass_value="'Interval Month'" />
                                  </div>
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      :autofocusclick="false"
                                      :no_label="false"
                                      :readonly="false"
                                      v-on:change="handleChangeIntervalMonths"
                                      v-model="json.IntervalMonths"
                                      :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />                        </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right: 10px; padding-top: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <Label :pass_value="'Interval Week'" />
                                  </div>
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      :autofocusclick="false"
                                      :no_label="false"
                                      :readonly="false"
                                      v-on:change="handleChangeIntervalWeeks"
                                      v-model="json.IntervalWeeks"
                                      :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.input_number_require : oridbComponentBehavior.input_number_require" />                        </div>
                                </div>
                            </div>
                          </div>
      ...
      <q-card-actions  class="dialog_action" style="padding-right:24px; padding-left: 24px;">
        <div class="row full-width">
          ...
          <div class="full-width">
            <Button_icon class="full-width custom_primary_button" style="height: 30px;" :small_round="true" :text="'ADD'" :flat="false" :font_color="'white'" :color="'#1E90FF'" :outline="false" size="16px" @click="handleEditPaymentTermC"/>
          </div>
...
<div class="row" style="align-items: center;">
    ...
    <q-card v-else style="width: 95vw; max-width: 950px; max-height: 90vh; margin-top: 5%;">
      <q-card-section class="row items-center dialog_header_custom">
          <div v-if="edit_barcode" class="text-h6">Edit Payment Term<br></div>
          <div v-else class="text-h6">Add Payment Term<br></div>
          <q-space />
      ...
      <q-card-actions class="dialog_action" align="right">
            ...
            <q-btn flat label="Confirm" color="primary" @click="handleAddPaymentTermC" />
        </q-card-actions>
...
export default{
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditPaymentTerm'){
  ...
  methods: {
    ...
    async fetchAllData(){
      var payload = {
        "pass_json":{
          ...
          "Code": this.$route.query.PaymentTermCode
        }
      }
      ...
      var object_pass = {
        ...
        var dispatch_response_get_payterm_get_pay_term= await this.$dispatch(object_pass);
        var status = dispatch_response_get_payterm_get_pay_term.status

        if(status){
          this.json.Code = dispatch_response_get_payterm_get_pay_term.response.detail[0].Code,
          this.json.Description = dispatch_response_get_payterm_get_pay_term.response.detail[0].Description
          this.json.set_active = dispatch_response_get_payterm_get_pay_term.response.detail[0].SetActive
        }
    },

    async handleCreatePaymentTerm(){
      ...
      if(this.page_function == 'CreatePaymentTerm'){
        var payload = {
        "pass_json":{
          "outlet_guid": this.session_outlet_guid,
          "language": this.language,
          ...
          "SetActive": this.json.set_active ? 1 : 0
        }
        }

      var object_pass = {
          "dispatch": 'setup2_paymentterm/trigger_create_payterm_get_pay_term',
          "getter": 'setup2_paymentterm/get_payterm_get_pay_term',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_create_payterm_get_pay_term= await this.$dispatch(object_pass);
        var status = dispatch_response_create_payterm_get_pay_term.status

        if(status){
          this.showNotify('positive', 'Created Successfully')
          this.$router.push({
              name: "EditPaymentTerm",
              query: { PaymentTermCode: dispatch_response_create_payterm_get_pay_term.response.Code}
          });
        }else{
          var get_error_message = JSON.parse(dispatch_response_create_payterm_get_pay_term.response)
      ...
      var object_pass = {
          "dispatch": 'setup2_paymentterm/trigger_patch_payterm_get_pay_term',
          "getter": 'setup2_paymentterm/get_payterm_get_pay_term',
          "app": this,
          "payload": payload,
        };

        var dispatch_response_patch_payterm_get_pay_term= await this.$dispatch(object_pass);
        var status = dispatch_response_patch_payterm_get_pay_term.status

        if(status){
          this.showNotify('positive', 'Updated Successfully')
          // this.$router.push({
          //     name: "EditPaymentTerm",
          //     query: { PaymentTermCode: dispatch_response_patch_payterm_get_pay_term.response.Code}
          // });
        }else{
          var get_error_message = JSON.parse(dispatch_response_patch_payterm_get_pay_term.response)
            if(get_error_message){
              this.showNotify('negative', get_error_message.detail);
            }else{
    ...
    // handleChangeLine(newVal){
    //   this.$nextTick(()=>{
    //     this.get_line = newVal;
    //   });
    // },
    handleChangeDayFrom(newVal){
      this.$nextTick(()=>{
        this.json.DayFrom = newVal;
      });
    },
    handleChangeDayTo(newVal){
      this.$nextTick(()=>{
        this.json.DayTo = newVal;
      });
    },
    handleChangePayType(newVal){
      this.$nextTick(()=>{
        this.json.PayTyp = newVal;
      });
    },
    handleChangeIntervalDays(newVal){
      this.$nextTick(()=>{
        this.json.IntervalDays = newVal;
      });
    },
    handleChangeIntervalMonths(newVal){
      this.$nextTick(()=>{
        this.json.IntervalMonths = newVal;
      });
    },
    handleChangeIntervalWeeks(newVal){
      this.$nextTick(()=>{
        this.json.IntervalWeeks = newVal;
      });
    },

    addButtonPaymentTerm(payload){
      ...
      if(!this.edit_barcode){
        ...
        this.json.DayTo = ''
        this.json.PayType = ''
        this.json.IntervalDays = ''
        this.json.IntervalMonths = ''
        this.json.IntervalWeeks = ''
      }
    ...
    handleReceiveHandleEdit(pass_payload){
      ...
      this.json.line = pass_payload.row.line
      this.json.DayFrom = pass_payload.row.DayFrom
      this.json.DayTo = pass_payload.row.DayTo
      this.json.PayType = pass_payload.row.PayType
      this.json.IntervalDays = pass_payload.row.IntervalDays
      this.json.IntervalMonths = pass_payload.row.IntervalMonths
      this.json.IntervalWeeks = pass_payload.row.IntervalWeeks
    ...
    async handleAddPaymentTermC(){
      // if(this.page_function == 'CreatePaymentTerm'){
      //   var payload = {
      //     "pass_json":{
      //       "outlet_guid": this.session_outlet_guid,
      //       "language": this.language,
      //       "currency_guid": this.$route.query.PaymentTermCode,
        ...
        if(!this.edit_barcode){
          var payload = {
            "pass_json":{
              ...
              "Code": this.$route.query.PaymentTermCode,
              // "line": this.json.line,
              "DayFrom": this.json.DayFrom,
              "DayTo": this.json.DayTo,
              "PayType": this.json.PayType,
              "IntervalDays": this.json.IntervalDays,
              "IntervalMonths": this.json.IntervalMonths,
              "IntervalWeeks": this.json.IntervalWeeks,
            }
          }

          var object_pass = {
            "dispatch": 'setup2_paymentterm/trigger_create_payterm_get_pay_term_child',
            "getter": 'setup2_paymentterm/get_payterm_get_pay_term_child',
            "app": this,
            "payload": payload,
          };

          var dispatch_response_create_payterm_get_pay_term_child = await this.$dispatch(object_pass);
          var status = dispatch_response_create_payterm_get_pay_term_child.status

          if(status){
            this.showNotify('positive', 'Created Successfully')
            this.table_function(this.ori_params)
          }else{
            var get_error_message = JSON.parse(dispatch_response_create_payterm_get_pay_term_child.response)
              if(get_error_message){
                this.showNotify('negative', get_error_message.detail);
              }else{
                this.showNotify('nagative', 'Created Failed')
          ...
          var object_pass = {
            "dispatch": 'setup2_paymentterm/trigger_patch_payterm_get_pay_term_child',
            "getter": 'setup2_paymentterm/get_payterm_get_pay_term_child',
            "app": this,
            "payload": payload,
          };

          var dispatch_response_patch_payterm_get_pay_term_child = await this.$dispatch(object_pass);
          var status = dispatch_response_patch_payterm_get_pay_term_child.status

          if(status){
            this.showNotify('positive', 'Updated Successfully')
            this.table_function(this.ori_params)
          }else{
            var get_error_message = JSON.parse(dispatch_response_patch_payterm_get_pay_term_child.response)
              if(get_error_message){
                this.showNotify('negative', get_error_message.detail);
              }else{
                this.showNotify('nagative', 'Updated Failed')
    ...
    async handleDeletePaymentC(){
      ...
      var object_pass = {
        "dispatch": 'setup2_paymentterm/trigger_delete_payterm_get_pay_term_child',
        "getter": 'setup2_paymentterm/get_payterm_get_pay_term_child',
        "app": this,
        "payload": payload,
      };

      var dispatch_response_delete_payterm_get_pay_term_child = await this.$dispatch(object_pass);

      var status = dispatch_response_delete_payterm_get_pay_term_child.status
      ...
      if(status){
        ...
        var get_error_message = JSON.parse(dispatch_response_delete_payterm_get_pay_term_child.response)
        if(get_error_message){
          this.showNotify('negative', get_error_message.detail);
          this.deleteLoading = false
        }else{
    ...
    async handleAction(payload){
      ...
      this.showAddLoading = true;
        ...
        this.json.line = payload.line
        this.json.DayFrom = payload.DayFrom
        this.json.DayTo = payload.DayTo
        this.json.PayType = payload.PayType
        this.json.IntervalDays = payload.IntervalDays
        this.json.IntervalMonths = payload.IntervalMonths
        this.json.IntervalWeeks = payload.IntervalWeeks
      }
    ...
    async table_function(ori_payload){
        ...
        var object_pass = {
          "dispatch": 'setup2_paymentterm/trigger_get_payterm_get_pay_term_child',
          "getter": 'setup2_paymentterm/get_payterm_get_pay_term_child',
          "app": this,
          "payload": xpayload,
        };

        var dispatch_response_get_payterm_get_pay_term_child = await this.$dispatch(object_pass);
        var status = dispatch_response_get_payterm_get_pay_term_child.status
        ...
        if(status == "failed"){
          ...
          var results = dispatch_response_get_payterm_get_pay_term_child.response.detail;

          // for(var i in results){
          //   this.get_line = results[i].line
          // }
          ...
          if(this.page_function == 'CreatePaymentTerm'){
              ...
              this.table_data = {
              "data": {
                "count": dispatch_response_get_payterm_get_pay_term_child.response.total_row,
                "next": null,
                "previous": null,
                "results": dispatch_response_get_payterm_get_pay_term_child.response.detail
              }
            };
          }


          this.results = dispatch_response_get_payterm_get_pay_term_child.response.detail;
