  ...
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateGSTTaxCodePurchase' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreateGSTTaxCodePurchase'" class="text-subtitle1 header_text">
         New GST Tax Code Purchase
        </div>
        <div v-if="page_function == 'CreateGSTTaxCodeSupply'" class="text-subtitle1 header_text">
         New GST Tax Code Supply
        </div>
        <div v-if="page_function == 'EditGSTTaxCodePurchase'" class="text-subtitle1 header_text">
          Edit GST Tax Code Purchase > {{ json.gst_tax_code }}
        </div>
        <div v-if="page_function == 'EditGSTTaxCodeSupply'" class="text-subtitle1 header_text">
          Edit GST Tax Code Supply > {{ json.gst_tax_code }}
        </div>
    </div>
    ...
    <q-form ref="save_form">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          >
            <q-step
              :name="1"
              :title="page_function === 'CreateGSTTaxCodePurchase' || page_function === 'EditGSTTaxCodePurchase' ? 'GST Tax Code Purchase' : 'GST Tax Code Supply'"
              icon="settings"
              :done="done1"
          ...
          <!-- <Button
            v-if="page_function == 'EditGSTTaxCodePurchase' || page_function == 'EditGSTTaxCodeSupply'"
            :disable="false"
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeGSTTaxType"
                                v-model="json.gst_tax_type "
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Input
                                ...
                                :no_label="false"
                                :readonly="false"
                                v-on:change="handleChangeGSTTaxCode"
                                v-model="json.gst_tax_code "
                                :dbComponentBehavior="dbComponentBehavior ?  dbComponentBehavior.text : oridbComponentBehavior.text"
                              />
                            </div>
                          </div>
    ...
    <q-card-actions class="dialog_action justify-between" style="padding-bottom: 10px;">
      <span class="q-pl-xs">
        ...
        <span class="q-pl-xs">
            ...
            v-on:receiveClick="handleCreateGST"/>
        </span>
...
export default {
  ...
  async mounted(){
    ...
    if(this.page_function === 'EditGSTTaxCodePurchase' || this.page_function === 'EditGSTTaxCodeSupply'){
  ...
  methods: {
    ...
    async handleDeletePOGroup(){
      ...
      }else if(this.page_function == 'EditGSTTaxCodeSupply'){
        var payload = {
          "pass_json":{
            "gst_trans_type": "S",
            "outlet_guid": this.session_outlet_guid,
    ...
    back(){
      if(this.page_function === 'CreateGSTTaxCodePurchase' || this.page_function === 'EditGSTTaxCodePurchase'){
        this.$router.push("gsttaxcodepurchase");
      }else if(this.page_function === 'CreateGSTTaxCodeSupply' || this.page_function === 'EditGSTTaxCodeSupply'){
        this.$router.push("gsttaxcodesupply");
      }
    },
    ...
    async handleCreateGST(){
      ...
      if(this.page_function == 'CreateGSTTaxCodePurchase'){
      ...
      }else if(this.page_function == 'CreateGSTTaxCodeSupply'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": "EN",
        ...
        if(status){
          this.showNotify('positive', 'Created Successfully')
          this.$router.push({name: "gsttaxcodesupply", params:{data: JSON.stringify() }});
        }else{
          var get_error_message = JSON.parse(dispatch_response_create_gst_read_gst.response)
          if(get_error_message){
            this.showNotify('negative', get_error_message.detail);
