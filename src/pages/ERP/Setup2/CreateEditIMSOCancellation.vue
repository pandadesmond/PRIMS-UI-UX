<template>
  <div v-if="$q.screen.width > 599" class="card_sides card_section">
    <div :class="page_function == 'CreateSOCancellation' ? 'chip-container_2' : 'chip-container_1'">
       <div v-if="page_function == 'CreateSOCancellation'" class="text-subtitle1 header_text">
         New SO Cancellation
        </div>
        <div v-if="page_function == 'EditSOCancellation'" class="text-subtitle1 header_text">
          Edit SO Cancellation
        </div>
    </div>
                        ...
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                              <Datepicker
                                ...
                                :componentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.text_required" />
                            </div>
                          </div>
                      </div>
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateSOCancellation' ? 'chip-container_2' : 'chip-container_1'">
          <Chip v-if="page_function == 'CreateSOCancellation'"  :label="$language('D0202')" :icon="'chevron_left'" text-color="grey-10" class="bold-font chip_sty back_chip_icon" @click="back()" />
          <Chip v-if="page_function == 'EditSOCancellation'" :icon="'chevron_left'" :square="true" :label="'Edit Surcharge Code' +' / '+json.Itemcode" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('Itemmaster')"/>
      </div>
...
export default{
  ...
  async mounted()
  {
    ...
    if(this.page_function === 'EditSOCancellation'){
  ...
  methods: {
    ...
    back(){
      this.$router.push("socancellation");
    },
    ...
    async handleCreatePOGroup(){
      ...
      if(this.page_function == 'CreateSOCancellation'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": "EN",
        ...
        console.log('dispatch_response_create_master_code_read_master_code_by_trans_type', dispatch_response_create_master_code_read_master_code_by_trans_type);
        ...
        if(status){
          ...
          this.$router.push({name: "socancellation", params:{data: JSON.stringify() }});
        }else{
      ...
      }else if(this.page_function == 'EditSOCancellation'){
        var payload = {
          "pass_json":{
            "outlet_guid": this.session_outlet_guid,
            "language": "EN",
        ...
        console.log('dispatch_response_update_master_code_read_master_code_by_trans_type', dispatch_response_update_master_code_read_master_code_by_trans_type);
