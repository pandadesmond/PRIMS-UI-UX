  ...
  <div class="row main_container">
      ...
      <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div v-if="!edit_hq" class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Add Adjustment Location<br></div>
          <div v-else class="text-subtitle1 mobile_dialog_bottom" style="padding:16px 24px;margin-top: 0px;box-shadow: 0px 0px 4px 0px rgba(0, 0, 0, 0.25);">Edit Adjustment Location<br></div>
      ...
      <q-card-section class="row items-center dialog_header_custom">
          <div v-if="edit_hq" class="text-h6">Edit Adjustment<br></div>
          <div v-else class="text-h6">Add Adjustment<br></div>
          <q-space />
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " :class="!edit_child ? '': ''">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 q-pt-xs">
                            <div class="row" style="align-items: center;">
                              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
...
export default {
  ...
  methods:{
      ...
      handleShowCreateItemMaster(){
        ...
        // this.$router.push({ name: "CreateAdjustment" });
      },
      ...
      handleReceiveHandleEdit(pass_payload)
      {
        ...
        this.code_group = pass_payload.row.code_group
      ...
      async table_function(ori_payload){
          ...
          var xpayload = {
            "pass_json":{
              ...
              "sort_by": payload.sort_by == "" ? "CODE_DESC" : payload.sort_by == "inactive_status" ? "inactive" : payload.sort_by,
          ...
          //   xpayload.pass_json.code_group = this.table_column[2].filter_value;
          //   if(this.table_column[3].filter_value != ''){
          //     xpayload.pass_json.inactive = Number(this.table_column[3].filter_value);
          //   }
          // }

          if(this.table_column.length != 0){
            xpayload.pass_json.CODE_DESC = this.table_column[0].filter_value;
            xpayload.pass_json.code_group = this.table_column[1].filter_value;
