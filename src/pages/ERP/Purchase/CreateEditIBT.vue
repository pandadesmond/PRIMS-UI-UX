  ...
  <div v-if="$q.screen.width > 599" class="card_sides">
    <q-card style="max-height: 100%;">
      ...
      <!-- <q-card-section class="theme_color dialog_header header_top">
        ...
        <div v-if="page_function == 'CreateInterbranchTransfer'" class="text-subtitle1 header_text">Interbranch Transfer</div>
        <div v-if="page_function == 'EditInterbranchTransfer'" class="text-subtitle1 header_text">
          Interbranch Transfer<br>
      ...
      <q-card-section class="upload_container content_body_dialog">
        <q-form ref="save_form">
          <div v-if="page_function == 'EditInterbranchTransfer'" class="intermediate_white"/>
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <q-stepper
                ...
                :class="page_function == 'EditInterbranchTransfer' ? 'sticky_stepper' : ''"
              >
                <q-step
                  :name="1"
                  title="Header"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                      <div class="row dialog_separator">
                        ...
                        <div v-if="json.BillStatus == 0 && !supplier_readonly" dir="rtl" class="col-xs-2 col-sm-1 col-md-1 col-lg-1 col-xl-1 input_wrapper_right">
                          ...
                          v-on:receiveClick="addButtonCreatePOChild('supplier')" style="margin-top: -2px;" :tooltip_message="'Search Supplier'"/>
                        </div>

                        <div v-if="page_function=='EditInterbranchTransfer'" class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row" :class="$q.screen.width < 1024 ? 'dialog_separator' : ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                ...
                <q-step
                  v-if="page_function == 'EditInterbranchTransfer'"
                  :name="2"
                  title="Detail"
                ...
                >
                  <div class="row upload_separator">
                      <div class="card_section_two col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          ...
                          :row_per_page="[0]"
                          :top_button="page_function=='EditInterbranchTransfer' && json.BillStatus == 0"
                ...
                <!-- <q-step
                  ...
                  :done="json.step > 3"
                >
                  <div v-if="page_function=='EditInterbranchTransfer'" class="row dialog_separator">
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <Input
      ...
      <q-card-actions class="dialog_action justify-between">
        <div v-if="this.json.step == 1">
          ...
          <span v-if="json.BillStatus == 0" class="q-pl-xs">
            ...
            v-on:receiveClick="handleCreateIBT"/>
          </span>

          <span v-if="page_function == 'EditInterbranchTransfer'" class="q-pl-xs">
            <Button_icon v-if="page_function=='EditInterbranchTransfer'" :flat="false" :font_color="'black'" :color="'white'" :text="'NEXT'" :outline="true" size="15px"
            @click="json.step = 2"/>
          </span>

          <!-- <q-btn v-if="page_function=='EditInterbranchTransfer'" @click="json.step = 2" color="primary" label="Next" />

          <span class="q-pl-xs">
            <q-btn color="primary" label="SAVE" @click="handleCreateIBT" />
          </span> -->
        </div >
  ...
  <div v-else class="card_sides">
    <q-card style="min-height: 100vh;">
      <q-card-section class="header_top">
        ...
        <div v-if="page_function == 'CreateInterbranchTransfer'" class="text-subtitle1 header_text" style="padding-top: 10px;">Interbranch Transfer</div>
        <div v-if="page_function == 'EditInterbranchTransfer'" class="text-subtitle1 header_text">Interbranch Transfer
        <br>Refno: {{ json.RefNo }}</div>
        <!-- <q-btn-dropdown v-if="page_function == 'EditInterbranchTransfer'" :disable="showAddLoading" class="custom_more_button" flat dense icon="more_vert">
          <q-list>
              ...
              >
                ...
                >
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                      <div class="row dialog_separator">
                        <div class="input_wrapper_right" :class="page_function == 'CreateInterbranchTransfer' ?  'col-xs-10' : json.BillStatus == 0 && !supplier_readonly ? 'col-xs-10' : 'col-xs-12'">
                          <div class="row" :class="$q.screen.width < 1024 ? 'dialog_separator' : ''">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="json.BillStatus == 1 ? true : json.BillStatus==1 || supplier_readonly"
                              :no_label="true"
                              v-model:pass_value="json.SCode"
                              :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.select"
                              :options="supplier_options"
                        ...
                        <div :class="page_function == 'CreateInterbranchTransfer' ? 'col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4' : 'col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4'" class="input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 input_wrapper_right">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Datepicker
                              :no_label="true"
                              :disable="json.BillStatus == 1 ? true : json.BillStatus==1"
                              :autoclose="true"
                              v-on:receiveChange="handleChangeDeliverDate"
                              :daterange="json.DeliverDate"
                              :componentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.text" />
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row dialog_separator">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :autofocusclick="true"
                              :no_label="true"
                              :readonly="json.BillStatus==1 ? true : page_function == 'CreateInterbranchTransfer'"
                              v-on:change="handleChangeExpInDays"
                              v-model="json.pur_expiry_days"
                              :dbComponentBehavior="dbComponentBehavior ? page_function == 'CreateInterbranchTransfer' ? dbComponentBehavior.text_right_readonly :  dbComponentBehavior.text_right : oridbComponentBehavior.text" />
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row dialog_separator">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                              :readonly="json.BillStatus == 1 ? true : json.BillStatus==1"
                              :no_label="true"
                              v-model:pass_value="json.loc_group"
                              :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior.text_required : oridbComponentBehavior.select"
                              :options="location_options"
                      ...
                      <div class="row">
                        ...
                        <div v-if="page_function=='EditInterbranchTransfer'" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 input_wrapper_right">
                          <div class="row dialog_separator">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Textarea class="ignore_height" :no_label="true" :readonly="json.BillStatus == 1 ? true : json.BillStatus==1" v-on:receiveChange="handleChange" v-model="json.Remark"
                              :dbComponentBehavior="dbComponentBehavior.remark" />
                            </div>
                          </div>
                        </div>
                ...
                <q-step
                  ...
                  :done="json.step > 2"
                >
                  <div v-if="page_function == 'EditInterbranchTransfer'" class="row">
    ...
    <div v-if="json.step == 1 || json.step == 3" class="dialog_action_bottom" :style="page_function == 'EditInterbranchTransfer' && json.BillStatus == 0 ? 'height: 65px;' : 'height: 40px;'">
      <div v-if="page_function == 'EditInterbranchTransfer'" class="row q-px-sm" :class="page_function == 'EditInterbranchTransfer' && json.BillStatus !== 0  ? 'q-pt-sm' :''" style="font-size: 13px;">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ">
    ...
    <div  class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
       <!-- POST BUTTON -->
       <span v-if="page_function == 'EditInterbranchTransfer'" class="q-pr-xs" :style="json.BillStatus == 1 ? 'width: 100%;' : 'width: 24%;'">
      ...
      <div class="row q-px-sm q-py-xs">
        <Button_icon v-if="json.BillStatus==0" :readonly="page_function.startsWith('Edit') && deepEqual(ori_json, json)" style="height: 30px; width: 100%" :small_round="true" :text="page_function.startsWith('Create') ? 'Generate Interbranch Transfer' : 'Update Interbranch Transfer'" :flat="false" :font_color="'white'" :color="'primary'" :outline="false" size="13px" @click="handleCreateIBT"/>
      </div>
    </div>

    <div v-if="json.step == 2" class="dialog_action_bottom" :style="page_function == 'EditInterbranchTransfer' && json.BillStatus== 0  ? 'height: 65px;' : 'height: 40px;'">
      <div v-if="page_function == 'EditInterbranchTransfer'" class="row q-px-sm" :class="page_function == 'EditInterbranchTransfer' && json.BillStatus !== 0  ? 'q-pt-sm' :''"  style="font-size: 13px;">
  ...
  <q-dialog v-model="modify_child" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
          <div v-if="!edit_child" class="text-subtitle1 header_text" style="margin-top: 5px;">Interbranch Transfer Detail<br></div>
          <div v-else class="text-subtitle1 header_text" style="margin-top: 5px;">Edit Interbranch Transfer Detail<br></div>
        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div v-if="hv_item" class="row dialog_separator">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 four_column_left">
                      <div class="row" :class="page_function == 'EditInterbranchTransfer' ? 'dialog_separator': ''">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
    ...
    <q-card v-else style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class=" row theme_color dialog_header" style="padding: 0px;">
          <div class="text-subtitle1 header_text" style="margin-top: 5px;">Interbranch Transfer Detail<br></div>
          <q-space />
          <q-btn icon="close" flat round dense @click="close()" :disable="false"/>
      </q-card-section>
...
export default{
  ...
  async created () {
    ...
    if(this.page_function == 'EditInterbranchTransfer')
    {
      var cpayload =
      {
        params: {
      ...
      var data = await this.getFilterIBT(payload);
  ...
  methods: {
    ...
    closeSearchItem()
      ...
      back(){
        ...
        if(this.page_function.endsWith('InterbranchTransfer'))
        {
          this.$router.push({name: 'InterbranchTransfer'});
        }
      },
      ...
      table_function(payload){
          ...
          this.$nextTick(async ()=>{
            ...
            if(this.page_function == 'CreateInterbranchTransfer')
            {
              data = {
                  "data": []
              };
            ...
            {
                data = await this.getIbtchild(payload);
      ...
      async savePO(){
          ...
          if(this.page_function == 'CreateInterbranchTransfer')
          {
            ...
            await this.$store.dispatch('purchase/trigger_create_ibt', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['purchase/get_ibt_status']));
            });
          }
          else if(this.page_function == 'EditInterbranchTransfer')
          {
            ...
            await this.$store.dispatch('purchase/trigger_update_ibt', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['purchase/get_ibt_status']));
            });
          }
          ...
          if(status == "success")
          {
            ...
            if(this.page_function == 'CreateInterbranchTransfer')
            {
              ...
              // if(mobile)
              // {
              //     this.$router.push({ name: 'confirm', query: { refno: data.response.RefNo, header: 'IBT', type:'create' }})
              // }
              // else
              // {
                  this.$router.push({ name: 'EditInterbranchTransfer', query: { refno: data.response.RefNo, step: 2 } })
              // }
            ...
            else if(this.page_function == 'EditInterbranchTransfer')
            {
                if(mobile)
                {
                  this.$router.push({ name: 'confirm', query: { refno: data.response.RefNo, header: 'IBT', type:'update' }})
                }
                else
                {
                  this.showNotify("positive", "Updated Successfully.");
