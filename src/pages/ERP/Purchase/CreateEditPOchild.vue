  ...
  <div class="card_sides">
    <q-card style="max-height: 100%;">
      <q-card-section class="theme_color dialog_header header_top">
          ...
          <div v-if="page_function.endsWith('PurchaseOrderDetails')" class="text-subtitle1 header_text">PO Detail<br>
            [ Refno: {{ json.RefNo }} ]
          </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              >
                <q-step
                  ...
                  :name="1"
                  :title="page_function.endsWith('PurchaseOrderDetails') ? 'PO Detail' : page_function.endsWith('InterbranchTransferDetails') ? 'IBT Detail' : 'GR Detail'"
                  icon="settings"
                ...
                >
                  ...
                  <div class="row input_wrapper_right">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <div class="row dialog_separator">
                        ...
                        <div v-if="page_function == 'EditPurchaseOrderDetails'" class="col-xs-6 col-sm-4 col-md-2 col-lg-2 col-xl-2" :class="$q.screen.width > 1023 ? 'q-pl-sm': ''">
                          <div class="row">
                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                              <Checkbox
                              size="xs"
                        ...
                        <div v-if="page_function=='EditPurchaseOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 four_column_left two_column_left">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 four_column_left" :class="page_function == 'CreatePurchaseOrderDetails' ? 'two_column_left': ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2" :class="page_function == 'CreatePurchaseOrderDetails' ? 'two_column_left' : ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      ...
                      <div class="row dialog_separator">
                        <div v-if="page_function=='EditPurchaseOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-5 col-md-2 col-lg-2 col-xl-2 four_column_left">
                          <div class="row">
                            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div class="col-xs-6 col-sm-2 col-md-1 col-lg-1 col-xl-1 four_column_left" :class="$q.screen.width>599 && $q.screen.width<1024 ? 'two_column_left' : page_function=='CreatePurchaseOrderDetails' ? 'two_column_left' : ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div v-if="page_function.endsWith('PurchaseOrderDetails')" class="col-xs-6 col-sm-2 col-md-2 col-lg-2 col-xl-2 four_column_left two_column_left">
                          <div class="row" :class="$q.screen.width<599 && page_function!='CreatePurchaseOrderDetails' ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                              :no_label="false"
                        ...
                        <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 four_column_left" :class="page_function == 'CreatePurchaseOrderDetails' ? 'two_column_left': ''">
                      ...
                      <div class="row dialog_separator">
                        ...
                        <div v-if="page_function=='EditPurchaseOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 four_column_left two_column_left">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div v-if="page_function=='EditPurchaseOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                  ...
                  <q-stepper-navigation>
                    ...
                    <span class="q-pl-xs">
                      <Button_icon v-if="page_function=='CreatePurchaseOrderDetails'" :flat="false" :font_color="'black'" :color="'white'" :text="'BACK'" :outline="true" size="15px"
                      @click="jsonChild.step = 1"/>
                    </span>

                    <!-- <q-btn color="primary" label="SAVE" @click="handleChild" />
                    <q-btn v-if="page_function=='CreatePurchaseOrderDetails'" flat @click="jsonChild.step = 1" color="primary" label="Back" class="q-ml-sm" /> -->
...
export default{
  ...
  async created () {
    ...
    if(this.page_function == 'EditPurchaseOrderDetails' || this.page_function == 'EditGoodsReceivingDetails' || this.page_function == 'EditInterbranchTransferDetails')
    {
      var cpayload = {
        params: {
          refno: this.$route.query.refno,
      ...
      if(this.page_function.endsWith('PurchaseOrderDetails'))
      {
  ...
  methods: {
      ...
      handleNewForm(){
        ...
        if(this.page_function =='CreatePurchaseOrderDetails')
        {
          this.$router.push({
      ...
      async savePOChild(newVal){
        ...
        else if(this.page_function.startsWith('Edit'))
        {
          ...
          if(this.page_function == 'EditPurchaseOrderDetails')
          {
            payload.Qty_foc = this.unformatAmount(this.jsonChild.Qty_foc);
