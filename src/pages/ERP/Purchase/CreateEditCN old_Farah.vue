...
<!-- GENERAL INFO -->
                  <div class="row first_dialog_separator">
                    <div class="row col-12">
                      <div class="col-3 left_col left_col_font">General Information</div>
                      <div class="col-9 row right_col">
                        <div class="row full-width">
                          ...
                          <div class="row col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-md">
                            ...
                            <div v-if="json.BillStatus == 0 && !supplier_readonly" dir="ltr" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                        ...
                        <div v-if="page_function=='EditCreditNote'" class="row full-width">
                          <div v-if="page_function=='EditCreditNote'" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md">
                    ...
                    <div class="row col-12">
                      <div class="col-3 left_col left_col_font">Document Details</div>
                      <div class="col-9 row right_col">
                        <div class="row full-width">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md">
...
<!-- BUTTONSS NAV/SAVE -->
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateCreditNote' ? 'chip-container_2' : 'chip-container_1'"> <!--D0224 -->
          ...
          <Chip v-if="page_function == 'EditCreditNote'" :icon="'chevron_left'" :square="true" :label="$language('D0030') +' : '+ json.RefNo" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('CreditNote')"/>
    </div>
                    ...
                    <!-- <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9"> -->
                      <div class="row col-12" style="gap:16px">
                        ...
                        <div v-if="json.BillStatus == 0 && !supplier_readonly" dir="rtl" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 q-pl-sm" style="padding-top: 0px;">
                            <Button_icon :small_round="true" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="false" size="13px"
          ...
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="row input_wrapper_right q-pb-md">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 row" :class="$q.screen.width > 1023 ? 'q-pl-sm': ''" style="gap: 8px;padding-bottom: 16px">
                      <div class="row col-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              <Button_icon :small_round="true" :readonly="false" :flat="false" :font_color="'primary'" :color="'white'" :icon="select_inv ? 'playlist_add_check' : 'drive_file_rename_outline'" :outline="false" size="16px"
                              v-on:receiveClick="changeInvoiceMethod()" style="height:100%" class="search_button_secondary search_button_secondary full-height full-width primary_button_font"/>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <div class="row" style="gap:16px;">
                        ...
                        <div v-if="!edit_child" dir="rtl" class=" col-xs-2 col-sm-1 col-md-2 col-lg-2 col-xl-2" style="padding-top: 0px;">
                          <Button_icon ref="searchButton" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="false" size="14px"
                          v-on:receiveClick="showSearchDialog()" class="full-width search_button search_button_icon primary_button_font" style="height:100%"/>
                        </div>
                        </div>
                        </div>
...
.search_button_icon >>>.q-icon {
    transition: transform 0.3s ease; /* Smooth transition */
}

.search_button_icon:hover >>> .q-icon{
    transform: scale(1.1); /* Enlarge the button on hover */
}

.search_button_icon:active >>> .q-icon{
