        ...
        <div v-if="page_function == 'CreateDebitNote'" class="text-subtitle1 header_text">Debit Note</div>
          <div v-if="page_function == 'EditDebitNote'" class="text-subtitle1 header_text">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-total">
              <span class="text-caption text-total text-bold" style="font-size:14px">{{ this.$language('D0145') }}: {{ currency_sign }} {{ json.SubTotal1 }}<br></span>
            </div>
          </div>
                    ...
                    <div class="row col-12">
                      ...
                      <div class="col-9 row right_section">
                        <div class="row full-width">
                          ...
                          <div class="row col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pl-md">
                            <div :class="json.BillStatus == 0 && !supplier_readonly ? 'col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10  q-pr-md' : 'col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'">
                              <SelectFilter
                            ...
                            <div v-if="json.BillStatus == 0 && !supplier_readonly"  class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                              <Button_icon :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="true" size="16px"
...
<!-- DOCUMENT DETAILS -->
                    <div class="row col-12">
                      ...
                      <div class="col-9 row right_section">
                        ...
                        <div v-if="page_function=='EditDebitNote'" class="row full-width">
                          <div v-if="page_function=='EditDebitNote'" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md">
                          <div class="row" :class="$q.screen.width < 1024 ? '' : ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
...
<!-- dncheckbox -->
                        ...
                        <div class="row col-12 q-col-gutter-y-md">
                          ...
                          <div class="col-3 checkbox_sty">
                            <div class="col-xs-7 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <span class="checkbox_InterfontMedium">B2B Status</span>
                                </div>
    ...
    <q-card-actions class="dialog_action justify-between">
        ...
        <span v-if="page_function == 'EditDebitNote'" class="q-gutter-x-md">
          ...
          <span v-if="json.BillStatus == 0 && (this.json.step == 1 || this.json.step == 3)" class="q-pl-xs">
            <Button_icon :flat="true" :font_color="'white'" :color="'#1E90FF'" :text="'SAVE'" :outline="false" size="16px" class="primary_actions_button"
            v-on:receiveClick="handleCreatePO"/>
          </span>
        </span>
        <Button_icon v-if="page_function == 'CreateDebitNote'" :flat="true" :font_color="'white'" :color="'#1E90FF'" :text="'SAVE'" :outline="false" size="16px"
  ...
  <div v-else class="card_sides">
    ...
    <div :class="page_function == 'CreateDebitNote' ? 'chip-container_2' : 'chip-container_1'">
          ...
          <Chip v-if="page_function == 'EditDebitNote'" :icon="'chevron_left'" :square="true" :label="$language('D0030') +' : '+ json.RefNo" text-color="grey-10" class="bold-font chip_sty" v-on:receiveClick="handleNavigate('DebitNote')"/>
    </div>
    <div class="row justify-left" >
                  <Button_icon class="summary_button q-pa-none q-ma-none" :flat="true" :label="currency_sign + ' ' + json.SubTotal1" v-on:receiveClick="show_summary_dialog" :font_color="'primary'" :color="'primary'" :outline="false" size="13px"/>
                  ...
                  <div class="row col-12" style="padding-top: 16px;gap:16px;">
                    <!-- <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9"> -->
                      <div class="row col-12" style="gap:16px">
                        ...
                        <div class="row col-12">
                        <div class="" :class="page_function == 'CreateDebitNote' ? 'col-xs-9 q-pr-sm' : json.BillStatus == 1 ? 'col-xs-12' : json.BillStatus == 0 && !supplier_readonly ? 'col-xs-9 q-pr-sm' : 'col-xs-12'">
                          <div class="row">
                            <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div v-if="json.BillStatus == 0 && !supplier_readonly" dir="rtl" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 q-pl-sm" style="padding-top: 0px;">
                            <Button_icon :small_round="true" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="false" size="15px"
                            v-on:receiveClick="addButtonCreatePOChild('supplier')" style="margin-top: 0px;height:100%" class="full-width full-height search_button primary_button_font"/>
                        </div>
                      </div>
          ...
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="row input_wrapper_right q-pb-md">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="row">
                    <div class="row col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" :class="$q.screen.width > 1023 ? 'q-pl-sm': ''" style="gap:8px; padding-bottom: 16px">
                      <div class="row col-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                          <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                      <div class="row ">
                        ...
                        <div v-if="!edit_child" dir="rtl" class="button_upload_wrapper col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2" style="padding-top: 0px;">
                            <Button_icon ref="searchButton" :small_round="true" :flat="false" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="false" size="15px"
                            v-on:receiveClick="showSearchDialog()" style="margin-top: 0px;height:100%" class="search_button_step2 search_button primary_button_font"/>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row full-height">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                          <div class="row full-height">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Button_icon :small_round="true" :readonly="false" :flat="false" :font_color="'primary'" :color="'white'" :icon="select_inv ? 'playlist_add_check' : 'drive_file_rename_outline'" :outline="false" size="13px"
                        ...
                        <div class="row col-12">
                            ...
                            <!-- <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md"> -->
                              ...
                              <div v-if="!edit_child" dir="rtl" class="q-pr-md col-xs-2 col-sm-1 col-md-2 col-lg-2 col-xl-2" style="padding-top: 0px;">
                                <Button_icon ref="searchButton" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="true" size="15px"
...
<!-- ori inv no -->
                    ...
                    <div v-if="json.BillStatus == 0" dir="rtl" class="q-pr-md col-xs-2 col-sm-1 col-md-2 col-lg-2 col-xl-2">
                      <Button_icon :flat="true" :font_color="'primary'" :color="'white'" :icon="select_inv ? 'playlist_add_check' : 'drive_file_rename_outline'" :outline="true" size="14px"
...
<!-- Input for DN DETAIL -->
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md">
                            <div class="row">
                              ...
                              <div v-if="!edit_child" dir="rtl" class=" col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2" style="padding-top: 0px;">
                                  <Button_icon ref="searchButton" :flat="true" :font_color="'primary'" :color="'white'" :icon="'search'" :outline="true" size="14px"
                                  v-on:receiveClick="showSearchDialog()" style="height:100%" class=" search_button_secondary search_button primary_button_font"/>
                              </div>
                              <!-- </div> -->
                            </div>
                          </div>
      ...
      <q-card-actions v-if="json.BillStatus == 0" class="" style="padding-right: 16px;padding-bottom: 16px; padding-top:0px">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="right">
          ...
          <span class="q-pl-md" />
          <Button_icon v-if="!edit_child" :readonly="false" :font_color="'white'" :color="'#1E90FF'" :text="'ADD'" :outline="false" size="15px"
...
@media screen and (min-width: 600px) {
  *>>>.text-right {
  ...
  .checkbox_sty > .row > .col-3
   {
        height: auto;
        width: 25%;
        align-items: center; /* Assuming .row is a flex container */
    }
  .no-scroll {
  overflow: hidden;
}
...
.search_button_secondary >>>.q-icon {
