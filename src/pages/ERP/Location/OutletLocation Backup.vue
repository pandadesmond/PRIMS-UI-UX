<template>
<q-form class="submit_form" ref="submit_form">
<div class="row row_section" style="padding: 0px; margin-bottom: 10px; margin-left: 12px;">
    ...
    <Title :text="'Outlet'" :noFilter="true" :filter_status="filter_status" v-on:receiveFilter="handleReceiveFilter" />
</div>
...
<div class="row row_section">
    <div class="card_section col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        ...
        <div class="row">
            ...
            <template v-for="details in outlet_json" :key="details">

                <div class="card_section col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2" style="padding-right: 10px; margin-bottom: 10px;">
                    ...
                    <q-btn
                        size="25px"
                        style="width: 100%; height: 100%; padding-top: 10px; border-radius: 0px;background-color: #273655; color: white;"
                        icon="storefront"
                        :label="details.label"
                        stack
                        @click="handleClickOutlet(details)"
...
export default {
    ...
    data() {
        return {
            ...
            folder_path: '',
            outlet_list: sessionStorage.getItem("outlet_list") != "" && sessionStorage.getItem("outlet_list") != "null" && sessionStorage.getItem("outlet_list") != null ? JSON.parse(sessionStorage.getItem("outlet_list")) : [],
        }
    },
    components: {
        // Input,
    ...
    methods: {
        async handleClickOutlet(payload)
        {
            ...
            await this.$store.dispatch('login/trigger_get_user', payload2).then(() => {
