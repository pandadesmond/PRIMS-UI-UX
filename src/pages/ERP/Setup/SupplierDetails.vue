    ...
    <q-form v-if="payload_new_3.searchbutton == false && payload_new_3.actionbutton == false" ref="submit_form" style="width: 100%;">
        ...
        <q-card-section>
           ...
           <!--Address 1-->
            ...
            :no_label="true"
            :text="'Address'"
            v-model:pass_value="payload_new_3.dadd1"
            :dbComponentBehavior="dbComponentBehavior.text"
            style="margin-left: 0px;" />
            </div>
            </div>

 <!--**If 'Input', no value pass in; if 'LabelInputVertical', value able to pass in**-->
            ...
            :readonly="false" 
            :no_label="true"
            v-model:pass_value="payload_new_3.dadd2" 
            :dbComponentBehavior="dbComponentBehavior.text"/>
            </div>
            </div>
            ...
            :readonly="false" 
            :no_label="true" 
            v-model:pass_value="payload_new_3.dadd3" 
            :dbComponentBehavior="dbComponentBehavior.text"/>
            </div>
            </div>
            ...
            :readonly="false" 
            :no_label="true"
            v-model:pass_value="payload_new_3.dadd4" 
            :dbComponentBehavior="dbComponentBehavior.text"/>
            </div>
            </div>
            ...
            :no_label="true"
            :text="'Tel'"
            v-model:pass_value="payload_new_3.dtel"
            :dbComponentBehavior="dbComponentBehavior.text"
            style="margin-left: 0px;" /> 
            </div>
            </div>
            ...
            :no_label="true"
            :text="'Fax'"
            v-model:pass_value="payload_new_3.dfax"
            :dbComponentBehavior="dbComponentBehavior.text"
            style="margin-left: 0px;" /> 
            </div>
            </div>
    ...
    methods: {
        goBack () {
           ...
           // push 4(details) , get 3(viewdetails)
            ...
            this.$router.push({name: "Supplier/view/details", params: {data: JSON.stringify(this.payload_new_4) } })
