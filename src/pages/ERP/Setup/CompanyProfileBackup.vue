    ...
    <q-form ref="submit_form">
        ...
        <div class="row" style="margin-bottom: 10px;">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <q-card style="margin-left: 10px; margin-bottom: 10px;height: 100%;" >
                    <q-card-section>
                        <!--First column, row--> 
                        <div class="row row_section">
                            ...
                            <LabelInputVertical :readonly="true" :no_label="true" :text="'Company Name'" v-model:pass_value="json_new.companyname" :dbComponentBehavior="dbComponentBehavior.companyname"/> 
                            </div>
                            </div>
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="component_div">
                            <LabelInputVertical :readonly="false" :no_label="true" :text="'Address'" v-model:pass_value="json_new.address1" :dbComponentBehavior="dbComponentBehavior.address1"/> 
                            </div>
                            </div>
                            ...
                            <div class="component_div">
                            <LabelInputVertical :readonly="false" :no_label="true" :text="'City'" v-model:pass_value="json_new.city" :dbComponentBehavior="dbComponentBehavior.City"/> 
                            </div>
                            </div> 
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical :readonly="false" :no_label="true" :text="'Postal Code'" v-model:pass_value="json_new.postalcode" :dbComponentBehavior="dbComponentBehavior.PostalCode"/> 
                            </div>
                            </div>
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical :readonly="false" :no_label="true" :text="'State'" v-model:pass_value="json_new.state" :dbComponentBehavior="dbComponentBehavior.State"/> 
                            </div>
                            </div>
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical :readonly="false" :no_label="true" :text="'Country'" v-model:pass_value="json_new.country" :dbComponentBehavior="dbComponentBehavior.Country"/> 
                            </div>
                            </div> 
                            <!--Tel-->
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'Tel'" v-model:pass_value="json_new.tel" :dbComponentBehavior="dbComponentBehavior.Tel"/> 
                            </div> 
                            </div>
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'Fax'" v-model:pass_value="json_new.fax" :dbComponentBehavior="dbComponentBehavior.Fax"/> 
                            </div> 
                            </div>
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'Reg.No.'" v-model:pass_value="json_new.comp_reg_no" :dbComponentBehavior="dbComponentBehavior.RegNo"/> 
                            </div>
                            </div> 
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'Custom Report Code'" v-model:pass_value="json_new.comp_code" :dbComponentBehavior="dbComponentBehavior.CustomReportCode"/> 
                            </div>
                            </div> 
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelSelectVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'Branch Location Group'" v-model:pass_value="json_new.locgroup_branch" 
                            ...
                            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="component_div">
                            <LabelSelectVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'DC Location Group'" v-model:pass_value="json_new.locgroup_dc" 
                            :dbComponentBehavior="dbComponentBehavior.select"
                            :options="branch_options"
                            />
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <q-card style="background-color: white; padding: 10px; margin-left: 10px; margin-right: -10px; margin-bottom: 10px;height: 100%;" >
                    <q-card-section>
                        <!--First column, row--> 
                        <div class="row row_section">
                        ...
                        <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="component_div">
                        <LabelSelectVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'GST submission cycle month'" v-model:pass_value="json_new.gst_submission_cycle" 
                        :dbComponentBehavior="dbComponentBehavior.select"
                        ...
                        <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="component_div">
                        <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'GST No.'" v-model:pass_value="json_new.gst_no" :dbComponentBehavior="dbComponentBehavior.GSTNo"/> 
                        </div>
                        </div>
                        ...
                        :dbComponentBehavior="dbComponentBehavior.sst_start_date"/>
                        </div>
                        </div>
                        ...
                        <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="component_div">
                        <LabelInputVertical style="margin-left: 0px;" :readonly="false" :no_label="true" :text="'SST No.'" v-model:pass_value="json_new.sst_no" :dbComponentBehavior="dbComponentBehavior.SSTNo"/> 
                        </div>
                        </div>
                        ...
                        <!--Action dialog-->
                            <div class="row row_section">
                                <div class="card_section col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="component_div">            
                                    <LabelSelectVertical :readonly="false"  :no_label="true" :text="'DC Location Group'" v-model:pass_value="json_new.locgroup_dc" 
                                        :dbComponentBehavior="dbComponentBehavior.select"
                                        :options="branch_options"
                                        />
                                        </div>
                            ...
                            <div class="row row_section">
                                    <div class="card_section col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                        <div class="component_div text-right">   
                                    <Button class="button_save" v-close-popup :text="'CANCLE'" :type="'button'" />
                                </div>
                                </div>
                        ...
                        <div class="card_section col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                        <div class="component_div"> 
                        <!-- <q-btn label="Apply" color="green" class="text-right"/> -->

                            <Button class="button_save" v-on:receiveChange="callUpdate()" :text="'APPLY'" :type="'button'" />
            ...
            <q-card-section>-->
               ...
               <LabelInputVertical
                ...
                <LabelInputVertical
                  ...
                  :dbComponentBehavior="dbComponentBehavior.CustomReportCode" />
                </div>
                </div>  -->
              ...
              <LabelSelectVertical
               ...
               <LabelSelectVertical
                ...
                <LabelInputVertical
                  ...
                  :dbComponentBehavior="dbComponentBehavior.SSTNo" />
                </div>
                </div> -->
...
methods: {
    ...
    {
        this.$router.push({name: "CompanyProfileBackup/details", params: {data: JSON.stringify(this.payload_new) } })
    },
