...
export default {
    ...
    mounted()
    {
        ...
        this.filter_value = ['AccountCode','Code','Name','idvalue','Block','Consign','Consign_diplay','Term','grn_baseon_pocost','poprice_method','pur_expiry_days','stock_returnable','b2b_registration','deliveryterm','set_rep_freq__freq_description','set_rep_freq__freq_stock_day','sc_buffer_stock_day','stockday_min','stockday_max','dcity','dstate','dcountry','Add1','Add2','Add3','Add4','Mobile','Fax','email'];
