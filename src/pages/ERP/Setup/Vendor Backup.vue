<template>
  <div v-if="$q.screen.width > 599" style="font-size: 10px; padding-left: 15px; padding-right: 15px;">
<!-- {{last_enter_field}} -->

      <div class="text-subtitle1 header_text">
        AP Supplier Management
      </div>
...
<q-stepper
      ...
      >
        <q-step
          ...
          icon="settings"
          :done="done1"
          style="font-size: 10px; padding-left: 15px; padding-right: 15px;overflow:hidden"
        >
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input 
                                    v-model:pass_value="json.SupplierLink" 
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.ArCustomer" 
                                      v-on:receiveChange="handleChange('')"
                                      :dbComponentBehavior="dbComponentBehavior.text" 
                                    />
                                  </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'SST Reg No'" />
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.sst_reg_no"
                                      v-on:receiveChange="handleChange('')"
                                      :dbComponentBehavior="dbComponentBehavior.text"
                                      :dense="dense"
                                    />
                          ...
                          <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <Input
                                      v-model:pass_value="json.SupplierCode"
                                      v-on:receiveChange="handleChange('')" 
                                      :dbComponentBehavior="dbComponentBehavior.text" 
                                      :dense="dense"
                                    />
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  ...
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.ApSupplier"
                                      v-on:receiveChange="handleChange('')" 
                                      :dbComponentBehavior="dbComponentBehavior.text" 
                                    />
                                  </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    ...
                                    <Label :pass_value="'GST Reg No'" />     
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.gst_reg_no" 
                                      v-on:receiveChange="handleChange('')" 
                                      :dbComponentBehavior="dbComponentBehavior.number" 
                                      :dense="dense"
                                    />
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'SST Code'" />
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.sst_code"
                                      v-on:receiveChange="handleChange('')"
                                      :dbComponentBehavior="dbComponentBehavior.number"
                                      :dense="dense"
                                    />
                          ...
                          <div class="row" style="align-items: center;">
                              ...
                              <div style="width: 83.6%;" >
                                <Input
                                  ...
                                  v-on:receiveChange="handleChange('name')" 
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              ...
                              v-on:receiveChange="handleChange('type')" 
                              :dbComponentBehavior="dbComponentBehavior.number"
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'GST Code'" /> 
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.gst_code" 
                                      v-on:receiveChange="handleChange('')" 
                                      :dbComponentBehavior="dbComponentBehavior.text" 
                                      :dense="dense"
                                    />
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                              <div class="row" style="align-items: center;">
                                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'SST Start Date'" /> 
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <Input
                                      v-model:pass_value="json.sst_start_date" 
                                      v-on:receiveChange="handleChange('')" 
                      ...
                      <div class="row" style="margin-bottom: 10px;">
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding-right: 10px;">
                          <div class="row" style="align-items: center;">
                            ...
                            <div style="width: 83.6%;" >
                              <Input
                                v-model:pass_value="json.entity_name" 
                                v-on:receiveChange="handleChange('')" 
                                :dbComponentBehavior="dbComponentBehavior.text_required" 
                                :dense="dense"
                              />
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                            <div class="row" style="align-items: center;">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'GST Start Date'" />
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" >
                                        <Input
                                          v-model:pass_value="json.gst_start_date" 
                                          v-on:receiveChange="handleChange('')" 
                                          :dbComponentBehavior="dbComponentBehavior.date" 
                                          :dense="dense"
                                        />
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px;">
                            <div class="row" style="align-items: center;">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <Label :pass_value="'E-Inv Start Date'" />
                                  </div>
                                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" >
                                        <Input
                                          v-model:pass_value="json.einv_start_date" 
                                          v-on:receiveChange="handleChange('')" 
                                          :dbComponentBehavior="dbComponentBehavior.date" 
                                          :dense="dense"
                                        />
              ...
              <div class="component_div2">
                ...
                <q-tab-panels v-model="tab" :animated="false" keep-alive > 
                    ...
                    <div class="row">    
                          ...
                          <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                            <div class="row col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5">
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px">
                                <LabelInputVerticalGeneral
                                  ...
                                  v-on:receiveChange="handleChange('address1')" 
                            ...
                            <div class="row col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                                ...
                                v-on:receiveChange="handleChange('tel')" 
                                :dbComponentBehavior="dbComponentBehavior.number"
                                :pass_dense="dense"
                              />
                              </div>
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                                <LabelInputVerticalGeneral
                                  v-model:pass_value="json.payment_term"
                                  :pass_label_value="'Payment Term'"
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                                <LabelInputVerticalGeneral
                                  v-model:pass_value="json.opther_reg_no"
                                  :pass_label_value="'Other Reg No'"
                                  v-on:receiveChange="handleReceiveChange"
                                  :dbComponentBehavior="dbComponentBehavior.number"
                                  label="test"
                                />
                      ...
                      <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                        <div class="row col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5">
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                              ...
                              v-model:pass_value="json.address2" 
                              v-on:receiveChange="handleChange('')" 
                              :dbComponentBehavior="dbComponentBehavior.address1" 
                              :pass_dense="dense"
                            />
                        ...
                        <div class="row col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                            :pass_label_value="'Tel/Fax'"
                            v-model:pass_value="json.tel_fax"
                            v-on:receiveChange="handleChange('')" 
                            :dbComponentBehavior="dbComponentBehavior.number"
                            :pass_dense="dense"
                          />
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                              v-model:pass_value="json.cal_due_date_by"
                              :pass_label_value="'Cal Due Date By'"
                              v-on:receiveChange="handleReceiveChange"
                      ...
                      <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                        <div class="row col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5">
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                              ...
                              v-model:pass_value="json.address3" 
                              v-on:receiveChange="handleChange('')" 
                              :dbComponentBehavior="dbComponentBehavior.address1" 
                              :pass_dense="dense"
                            />
                        ...
                        <div class="row col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                            :pass_label_value="'Mobile Contact'"
                            v-model:pass_value="json.mobile_contact"
                            v-on:receiveChange="handleChange('')" 
                            :dbComponentBehavior="dbComponentBehavior.number"
                            :pass_dense="dense"
                          />
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                              v-model:pass_value="json.credit_limit"
                              :pass_label_value="'Credit Limit'"
                              v-on:receiveChange="handleReceiveChange"
                              :dbComponentBehavior="dbComponentBehavior.text"
                              :pass_dense="dense"
                            />
                        ...
                        <div class="row col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5">
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                              ...
                              v-model:pass_value="json.address4" 
                              v-on:receiveChange="handleChange('')" 
                              :dbComponentBehavior="dbComponentBehavior.address1" 
                              :pass_dense="dense"
                            />
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px; padding-right: 10px;">
                        <div style="width: 100%; overflow-y: auto;">
                          <table cell style="width: 100%; border-collapse: collapse; color: black; font-size: 11px;" class="custom_table">
                            <thead>
                              <tr>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">DC Code</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Banner/Site</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Rep_Type (Conventional / Flow-through)</th>
                                ...
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Dept</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Sub-Dept</th>
                              </tr>
                            </thead>
                            <tbody>
                               ...
                               <!-- table row 1-->
                              <tr>
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td>  <!-- DC Code -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td>  <!-- Banner/Site -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Rep_Type -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Code -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">testing</td> <!-- Name -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Dept -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">14</td> <!-- Sub-Dept -->
                              </tr>

                              <!-- table row 2-->
                              <tr style="border-top: 1px solid #273655;">
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td>  <!-- DC Code -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td>  <!-- Banner/Site -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Rep_Type -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Code -->
                    ...
                    <div class="row">    
                          ...
                          <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                            ...
                            <div class="row col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                              ...
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-right: 10px">
                                <LabelInputVerticalGeneral
                                  v-model:pass_value="json.unit_weight"
                                  :pass_label_value="'Returned Cost'"
                                  v-on:receiveChange="handleReceiveChange"
                                  :dbComponentBehavior="dbComponentBehavior.number"
                                  label="test"
                                />
                     ...
                     <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                      <!-- col 1-->
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                          <div>
                            <b>Advance Receiving with HHT</b>
                          </div>
                          <div>
                            <q-toggle
                              dense
                  ...
                  <q-tab-panel name="Product List" style="padding: 0px; padding-top: 10px; color: grey; overflow: hidden">
                    <div class="row" v-if="active_section4 == 'Product List'">    
                          <!-- row 1-->
                          <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 3px;">
                          <!-- col 1-->
                            <div class="row col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                  ...
                  <q-tab-panel name="Replenishment" style="padding: 0px; padding-top: 10px; color: grey" class="no-scroll">
                    ...
                    <div class="row" v-if="active_section == 'Supplier'">
                      ...
                      <!-- col 1-->
                        <div class="row col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 10px">
                            <LabelInputVerticalGeneral
                            v-model:pass_value="pending_wording"
                            :pass_label_value="'ADS Parameter'"
                            v-on:receiveChange="handleReceiveChange"
                            :dbComponentBehavior="dbComponentBehavior.text"
                            label="test"
                            />
                    ...
                    <div class="row" v-if="active_section == 'Banner/Site'">
                          ...
                          <table cell style="width: 100%; border-collapse: collapse; color: black; font-size: 11px;" class="custom_table">
                            <thead>
                              <tr>
                                ...
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Dept</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Sub-Dept</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Min Day</th>
                                ...
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Manual SOQ</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Manual Ordering</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Order Frequency</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Stock Day</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Lead Time (Days)</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Buffer Stock Day</th>
                              </tr>
                            </thead>
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Banner/Site-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Dept-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">A001</td> <!-- Sub-Dept-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Min Day-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">14</td> <!-- Max Day-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">0</td> <!-- Manual SOQ-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">0</td> <!-- Manual Ordering-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">4</td> <!-- Order Frequency-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">7</td> <!-- Stock Day-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">4</td> <!-- Lead Time (Days) -->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">7</td> <!-- Buffer Stock Day-->
                              </tr>

                              <!-- table row 2-->
                              <tr style="border-top: 1px solid #273655;">
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">2</td> <!-- Code-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Banner/Site-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">1</td> <!-- Dept-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">A002</td> <!-- Sub-Dept-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">2</td> <!-- Min Day-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">4</td> <!-- Max Day-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">0</td> <!-- Manual SOQ-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">0</td> <!-- Manual Ordering-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">4</td> <!-- Order Frequency-->
                                <td style="padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca;">7</td> <!-- Stock Day-->
                  ...
                  <q-tab-panel name="IBT/ICT" style="padding: 0px; padding-top: 10px; color: grey" class="no-scroll">
                    ...
                    <div class="row" v-if="active_section2 == 'Basic'">
                          ...
                          <table cell style="width: 100%; border-collapse: collapse; color: black; font-size: 11px;" class="custom_table">
                            <thead>
                              <tr>
                                ...
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Name</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Dept</th>
                                <th style="cursor: pointer; padding: 10px; padding-top: 5px; padding-bottom: 5px; border: 1px solid #cbcaca; background-color: #D7E2E9;">Sub-Dept
                                  <!-- <q-tooltip anchor="top middle" self="center middle">
                                    Currency
                                  </q-tooltip> -->
                                </th>
                    ...
                    <div class="row" v-if="active_section2 == 'Banner/Site'">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px; padding-right: 10px;">
                        <div style="width: 100%; overflow-y: auto;">
                          <table cell style="width: 100%; border-collapse: collapse; color: black; font-size: 11px;" class="custom_table">
                            <thead>
