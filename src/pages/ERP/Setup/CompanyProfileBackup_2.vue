...
<div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="component_div">
            <LabelCheckboxHorizontal :readonly="false"  
            :no_label="true" 
            :text="'Tax inclusive'" 
...
<!--GST Effective Date-->            
            <div class="card_section col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="component_div">
                <LabelDatepickerHorizontal :readonly="false"  
                :no_label="true" 
...
computed: {
    ...
    methods: {
        addButton: function(payload)
        {
            ...
            this.$router.push({name: "CompanyProfileBackup_2/details", params: {data: JSON.stringify(this.payload_new) } })
        },
