  ...
  <div class="card_sides">
    <q-card style="min-height: 100vh;">
      <q-card-section class="header_top_mobile">
        ...
        <Button_icon :disable="showAddLoading" :text="header=='ADJ' ? 'New ADJ' : ' '" :big_round="true" :flat="true" :font_color="'#1976D2'" :color="'#f1f8ff'" :icon="'add_circle'" :outline="false" size="15px" class="custom_more_button" @click="handleCreate()" />
      </q-card-section>
      ...
      <q-card-section class="dialog_header card_sides">
        <div class="card_ypadding">
          ...
          <div class="row justify-center">
            <Label v-if="header=='ADJ' && type=='create'" :text="'Your Adjustment is Ready'"
            style="background-color: white;"/>

            <Label v-if="header=='ADJ' && type=='update'" :text="'Adjustment Updated'"
            style="background-color: white;"/>
          </div>
          <div class="row q-pt-lg" style="font-size: 10px;">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7" v-if="header=='ADJ'"><b>:</b> {{ json.PODate }}</div>
                  </div>
                  <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7" v-if="header=='ADJ'"><b>:</b> {{ json.SCode }}</div>
              ...
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7" v-if="header=='ADJ' || header == 'IBT'"><b>:</b> {{ json.SName }}</div>
...
export default {
  ...
  methods: {
    async getFilterAdjmain(payload)
    {
    ...
    back()
    {
      if(this.header == 'ADJ')
      {
        if(this.type == 'create')
        {
          this.$router.push({ name: 'EditAdjustment', query: { refno: this.refno, step: 2 } })
        }
        else if(this.type == 'update')
        {
          this.$router.push({ name: 'EditAdjustment', query: { refno: this.refno } })
        }
      }
    },
    handleCreate()
  ...
  async created(){
    ...
    if(this.header == 'ADJ')
    {
      ...
      var data = await this.getFilterAdjmain(payload);
