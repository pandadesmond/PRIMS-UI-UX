<template>
  ...
  <div v-if ="$q.screen.width > 599" class="row card_section card_section_second">
    <Title v-if="page_function == 'SalesOrder'" :text="'Sales Order'" :filter_status="filter_status" v-on:receiveFilter="handleReceiveFilter" />
          ...
          <div class="q-pr-xs q-pt-xs q-pb-md row justify-end">
            <div class="row full-width">
              ...
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4" align="right">
                <Button_icon v-if="page_function != 'SalesInvoice'" :flat="false" :font_color="'white'" :color="'#2F3A4D'" :text="page_function == 'SalesOrder' ? 'New SO' : 'New DN'" :outline="false" size="15px"
                v-on:receiveClick="handleShowCreateSalesOrder"/>
            ...
            v-on:add_button="handleShowCreateSalesOrder"
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 q-px-md">
      <div class="row">
        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
          <Title v-if="page_function == 'SalesOrder'" :text="'Sales Order'" :smaller_label="true"  :noFilter="true" :filter_status="filter_status" v-on:receiveFilter="handleReceiveFilter" />
          <Title v-if="page_function == 'SalesInvoice'" :text="'Sales Invoice'" :smaller_label="true" :noFilter="true" :filter_status="filter_status" v-on:receiveFilter="handleReceiveFilter" />
        </div>
          ...
          <div class="row">
                  ...
                  <q-card-section style="padding: 5px;">
                    <div class="row">
                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9 q-pl-sm">
                        ...
                        <div v-if="page_function == 'SalesOrder'" class="row q-pt-sm" style="font-size: 11px;">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div v-if="page_function == 'SalesInvoice'" class="row q-pt-sm" style="font-size: 11px;">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                             <q-icon name="person" class="q-pa-xs" size="15px" />
            ...
            <div class="dialog_action1">
              <div class="row full-height items-center">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3" align="center">
                  <Button_icon v-if="page_function != 'SalesInvoice'" :icon="'add'" :border_radius="'17px;'" :flat="false" :font_color="'white'" :color="'primary'" :outline="false" size="13px"
                  v-on:receiveClick="handleShowCreateSalesOrder" />
...
export default{
  ...
  methods: {
    handleShowSidebar()
      ...
      async handleDeleteLine(){
        ...
        if(this.page_function == 'SalesOrder')
        {
      ...
      handlePrint(newVal){
        this.$router.push({
          ...
          query: {
            from: 'Header',
            type: (this.page_function == 'SalesOrder' ? 'SO' : this.page_function == 'SalesInvoice' ? 'SI' : this.page_function == 'SalesOrder' ? 'SO' : this.page_function == 'SalesInvoice' ? 'SI' : 'IS'),
      ...
      handleTableChange: function(newVal)
      {
            ...
            console.log('handleTableChange',this.ori_params)
      ...
      async table_function(ori_payload){
          ...
          this.table_column = this.page_function == 'SalesOrder' ? table_column_so : this.page_function == 'SalesInvoice' ? table_column_si : table_column_dn;
  ...
  async created() {
    ...
    else if(this.page_function == 'SalesOrder')
    {
      sort_by_options = [
        {
          label: 'RefNo',
