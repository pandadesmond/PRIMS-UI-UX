        ...
        <q-form ref="save_form">
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              >
                  <q-tab name="po" label="SO" />
                  <q-tab name="po_detail" label="SO Detail" />
...
export default{
  ...
  async created () {
    ...
    this.customer_options = supcus_code;
    this.customer_options2 = supcus_name;
