  ...
  <div class="card_sides">
    <q-card style="max-height: 100%;">
      <q-card-section class="theme_color dialog_header header_top">
          ...
          <div v-if="page_function.endsWith('SalesOrderDetails')" class="text-subtitle1 header_text">SO Detail<br>
            [ Refno: {{ json.RefNo }} ]
          </div>
          <div v-if="page_function.endsWith('SalesInvoiceDetails')" class="text-subtitle1 header_text">SI Detail<br>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              >
                <q-step
                  ...
                  :name="1"
                  :title="page_function.endsWith('SalesDetails') ? 'SO Detail' : 'SI Detail'"
                  icon="settings"
                ...
                >
                  ...
                  <div class="row input_wrapper_right">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <div class="row dialog_separator">
                        ...
                        <div v-if="page_function == 'EditSalesOrderDetails'" class="col-xs-6 col-sm-4 col-md-2 col-lg-2 col-xl-2" :class="$q.screen.width > 1023 ? 'q-pl-sm': ''">
                          <div class="row">
                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                              <Checkbox
                              size="xs"
                        ...
                        <div v-if="page_function=='EditSalesOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 four_column_left two_column_left">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 four_column_left" :class="page_function == 'CreateSalesOrderDetails' ? 'two_column_left': ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2" :class="page_function == 'CreateSalesOrderDetails' ? 'two_column_left' : ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 dialog_separator">
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      ...
                      <div class="row dialog_separator">
                        <div v-if=" page_function=='CreateSalesOrderDetails'|| page_function=='EditSalesOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-5 col-md-2 col-lg-2 col-xl-2 four_column_left">
                          <div class="row">
                            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div class="col-xs-6 col-sm-2 col-md-1 col-lg-1 col-xl-1 four_column_left" :class="$q.screen.width>599 && $q.screen.width<1024 ? 'two_column_left' : page_function=='CreateSalesOrderDetails' ? 'two_column_left' : ''">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div v-if="page_function.endsWith('SalesOrderDetails')" class="col-xs-6 col-sm-2 col-md-2 col-lg-2 col-xl-2 four_column_left two_column_left">
                          <div class="row" :class="$q.screen.width<599 && page_function!='CreateSalesOrderDetails' ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                              :no_label="false"
                        ...
                        <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 four_column_left" :class="page_function == 'CreateSalesOrderDetails' ? 'two_column_left': ''">
                      ...
                      <div class="row dialog_separator">
                        ...
                        <div v-if="page_function=='EditSalesOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 four_column_left two_column_left">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div v-if="page_function=='EditSalesOrderDetails' || this.page_function == 'EditGoodsReceivingDetails'" class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                          <div class="row" :class="$q.screen.width<1024 ? 'dialog_separator': ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                  ...
                  <q-stepper-navigation>
                    ...
                    <span class="q-pl-xs">
                      <Button_icon v-if="page_function=='CreateSalesOrderDetails'" :flat="false" :font_color="'black'" :color="'white'" :text="'BACK'" :outline="true" size="15px"
                      @click="jsonChild.step = 1"/>
                    </span>

                    <!-- <q-btn color="primary" label="SAVE" @click="handleChild" />
                    <q-btn v-if="page_function=='CreateSalesOrderDetails'" flat @click="jsonChild.step = 1" color="primary" label="Back" class="q-ml-sm" /> -->
...
import ItemTable from 'src/components/ERP/Sales/ItemTable'
...
export default{
  ...
  async created () {
    ...
    if(this.page_function == 'EditSalesOrderDetails' || this.page_function == 'EditSalesInvoiceDetails')
    {
      var cpayload = {
        params: {
          refno: this.$route.query.refno,
      ...
      if(this.page_function.endsWith('SalesOrderDetails'))
      {
        await this.$store.dispatch('sales/trigger_get_sochild', cpayload).then(() => {
          cdata = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild']));
  ...
  methods: {
      handleResize()
      {
        var cardSection = document.getElementById("myCardSection");
        var cardSectionHeight = cardSection.offsetHeight;
        document.documentElement.style.setProperty('--card-section-height', cardSectionHeight + 'px');
      },
      ...
      handleNewForm(){
        ...
        if(this.page_function =='CreateSalesOrderDetails')
        {
          this.$router.push({
      ...
      async savePOChild(newVal){
        ...
        else if(this.page_function.startsWith('Edit'))
        {
          ...
          if(this.page_function == 'EditSalesOrderDetails')
          {
            payload.Qty_foc = this.unformatAmount(this.jsonChild.Qty_foc);
          ...
          if(status == "success")
          {
            ...
            if(this.page_function == 'EditSalesOrderDetails' || this.page_function == 'EditGoodsReceivingDetails')
            {
              this.showAddLoading = false;
