<template>
  <div v-if="$q.screen.width > 599" class="card_sides">
    <q-card style="max-height: 100%;">
      ...
      <q-card-section class="theme_color dialog_header header_top">
        ...
        <div v-if="page_function == 'CreateSalesOrder'" class="text-subtitle1 header_text">Sales Order</div>
        <div v-if="page_function == 'EditSalesOrder'" class="text-subtitle1 header_text">
          Sales Order<br>
          <span class="text-caption">
            Refno: {{ json.RefNo }} | Customer: {{ json.SCode }} - {{ json.SName }} | Branch: {{json.loc_group}}<br>
          </span>
        </div>
      </q-card-section>
      ...
      <q-card-section class="upload_container">
        <q-form ref="save_form">
          <div v-if="page_function == 'EditSalesOrder'" class="intermediate_white"/>
          <div class="row upload_separator_first">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <q-stepper
                ...
                :class="page_function == 'EditSalesOrder' ? 'sticky_stepper' : ''"
              >
                <q-step
                  :name="1"
                  title="Header"
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                      <div class="row dialog_separator">
                        ...
                        <div v-if="page_function=='EditSalesOrder'" class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row" :class="$q.screen.width < 1024 ? 'dialog_separator' : ''">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <Input
                              :autofocusclick="true"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              :no_label="false"
                              label="Exp in Days"
                              :readonly="json.BillStatus==1 ? true : page_function == 'CreateSalesOrder'"
                ...
                <q-step
                  v-if="page_function == 'EditSalesOrder'"
                  :name="2"
                  title="Detail"
                ...
                >
                  <div class="row upload_separator">
                      <div class="card_section_two col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          ...
                          :row_per_page="[0]"
                          :top_button="page_function=='EditSalesOrder' && json.BillStatus == 0"
                ...
                >
                  ...
                  <div v-if="page_function=='EditSalesOrder'" class="row dialog_separator">
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <Input
      ...
      <q-card-actions class="dialog_action justify-between">
        <div v-if="this.json.step == 1">
          ...
          <Button_icon v-if="page_function == 'EditSalesOrder'" :flat="true" :font_color="'white'" :color="'#094161'" :text="json.BillStatus==1 ? 'UNPOST' : 'POST'" :outline="false" size="15px"
          ...
          <span v-if="page_function == 'EditSalesOrder'" class="q-pl-xs">
            <Button_icon v-if="page_function=='EditSalesOrder'" :flat="false" :font_color="'black'" :color="'white'" :text="'NEXT'" :outline="true" size="15px"
            @click="json.step = 2"/>
          </span>

          <!-- <q-btn v-if="page_function=='EditSalesOrder'" @click="json.step = 2" color="primary" label="Next" />

          <span class="q-pl-xs">
            <q-btn color="primary" label="SAVE" @click="handleCreatePO" />
          </span> -->
        </div >
  ...
  <div v-else class="card_sides">
    <q-card style="min-height: 100vh;">
      <q-card-section class="header_top">
        ...
        <div v-if="page_function == 'CreateSalesOrder'" class="text-subtitle1 header_text" style="padding-top: 10px;">Sales Order</div>
        <div v-if="page_function == 'EditSalesOrder'" class="text-subtitle1 header_text">Sales Order
        <br>Refno: {{ json.RefNo }}</div>
        <!-- <q-btn-dropdown v-if="page_function == 'EditSalesOrder'" :disable="showAddLoading" class="custom_more_button" flat dense icon="more_vert">
          <q-list>
              ...
              >
                ...
                >
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                      <div class="row dialog_separator">
                        <div class="input_wrapper_right" :class="page_function == 'CreateSalesOrder' ?  'col-xs-10' : json.BillStatus == 0 && !supplier_readonly ? 'col-xs-10' : 'col-xs-12'">
                          <div class="row" :class="$q.screen.width < 1024 ? 'dialog_separator' : ''">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                              <span class="mobile_font">Customer</span>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <SelectFilter
                        ...
                        <div :class="page_function == 'CreateSalesOrder' ? 'col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4' : 'col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4'" class="input_wrapper_right">
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 input_wrapper_right">
                          <div class="row dialog_separator">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              v-on:change="handleChangeExpInDays"
                              v-model="json.pur_expiry_days"
                              :dbComponentBehavior="dbComponentBehavior ? page_function == 'CreateSalesOrder' ? dbComponentBehavior.text_right_readonly :  dbComponentBehavior.text_right : oridbComponentBehavior.text" />
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div v-if="page_function=='EditSalesOrder'" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 input_wrapper_right">
                          <div class="row dialog_separator">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                      ...
                      <div class="row dialog_separator">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <div class="row">
                            ...
                            <div v-if="page_function == 'EditSalesOrder'" class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12 input_wrapper_right">
                              <div class="row">
                                <div class="col-xs-7 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                ...
                <q-step
                  ...
                  :done="json.step > 2"
                >
                  <div v-if="page_function == 'EditSalesOrder'" class="row">
    ...
    <div v-if="json.step == 1 || json.step == 3" class="dialog_action_bottom" :style="page_function == 'EditSalesOrder' && json.BillStatus== 0  ? 'height: 65px;' : 'height: 40px;'">

      <div v-if="page_function == 'EditSalesOrder'" class="row q-px-sm" :class="page_function == 'EditSalesOrder' && json.BillStatus !== 0  ? 'q-pt-sm' :''" style="font-size: 13px;">
        ...
        <div  class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-right">
           <!-- POST BUTTON -->
           <span v-if="page_function == 'EditSalesOrder'" class="q-pr-xs" :style="json.BillStatus == 1 ? 'width: 100%;' : 'width: 24%;'">
      ...
      <div class="row q-px-sm q-py-xs">
        <Button_icon v-if="json.BillStatus==0" :readonly="page_function.startsWith('Edit') && deepEqual(ori_json, json)" style="height: 30px; width: 100%" :small_round="true" :text="page_function.startsWith('Create') ? 'Generate Sales Order' : 'Update Sales Order'" :flat="false" :font_color="'white'" :color="'primary'" :outline="false" size="13px" @click="handleCreatePO"/>
      </div>
    </div>

    <div v-if="json.step == 2" class="dialog_action_bottom" :style="page_function == 'EditSalesOrder' && json.BillStatus== 0  ? 'height: 65px;' : 'height: 40px;'">
      <div v-if="page_function == 'EditSalesOrder'" class="row q-px-sm" :class="page_function == 'EditSalesOrder' && json.BillStatus !== 0  ? 'q-pt-sm' :''"  style="font-size: 13px;">
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 ">
          <div class="row justify-left items-center" >
             <Button_icon class="q-pa-none q-ma-none" :flat="true" :icon="'expand_less'" v-on:receiveClick="show_summary_dialog" :font_color="'primary'" :color="'primary'" :outline="false" size="13px"/>
  ...
  <q-dialog v-model="modify_child" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <q-card v-if="$q.screen.width < 600" style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class="row header_top_mobile">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
          <div v-if="!edit_child" class="text-subtitle1 header_text" style="margin-top: 5px;">Sales Order Detail<br></div>
          <div v-else class="text-subtitle1 header_text" style="margin-top: 5px;">Edit Sales Order Detail<br></div>
        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div v-if="hv_item" class="row dialog_separator">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-xl-2 four_column_left">
                      <div class="row" :class="page_function == 'EditSalesOrder' ? 'dialog_separator': ''">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 col-xl-3 four_column_left two_column_left">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                          <Select
                          dir="rtl"
                          :readonly="json.BillStatus == 1 ? true : jsonChild.PriceType=='FOC' ? true : unit ? jsonChild.DiscAmt != '0.00' : true"
                          :no_label="true"
    ...
    <q-card v-else style="width: 700px; max-width: 98vw; margin-top: 5%;">
      <q-card-section class=" row theme_color dialog_header" style="padding: 0px;">
          <div class="text-subtitle1 header_text" style="margin-top: 5px;">Sales Order Detail<br></div>
          <q-space />
          <q-btn icon="close" flat round dense @click="close()" :disable="false"/>
      </q-card-section>
  ...
  <q-dialog v-model="search_item" persistent :position="$q.screen.width > 599 ? 'top' : 'bottom'">
    <SearchPopUp
      ...
      :title="search_supplier ? 'Customer' : 'Item'"
      :pass_value="search"
...
export default{
  ...
  async created () {
    ...
    if(this.page_function == 'EditSalesOrder')
    {
      var cpayload =
      {
        params: {
      ...
      await this.$store.dispatch('sales/trigger_get_sochild', cpayload).then(() => {
        var cdata = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild']));
  ...
  methods: {
      ...
      async handleDeleteLine(){
        ...
        else
        {
          ...
          if(this.page_function == 'EditSalesOrder')
          {
            ...
            await this.$store.dispatch('sales/trigger_delete_sochild', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild_status']));
            });
          }
      ...
      async savePOChild(newVal){
        ...
        if(!this.edit_child)
        {
          ...
          await this.$store.dispatch('sales/trigger_create_sochild', payload).then(() => {
            data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild_status']));
          });
        ...
        else
        {
          ...
          if(this.page_function == 'EditSalesOrder')
          {
            ...
            await this.$store.dispatch('sales/trigger_update_sochild', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild_status']));
            });
          }
          else if(this.page_function == 'EditGoodsReceiving')
          {
            payload.barcode = this.jsonChild.barcode;
      ...
      handleChangeLocGroup(payload)
      {
        if(payload)
        {
          ...
          console.log(filtered_location[0].location)
      ...
      {
        return await this.$store.dispatch('sales/trigger_read_supcus_all', payload).then(() => {
          var data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_read_supcus_all']));
          return data;
        });
      },
      async getLocation(payload)
      {
        return await this.$store.dispatch('sales/trigger_read_location_list', payload).then(() => {
          var data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_read_location_list']));
          return data;
        });
      },
      async getFilterPomain(payload)
      {
        return await this.$store.dispatch('sales/trigger_read_so_by_refno', payload).then(() => {
          var data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_read_so_by_refno']));
          return data;
        });
      },
      ...
      table_function(payload){
          ...
          this.$nextTick(async ()=>{
            ...
            if(this.page_function == 'CreateSalesOrder')
            {
              data = {
                  "data": []
              };
            ...
            {
              await this.$store.dispatch('sales/trigger_get_sochild', payload).then(() => {
                data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_sochild']));
      ...
      async savePO(){
          ...
          if(this.page_function == 'CreateSalesOrder')
          {
            ...
            await this.$store.dispatch('sales/trigger_create_somain', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_somain_status']));
            });
          }
          else if(this.page_function == 'EditSalesOrder')
          {
            ...
            await this.$store.dispatch('sales/trigger_update_somain', payload).then(() => {
              data = JSON.parse(JSON.stringify(this.$store.getters['sales/get_somain_status']));
          ...
          if(status == "success")
          {
            ...
            if(this.page_function == 'CreateSalesOrder')
            {
              ...
              // if(mobile)
              // {
              //   this.$router.push({ name: 'SalesConfirm', query: { refno: data.response.RefNo, header: 'SO', type:'create' }})
              // }
              // else
              // {
                this.$router.push({ name: 'EditSalesOrder', query: { refno: data.response.RefNo, step: 2 } })
              // }
            }
            else if(this.page_function == 'EditSalesOrder')
            {
              if(mobile)
              {
                this.$router.push({ name: 'SalesConfirm', query: { refno: data.response.RefNo, header: 'SO', type:'update' }})
              }
              else
              {
                this.showNotify("positive", "Updated Successfully.");
