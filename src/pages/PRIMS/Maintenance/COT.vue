    ...
    <q-dialog v-model="delete_dialog" persistent position="top">
        <q-card style="width: 864px; max-width: 98vw;text-align:center;margin-top: 5%;border-radius: 8px">
            ...
            <q-card-actions align="right" style="padding-top:0px;padding-bottom:16px;padding-right:16px">
                ...
                <q-btn flat label="Confirm" font_color="white" color="'#D81111'" size="12px" class="dialog_confirm_delete_button" @click="handleDeleteCot" />
            </q-card-actions>
...
export default {
    ...
    methods: {
        ...
        {
            this.$router.push({name: 'editCot', query: { guid: row.row.cot_guid}});
        },
        handleCreate(){
            this.$router.push({name: 'createCot'});
        },
        handleChangeSearch()
        {
        ...
        async handleDeleteCot()
        {
            this.deleteLoading = true;

            var payload = {
                "cot_guid": this.deleteItem.cot_guid,
            }

            var pass_obj = {
                "dispatch": 'general/trigger_delete_cot',
                "getter": 'general/get_cot',
                "app": this,
                "payload": payload,
            };
