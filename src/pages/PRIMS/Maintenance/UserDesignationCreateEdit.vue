...
export default {
    ...
    async mounted(){
        ...
        if(this.$route.name == 'editUserDesignation')
        {
            this.page_function = "edit";

            if(this.$route.query.guid)
            {
                this.currentDesignation = this.$route.query.guid;
            }
            
            if(this.currentDesignation == "")
            {
                this.showNotify('negative', 'Unable to identify user group guid.');
                this.$router.push({name: "userDesignation"});
            }

            var payload = {
                'designation_guid': this.currentDesignation,
            }

            var pass_obj = {
                "dispatch": 'user/trigger_get_designation',
    ...
    methods:{
        async saveUserGroup(){
            ...
            if(this.page_function == "create")
            {
                ...
                var pass_obj = {
                    "dispatch": 'user/trigger_create_designation',
                    "getter": 'user/get_designation',
                    "app": this,
                    "payload": payload,
                };
            ...
            {
                payload.designation_guid = this.json.designation_guid;

                var pass_obj = {
                    "dispatch": 'user/trigger_update_designation',
                    "getter": 'user/get_designation',
                    "app": this,
                    "payload": payload,
                };
