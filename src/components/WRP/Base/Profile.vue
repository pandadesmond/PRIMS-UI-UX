<template>
<!-- <div class="q-pa-md"> -->
<q-btn-dropdown :unelevated="true" :content-class="'profile_class'" class="btn_dropdown">
<!-- style="padding-right:0px;" -->
    ...
    <div>
        ...
        <div class="row" style="background-color: #ef3839;padding-top: 20px;padding-bottom:20px;padding-left:15px;padding-right:15px;">
            ...
            <div class="column" style="padding-left:10px;">
                ...
                <!-- <label style="font-size:15px;color:white;padding-top:10px;">{{user_name}}</label> -->
                <label style="font-size:15px;color:white;min-width:200px;">User Name : {{user_name}}</label>
      ...
      <!-- <q-separator horizontal inset class="q-mx-lg" />
        ...
        <!-- <div class="row" style="background-color: #273655;"> -->
            <div class="row" style="background-color: #ef3839;">
            <div class="col-7">
            ...
            <div class="col-5" style="text-align:center;">
                ...
                <q-btn flat color="white" text-color="white" label="Logout" icon="logout" @click="logout()" style="background-color:#ef3839 !important;font-size:12px;padding: 10px 5px 10px 5px;" />
...
export default {
    ...
    methods: {
        ...
        //this.$router.push("/sapqoh/user");
        },
        logout() {
            this.$store.dispatch('login/logout').then(() => {
                 this.showLoading();
             setTimeout(()=>{
               this.$router.push('/wrp/login')
...
*>>>.q-btn {
    ...
    background-color: #ef3839 !important;
    border-radius: 0px;
}
