<template>
    <Input autocomplete="off" :readonly="readonly ? true : false"  :icon_append="icon_append" :id="id" :name="name" v-on:change="handleChange" v-model="pass_value" :componentBehavior="dbComponentBehavior"/>
    <!-- :rules="rules" -->
</template>
...
export default {
    ...
    props: ['text', 'value', 'dbComponentBehavior', 'id', 'name', 'type','readonly', 'icon_append'],
    components: {
        Input,
    },
    methods:{
