...
<q-btn-dropdown :unelevated="true" :content-class="'profile_class'">
    ...
    <div>
        <div class="row" style="background-color: #4e436a;padding-top: 20px;padding-bottom:20px;padding-left:15px;padding-right:15px;">
        ...
        <div class="row" style="background-color: #4e436a;">
            ...
            <div class="col-5" style="text-align:center;">
                <q-btn color="white" text-color="white" label="Logout" icon="logout" @click="logout()" style="background-color:#4e436a !important;font-size:12px;padding: 10px 5px 10px 5px;" />
            </div>
        </div>
    </div>
...
*>>>.q-btn {
    background-color: #4e436a !important;
    border-radius: 0px;
}
