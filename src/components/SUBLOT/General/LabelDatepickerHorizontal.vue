    ...
    <!-- <div class="component_div"> -->
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <Datepicker v-on:receiveClickIcon="handleReceiveClickIcon" v-on:receiveChange="handleChange" :pass_disabled="readonly" :daterange="bind_value" :optionsFn="options"
                :componentBehavior="dbComponentBehavior ? dbComponentBehavior : oridbComponentBehavior.text" :disableOptions="disable" :autoclose="autoclose"/>
            </div>
        </div>
    <!-- </div> -->
</template>
...
export default {
    ...
    props: ['text','disable','required','pass_value','readonly','optionsFn','dbComponentBehavior','no_label','readonly', 'autoclose'],
    computed:{
        // ...mapGetters("tta"),
