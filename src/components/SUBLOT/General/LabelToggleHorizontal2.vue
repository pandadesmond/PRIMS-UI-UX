<template>
    <!-- <div class="component_div"> -->
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 q-pl-md q-py-sm">
                <Toggle :no_label="no_label" :pass_disabled="readonly ? true : false" v-on:receiveToggleChange="handleChange" v-model="bind_value"
                    false-value="Blocked" true-value="Active" class="toggle"
               />
            </div>
        </div>
    <!-- </div> -->
...
export default {
    ...
    props: ['text','pass_value','no_label','readonly'],
