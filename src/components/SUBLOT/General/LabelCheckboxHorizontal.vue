    ...
    <!-- <div class="component_div"> -->
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <Checkbox :no_label="no_label" :disable="disable ? true : false" :readonly="readonly ? true : false" v-on:receiveChange="handleChange" :value="bind_value"
...
export default {
    ...
    props: ['text','pass_value','dbComponentBehavior','no_label','readonly', 'required', 'disable'],
    computed:{
        // ...mapGetters("tta"),
