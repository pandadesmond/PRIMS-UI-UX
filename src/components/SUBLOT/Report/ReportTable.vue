       ...
       <template v-slot:top-right v-if="top_button" >
        ...
        <q-td>
           ...
           <q-btn icon="print"  :disabled="readonly_button" dense color="primary" :outline="button_no_outline" ripple class="q-mr-sm" v-on:click="print(props.row)"
            ...
            v-if="novation_button && props.row.posted == 1 && props.row.cancel == 0 && props.row.renewed == 0">
                <q-tooltip>
                    Novation
                </q-tooltip>
            </q-btn>
<!-- 
            ...
            v-if="renewal_button && props.row.posted == 1 && props.row.cancel == 0 && props.row.renewed == 0">
                <q-tooltip>
                    Renewal
                </q-tooltip>
            </q-btn>
