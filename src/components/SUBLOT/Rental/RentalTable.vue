...
export default {
    ...
    props: ['title', 'table_column', 'table_data','top_button', 'hide_footer', 'row_per_page','table_footer',"flat_status", "bordered_status", 'print_button','edit_button', 'view_button', 'delete_button'
    ,"pass_row_key"],
    components: {
      Button_icon,
      Checkbox,
