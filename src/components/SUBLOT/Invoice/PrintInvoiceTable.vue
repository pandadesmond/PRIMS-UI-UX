...
<template v-slot:body-cell-isactive="props">
  <q-td :style="`text-align:${props.col.align}`">
    <Checkbox
      ...
      <template v-slot:top-right v-if="top_button || top_button2 || printListingButton">
        <div style="display: flex;">
          ...
          <q-btn v-if="printListingButton" v-on:click="printListingButtonClick()" label="Print Listing"  dense ripple class="q-py-none top_button" style="background-color:#273655 !important; font-size: 15px;color:white; margin-left: 10px;  width: 100%;"/>
        </div>
      </template>
