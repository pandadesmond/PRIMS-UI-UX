            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
              <div class="row">
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <Input :autofocusclick="autofocusclick ?true :false" :no_label="no_label" :readonly="readonly ? true : false" v-on:change="handleChange" v-model="bind_value"
                :dbComponentBehavior="dbComponentBehavior ? dbComponentBehavior : oridbComponentBehavior.text" :icon_append="icon_append"  :placeholder="placeholder" :suffix="suffix"/>
                 </div>
...
export default {
    ...
    props: ['text','required','pass_value','dbComponentBehavior','no_label','readonly', 'icon_append','suffix','autofocusclick'],
    computed:{
