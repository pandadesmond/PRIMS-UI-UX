    ...
    <div class="row" style="align-items: center;">
        ...
        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="row">
                ...
                <div :class="manage_button ? 'col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9' : filter ? 'col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8' : 'col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12'">
                    <MultipleSelect
                        :readonly="readonly"
                ...
                <div v-if="manage_button" class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <Button pass_label="Manage" class="custom_button"
...
export default {
    props:['label', 'dbComponentBehavior', 'pass_value','pass_type', 'readonly','options','options_type','forceSelectAll', 'manage_button', 'option_label','filter','loading'],
    data(){
        return {
