<template>
    <q-input ref="ref_input" @click="handleClick()" v-if="dbComponentBehavior.label" class="new_input" 
        v-model="value" 
        :dense="dense"  
    ...
    <q-input ref="ref_input" @click="handleClick()" v-else class="new_input" 
        v-model="value" 
        :dense="dense"  
        v-on:keyup="handleKeyUp"
        v-on:change="handleChange"
...
export default {
    ...
    props: ['pass_value', 'pass_dense', 'dbComponentBehavior', 'autofocusclick','readonly'],
    methods:{
        handleClick()
        {
