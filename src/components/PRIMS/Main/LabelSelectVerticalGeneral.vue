<template>
    ...
    >
            <!-- :display-value="`${pass_overwrite_display ? (value ? value[pass_overwrite_display] : '') : (value ? (value.label ? value.label : value ) : '')}`" -->
...
props: ['options', 'pass_value', 'dbComponentBehavior','no_label','label','no_padding_top', 'pass_label_value', 'pass_overwrite_display', 'readonly'],
methods:{
    handleDisplayValue(pass_payload)
    {
      // console.log(this.bind_options);
