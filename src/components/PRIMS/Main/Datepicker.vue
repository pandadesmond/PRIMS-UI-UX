<template>
  <q-input outlined dense bg-color="white" v-on:change="handleChange" v-model="date" :rules="componentBehavior.rules" :disable="readonly">
...
export default {
  ...
  props:['daterange','componentBehavior','min_year','max_year','autoclose', 'pass_day_string','optionsFn','readonly'],
  methods: {
      handleChange(newVal) {
