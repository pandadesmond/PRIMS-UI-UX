<template>
    ...
    <q-select v-if="!no_label"
        ...
        :display-value="`${bind_value.length > 2 ? `${bind_value.length} Column Selected` : bind_value}`"
    >
...
export default {
    ...
    props: ['pass_value', 'options', 'label', 'id', 'name','componentBehavior','no_label', 'value', 'forceSelectAll'],
