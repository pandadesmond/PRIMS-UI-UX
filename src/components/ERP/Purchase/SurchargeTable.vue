<template>
  <div class="row">
    <div v-if="title_section == 'GRN'" class="q-pl-sm q-pr-sm q-pt-sm col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <!-- <Label class="custom_label" :text="SectionTitle" /> -->
      <div class="row q-gutter-sm q-pa-md card_border">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-right">
        <Button_icon :style="{ visibility: add_button ? 'visible' : 'hidden' }" :disabled="readonly_button" :flat="true" :icon="'add'" v-on:receiveClick="handleAdd()" :font_color="'white'" :color="'green'" :text="'Add'" :outline="false" size="12px" class="q-pr-sm"/>
...
<!--
    ...
    <div v-if="title_section == 'PO'" class="q-pl-sm q-pr-sm q-pt-sm col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <!-- <Label class="custom_label" :text="SectionTitle" /> -->
      <div class="row q-gutter-sm q-pa-md card_border">
