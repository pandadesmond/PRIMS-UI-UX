...
<!-- 
                ...
                <q-tr :props="props"  >
                    ...
                    <td style="border: 0px;"></td>
                    <td colspan="50" :style="[json_data.Department.length > 1 ? 'border: 0px; border-bottom: 1px solid black;' : 'border: 0px;']"></td>
                </q-tr>
...
export default {
    ...
    {
        return{
            bind_pass_show_itemcode: this.pass_show_itemcode ? '80px' : '50px',
    ...
    props: ['pass_data','forceLoading','pass_table_title','pass_department_options','hierarchy_type_value', 'multiple_json', 'closeLoading','index','Day_to_Date','Week_to_Date','overwrite_amount_type', "hide_week", "pass_show_itemcode"],
    methods:{
        returnMain()
        {
...
{
    left: v-bind(bind_pass_show_itemcode) !important;
}
