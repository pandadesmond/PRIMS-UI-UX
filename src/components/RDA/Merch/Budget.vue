    ...
    >
      ...
      <template v-slot:header="props">
        ...
        <q-tr :props="props" style="background-color: #295fbd; color: white;">
            ...
            <q-th colspan="8"  style="border-right: 1px solid black;">Month-to-Date</q-th>
      ...
      <!-- <template v-slot:top-row>
        ...
        <template v-slot:body="props">
            ...
            <q-tr  v-if="json_data.Total_Stores.length > 0">
                ...
                <q-td colspan="7" style="border-bottom: 1px solid black; border-left: 0px; "></q-td>
                <q-td colspan="7" style="border: 0px; padding: 0px; border-bottom: 1px solid black;"></q-td>
                <!-- <q-td colspan="1" style="border-bottom: 1px solid black; border-left: 0px; ">eeee</q-td>
                <q-td colspan="1" style="border: 0px; padding: 0px;">ffff</q-td> -->
                <!-- <q-td colspan="7" style="border-bottom: 1px solid black; border-left: 0px; ">gggg</q-td> -->
            </q-tr>
            ...
            <template v-for="(total_lfl_store_details, index) in json_data.Total_LFL_Stores" :key="total_lfl_store_details">
                ...
                <q-tr class="table_row_third">
                    ...
                    <!-- <template v-if="total_lfl_store_details.Details_year_to_date">
                        ...
                        <q-td style="border: 0px; background-color: white;">bbb</q-td>
                    ...
                    <template v-if="total_lfl_store_details.Details_year_to_date">
                        <q-td style="font-style: normal; font-size: 13px; font-weight: bold; text-align: right; border-top: 1px solid black;" >{{formatAmount(total_lfl_store_details.Details_year_to_date.Sales_TY_amount,'$')}}</q-td>
                        <q-td style="font-style: normal; font-size: 13px; font-weight: bold; text-align: right; border-top: 1px solid black;" >{{formatAmount(total_lfl_store_details.Details_year_to_date.Budget_TY_amount,'$')}}</q-td>
                        <q-td style="font-style: normal; font-size: 13px; font-weight: bold; text-align: right; border-top: 1px solid black;" >{{formatAmount(total_lfl_store_details.Details_year_to_date.vsBud,'%')}}</q-td>
                        <q-td :style="['background-color: white;padding-left: 2px;padding-left: 2px; border-top: 1px solid black;',total_lfl_store_details.Details_year_to_date.vsBud >= -1 && total_lfl_store_details.Details_year_to_date.vsBud <= 1 ? 'color: #f8db8f;' : (total_lfl_store_details.Details_year_to_date.vsBud  > 1 ? 'color: green;' : total_lfl_store_details.Details_year_to_date.vsBud < -1 && 'color:red;')]"><center><char style="font-size: 18pt;">&#x25CF;</char></center></q-td>
                        <q-td style="font-style: normal; font-size: 13px; font-weight: bold; text-align: right; border-top: 1px solid black;" >{{formatAmount(total_lfl_store_details.Details_year_to_date.Sales_LY_amount,'$')}}</q-td>
                        <q-td style="font-style: normal; font-size: 13px; font-weight: bold; text-align: right; border-top: 1px solid black;" >{{formatAmount(total_lfl_store_details.Details_year_to_date.vsLY,'%')}}</q-td>
                        <q-td :style="['background-color: white;padding-left: 2px;padding-left: 2px;border-right: 1px solid black; border-top: 1px solid black;',total_lfl_store_details.Details_year_to_date.vsLY >= -1 && total_lfl_store_details.Details_year_to_date.vsLY <= 1 ? 'color: #f8db8f;' : (total_lfl_store_details.Details_year_to_date.vsLY  > 1 ? 'color: green;' : total_lfl_store_details.Details_year_to_date.vsLY < -1 && 'color:red;')]"><center><char style="font-size: 18pt;">&#x25CF;</char></center></q-td>
                    </template>
