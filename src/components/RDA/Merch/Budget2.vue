    ...
    <template v-slot:top>
      ...
      <template v-slot:header="props">
        ...
        <q-tr :props="props" style="background-color: #e0ebff; color:black;">
            ...
            <!-- <q-th style="min-width: 25px;max-width: 25px;background-color: white;position: sticky; left: 0px;background-color:white;z-index: 120;border-top: 1px solid black;">No</q-th>
            <q-th style="min-width: 120px;max-width: 120px;background-color: white;position: sticky; left: 25px;z-index:120;border-top: 1px solid black;text-align: center;">Outlet</q-th>
            <q-th style="min-width: 120px;max-width: 120px;background-color: white;position: sticky; left: 145px;background-color:white;z-index: 120;border-top: 1px solid black;text-align: center;">Outlet Name</q-th>
            <q-th style="min-width: 120px;max-width: 120px;background-color: white;position: sticky; left: 265px;z-index:120;border-top: 1px solid black;text-align: center;">Cohort</q-th>
            <q-th style="min-width: 120px;max-width: 120px;border-top: 1px solid black;position: sticky; left: 385px;z-index:120;border-top: 1px solid black;text-align: center;">State</q-th>
            <q-th style="min-width: 120px;max-width: 120px;border-top: 1px solid black;position: sticky; left: 505px;z-index:120;border-top: 1px solid black;text-align: center;border-right: 1px solid black;">AM</q-th>
