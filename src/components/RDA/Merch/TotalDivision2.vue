    ...
    >
      ...
      <template v-slot:header="props">
        ...
        <q-tr :props="props" style="background-color: white; color:black;" v-if="show_expand">
            ...
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" :style="['border: 0px;border-top:1px solid black;border-bottom: 1px solid black; border-left: 1px solid black;', !colspan.COGS.COGSShow && '']"><q-btn style="float: left;" @click="COGSColumnButtonClick" square color="blue-grey-2" text-color="black" :icon="colspan.COGS.COGSIcon" size="xs" padding="none"><q-badge v-if="!colspan.COGS.COGSShow" color="positive" floating rounded transparent></q-badge></q-btn></q-th>
            <q-th v-if="colspan.COGS.COGSShow && display_hierarchy_type_value != 'Total Divisions'" :style="['border: 0px;border-top:1px solid black;border-bottom: 1px solid black;', !colspan.COGS.COGSShow && 'border-top: 0px;border-left: 0px;border-right: 0px;border-bottom: 0px;']"></q-th>
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;border-top:1px solid black;border-bottom: 1px solid black;"><q-btn style="float: left;" @click="COGS2ColumnButtonClick" square color="blue-grey-2" text-color="black" :icon="colspan.COGS.COGS2Icon" size="xs" padding="none"><q-badge v-if="!colspan.COGS.COGS2Show" color="positive" floating rounded transparent></q-badge></q-btn></q-th>
            <q-th v-if="colspan.COGS.COGS2Show && display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;border-top:1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;"></q-th>
        ...
        <q-tr :props="props" style="background-color: #295fbd; color: white;">
            ...
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;background-color: white;color: black;border-bottom: 1px solid black; border-left: 1px solid black; text-align: right;">30</q-th>
            <q-th v-if="colspan.COGS.COGSShow && display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;background-color: white;color: black;border-bottom: 1px solid black; text-align: right;">30</q-th>
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;background-color: white;color: black;border-bottom: 1px solid black; text-align: right;">30</q-th>
            <q-th v-if="colspan.COGS.COGS2Show && display_hierarchy_type_value != 'Total Divisions'" style="border: 0px;background-color: white;color: black;border-bottom: 1px solid black; text-align: right;border-right: 1px solid black;">30</q-th>
        </q-tr>
        ...
        <q-tr :props="props" style="background-color: #a5c6ff; color:black;">
            ...
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" :colspan="colspan.COGS.COGS" style="border: 0px; border-left: 1px solid black;">COGS</q-th>
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" :colspan="colspan.COGS.COGS2" style="border: 0px;border-right: 1px solid black;">COGS</q-th>
        </q-tr>
        ...
        <q-tr :props="props" style="background-color: #e0ebff; color:black;">
            ...
            <q-th style="min-width: 120px;max-width: 120px;border-top: 1px solid black;background-color: black; color: white;position:sticky;left: 20px;z-index:120;">
            ...
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="min-width: 60px;border-top:1px solid black;border-bottom:1px solid black;" @click="handleSortingColumn('Cogs_details.Cogs_month_to_date.Cogs_TY_amount')">TY <q-icon v-if="active_sorting_column == 'Cogs_details.Cogs_month_to_date.Cogs_TY_amount'" style="font-size: 13px;" :class="[active_sorting_column_asc ? 'flip_down' : 'flip_up']" name="filter_list" /></q-th>
            <q-th v-if="colspan.COGS.COGSShow && display_hierarchy_type_value != 'Total Divisions'" style="min-width: 60px;border-top:1px solid black;border-bottom:1px solid black;" @click="handleSortingColumn('Cogs_details.Cogs_month_to_date.Cogs_LY_amount')">LY <q-icon v-if="active_sorting_column == 'Cogs_details.Cogs_month_to_date.Cogs_LY_amount'" style="font-size: 13px;" :class="[active_sorting_column_asc ? 'flip_down' : 'flip_up']" name="filter_list" /></q-th>
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="min-width: 60px;border-top:1px solid black;border-bottom:1px solid black;" @click="handleSortingColumn('Cogs_details.Cogs_year_to_date.Cogs_TY_amount')">TY <q-icon v-if="active_sorting_column == 'Cogs_details.Cogs_year_to_date.Cogs_TY_amount'" style="font-size: 13px;" :class="[active_sorting_column_asc ? 'flip_down' : 'flip_up']" name="filter_list" /></q-th>
            <q-th v-if="colspan.COGS.COGS2Show && display_hierarchy_type_value != 'Total Divisions'" style="min-width: 60px;border-top:1px solid black;border-bottom:1px solid black;border-right: 1px solid black;" @click="handleSortingColumn('Cogs_details.Cogs_year_to_date.Cogs_LY_amount')">LY <q-icon v-if="active_sorting_column == 'Cogs_details.Cogs_year_to_date.Cogs_LY_amount'" style="font-size: 13px;" :class="[active_sorting_column_asc ? 'flip_down' : 'flip_up']" name="filter_list" /></q-th>
        ...
        <q-tr :props="props">
            ...
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="border-bottom: 0px;"><span v-if="amount_type">$'000</span> <span v-else>$</span></q-th>
            <q-th v-if="colspan.COGS.COGSShow && display_hierarchy_type_value != 'Total Divisions'" style="border-bottom: 0px;"><span v-if="amount_type">$'000</span> <span v-else>$</span></q-th>
            <q-th v-if="display_hierarchy_type_value != 'Total Divisions'" style="border-bottom: 0px;"><span v-if="amount_type">$'000</span> <span v-else>$</span></q-th>
            <q-th v-if="colspan.COGS.COGS2Show && display_hierarchy_type_value != 'Total Divisions'" style="border-bottom: 0px;border-right: 1px solid black;"><span v-if="amount_type">$'000</span> <span v-else>$</span></q-th>
      ...
      <!-- <template v-slot:top-row>
        ...
        <template v-slot:body="props">
            ...
            <q-tr v-if="json_data.Department.length <= 0">
                <q-td colspan="1"></q-td>
                <q-td :colspan="colspan.COGS.COGSShow ? 55 : 52" style="border: 1px solid black;text-align: center; font-weight: bold;">No data</q-td>
            </q-tr>
            ...
            <template v-for="(division_details, index) in json_data.Department" :key="division_details">
                ...
                <template v-for="(data_details, data_index) in division_details.Data" :key="data_index">
                    ...
                    <q-tr :props="props" :style="[data_details.Summary == 1 ? 'background-color: #e9e9e9;' : (data_details.Summary == 0 ? 'background-color: #c9c9c9;' : '') ]">
                        ...
                        <q-td :style="['border: 0px;','position:sticky;left: 20px;z-index:100;', data_details.Summary > 0 ? 'font-style: normal;text-align: center;background-color: #e9e9e9;' : 'background-color: white;']">{{data_details.Title}}</q-td>

                        <template v-if="data_details.Details_month_to_date.Sales">
                            <q-td :style="[data_details.Summary == 1 && 'font-style: normal;','font-weight: bold; font-size: 13px; text-align: right;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                            ...
                            <q-td :style="['font-weight: bold; font-size: 13px; font-style: normal;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                        ...
                        <template v-if="data_details.Details_month_to_date.Scan_GP">
                            ...
                            <q-td :style="['font-weight: bold; font-size: 13px; font-style: normal;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                            ...
                            <q-td :style="['font-weight: bold; font-size: 13px; font-style: normal;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                            <q-td style="background-color: white;padding: 0px;"></q-td>
                        </template>
                        ...
                        <template v-if="data_details.Details_month_to_date.Scan_GP">
                            ...
                            <q-td :style="['font-weight: bold; font-size: 13px; font-style: normal;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                            ...
                            <q-td :style="['font-weight: bold; font-size: 13px; font-style: normal;', data_index == 0 ? 'border-top: 1px solid black;' : '']" :class="[data_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(data_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                            <q-td style="background-color: white;padding: 0px;"></q-td>
                        </template>
                        ...
                        <template v-if="data_details.Cogs_details.Cogs_month_to_date && display_hierarchy_type_value != 'Total Divisions'">
                            <q-td :style="[data_details.Summary == 1 && 'font-style: normal;', 'font-weight: bold; font-size: 13px;', data_index == 0 && 'border-top: 1px solid black;']">{{formatAmount(data_details.Cogs_details.Cogs_month_to_date.Cogs_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.COGS.COGSShow" :style="[data_details.Summary == 1 && 'font-style: normal;', 'font-weight: bold; font-size: 13px;', data_index == 0 && 'border-top: 1px solid black;']">{{formatAmount(data_details.Cogs_details.Cogs_month_to_date.Cogs_LY_amount,'$')}}</q-td>
                        </template>

                        <template v-if="data_details.Cogs_details.Cogs_year_to_date && display_hierarchy_type_value != 'Total Divisions'">
                            <q-td :style="[data_details.Summary == 1 && 'font-style: normal;', 'font-weight: bold; font-size: 13px;', data_index == 0 && 'border-top: 1px solid black;']">{{formatAmount(data_details.Cogs_details.Cogs_year_to_date.Cogs_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.COGS.COGS2Show" :style="[data_details.Summary == 1 && 'font-style: normal;', 'font-weight: bold; font-size: 13px;', data_index == 0 && 'border-top: 1px solid black;','border-right: 1px solid black;']">{{formatAmount(data_details.Cogs_details.Cogs_year_to_date.Cogs_LY_amount,'$')}}</q-td>
                        </template>
                    </q-tr>
                ...
                <q-tr :props="props" v-if="division_details.Data.length > 0">
                    ...
                    <q-td style="font-weight: bold;font-size: 13px;border: 0px;position:sticky;left: 20px;z-index:100;background-color:white;">{{division_details.Title}}</q-td>
...
export default {
    ...
    props: ['pass_data','forceLoading','pass_table_title','pass_department_options','hierarchy_type_value','multiple_json', 'closeLoading','index','overwrite_amount_type'],
    methods:{
        ...
        exportToExcel() {
            ...
            setTimeout(()=>{
                ...
                // let table = $('.table_total_division2'+table_class).find('#table_total_division2_id'+table_class);
    ...
    // return numberPart.replace(thousands, ",") + (decimalPart ? "." + decimalPart : "");
        ...
        COGSColumnButtonClick(){
            ...
            var totalNetGP = 2 - (this.colspan.COGS.COGSShow ? 0 : 1);
            // this.colspan.COGS.COGSmain = totalNetGP;
            this.colspan.COGS.COGS = totalNetGP;
            // this.calculateYearColspan();
        },
        COGS2ColumnButtonClick(){

            if(this.colspan.COGS.COGS2Show == true)
            {
                this.colspan.COGS.COGS2Show = false;
                this.colspan.COGS.COGS2Icon = 'add';
            }
            else
            {
                this.colspan.COGS.COGS2Show = true;
                this.colspan.COGS.COGS2Icon = 'remove';
            }

            var totalNetGP = 2 - (this.colspan.COGS.COGS2Show ? 0 : 1);
            // this.colspan.COGS.COGSmain = totalNetGP;
            this.colspan.COGS.COGS2 = totalNetGP;
            // this.calculateYearColspan();
        },
    },
    created () {
    ...
    {   
        ...
        // $('.table_total_division2').find('.q-table').attr('id','table_total_division2_id');
...
.table_total_division2 > .q-table__middle > .q-table > tbody > tr > td:nth-child(n+3) {
    text-align: right;
}
