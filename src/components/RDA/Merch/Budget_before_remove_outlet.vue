...
<!-- 
            ...
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_month_to_date.Sales_TY_amount')">TY</q-th>
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_month_to_date.Budget_TY_amount')">BUD</q-th>
            <q-th colspan="2" style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_month_to_date.vsBud')">vs Bud</q-th>
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_month_to_date.Sales_LY_amount')">LY</q-th>
            <q-th colspan="2" style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_month_to_date.vsLY')">vs LY</q-th>
            ...
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_year_to_date.Sales_TY_amount')">TY</q-th>
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_year_to_date.Budget_TY_amount')">BUD</q-th>
            <q-th colspan="2" style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_year_to_date.vsBud')">vs BUD</q-th>
            <q-th style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_year_to_date.Sales_LY_amount')">LY</q-th>
            <q-th colspan="2" style="min-width: 60px;border-top:1px solid black;border-bottom: 1px solid black;text-align: center;" @click="handleSortingColumn('Details_year_to_date.vsLY')">vs LY</q-th>
      ...
      <!-- <template v-slot:top-row>
        ...
        <template v-slot:body="props">
            ...
            <template v-for="(store_details, index) in json_data.Stores" :key="store_details">
                ...
                <q-tr :class="[index+1 == json_data.Stores.length && 'last_row table_row', 'table_row']">
                    ...
                    <template v-if="store_details.Details_year_to_date">
                        ...
                        <q-td :style="['padding-left: 2px;padding-left: 2px;',store_details.Details_year_to_date.vsLY >= -1 && store_details.Details_year_to_date.vsLY <= 1 ? 'color: #f8db8f;' : (store_details.Details_year_to_date.vsLY  > 1 ? 'color: green;' : store_details.Details_month_to_date.vsLY < -1 && 'color:red;')]"><center><char style="font-size: 15pt;">&#x25CF;</char></center></q-td>
                    </template>
            ...
            <q-tr v-if="json_data.Closed_Stores.length > 0">
                ...
                <q-td style="border: 0px; padding: 0px; baclground-color: white;"></q-td>
                <q-td colspan="7" style="border-bottom: 1px solid black; border-left: 0px; "></q-td>
                <q-td colspan="1" style="border: 0px; padding: 0px;"></q-td>
                <q-td colspan="1" style="border-bottom: 1px solid black; border-left: 0px; "></q-td>
                <q-td colspan="1" style="border: 0px; padding: 0px;"></q-td>
                <q-td colspan="7" style="border-bottom: 1px solid black; border-left: 0px; "></q-td>
            </q-tr>
            ...
            <template v-for="(total_store_details, index) in json_data.Total_Stores" :key="total_store_details">
                ...
                <q-tr class="table_row_third">
                    ...
                    <template v-if="total_store_details.Details_month_to_date">
                        ...
                        <q-td :style="['background-color: white; padding-left: 2px;padding-left: 2px;',total_store_details.Details_month_to_date.vsBud >= -1 && total_store_details.Details_month_to_date.vsBud <= 1 ? 'color: #f8db8f;' : (total_store_details.Details_month_to_date.vsBud  > 1 ? 'color: green;' : total_store_details.Details_month_to_date.vsBud < -1 && 'color:red;')]"><center><char style="font-size: 15pt;">&#x25CF;</char></center></q-td>
                        ...
                        <q-td :style="['background-color: white; padding-left: 2px;padding-left: 2px;border-right: 1px solid black;',total_store_details.Details_month_to_date.vsLY >= -1 && total_store_details.Details_month_to_date.vsLY <= 1 ? 'color: #f8db8f;' : (total_store_details.Details_month_to_date.vsLY  > 1 ? 'color: green;' : total_store_details.Details_month_to_date.vsLY < -1 && 'color:red;')]"><center><char style="font-size: 15pt;">&#x25CF;</char></center></q-td>
                    </template>
                    ...
                    <template v-if="total_store_details.Details_year_to_date">
                        ...
                        <q-td :style="['background-color: white; padding-left: 2px;padding-left: 2px;',total_store_details.Details_year_to_date.vsBud >= -1 && total_store_details.Details_year_to_date.vsBud <= 1 ? 'color: #f8db8f;' : (total_store_details.Details_year_to_date.vsBud  > 1 ? 'color: green;' : total_store_details.Details_year_to_date.vsBud < -1 && 'color:red;')]"><center><char style="font-size: 15pt;">&#x25CF;</char></center></q-td>
                        ...
                        <q-td :style="['background-color: white;padding-left: 2px;padding-left: 2px;',total_store_details.Details_year_to_date.vsLY >= -1 && total_store_details.Details_year_to_date.vsLY <= 1 ? 'color: #f8db8f;' : (total_store_details.Details_year_to_date.vsLY  > 1 ? 'color: green;' : total_store_details.Details_month_to_date.vsLY < -1 && 'color:red;')]"><center><char style="font-size: 15pt;">&#x25CF;</char></center></q-td>
                    </template>
            ...
            <q-tr v-if="json_data.Total_LFL_Stores.length > 0">
                <q-td colspan="7" style="border: 0px;position: sticky; left: 0px; z-index: 119; background-color: white;"></q-td>  
                <q-td colspan="7" style="border-bottom: 1px solid black; border-left: 0px;"></q-td>
                <q-td colspan="3" style="border: 0px;"></q-td>
                <q-td colspan="7" style="border: 0px;"></q-td>  
            </q-tr>
...
export default {
    ...
    methods:{
        handleSortingColumn(key)
        {
            ...
            console.log(this.active_sorting_column);
