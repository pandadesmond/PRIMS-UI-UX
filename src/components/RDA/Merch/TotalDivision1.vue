      ...
      <!-- <template v-slot:top-row>
        ...
        <template v-slot:body="props">
            ...
            <q-tr v-if="json_data.Division.length <= 0">
                <q-td colspan="1"></q-td>
                <q-td colspan="55" style="border: 1px solid black; text-align: center; font-weight: bold;">No data</q-td>
            </q-tr>
...
export default {
    ...
    props: ['pass_data','forceLoading','pass_table_title','pass_store_options','pass_cohort_options','pass_state_options','pass_am_options','multiple_json','closeLoading','index','overwrite_amount_type'],
    methods:{
        ...
        exportToExcel() {
            ...
            setTimeout(()=>{
                ...
                // let table = $('.table_total_division1'+table_class).find('#table_total_division1_id');
