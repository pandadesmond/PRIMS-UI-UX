<template>
   ...
   <div  style="overflow-x: auto; padding-left: 16px; padding-right: 16px; width: 100%;">
    ...
    <q-table :class="['table_total_sales', , css_show ? '' : 'hide_class']"
      :title="table_title"
      separator="vertical"
      :dense="true"
        :rows="rows"
            ...
            <template v-for="(division_details, index) in json_data.Division" :key="division_details">
                ...
                <q-tr :props="props">
                    ...
                    <template v-if="division_details.Details_month_to_date.Sales">
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                        <q-td v-if="colspan.MonthToDate.SalesShow" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                    ...
                    <template v-if="division_details.Details_month_to_date.Scan_GP">
                        <q-td v-if="colspan.MonthToDate.ScanGPShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.MonthToDate.ScanGPShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_month_to_date.Shrinkage">
                        <q-td v-if="colspan.MonthToDate.ShrinkageShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.MonthToDate.ShrinkageShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_month_to_date.Net_GP">
                        <q-td v-if="colspan.MonthToDate.NetGPShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.MonthToDate.NetGPShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_month_to_date.Stock">
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                        <q-td v-if="colspan.MonthToDate.StockShow" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_month_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_month_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{division_details.Details_month_to_date.Stock.Stock_TY_days}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_month_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{division_details.Details_month_to_date.Stock.Stock_LY_days}}</q-td>
                    </template>

                    <q-td style="border-top: 0px;border-bottom:0px;"></q-td>

                    <template v-if="division_details.Details_year_to_date.Sales">
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                        <q-td v-if="colspan.YearToDate.SalesShow" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_year_to_date.Scan_GP">
                        <q-td v-if="colspan.YearToDate.ScanGPShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.YearToDate.ScanGPShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_year_to_date.Shrinkage">
                        <q-td v-if="colspan.YearToDate.ShrinkageShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.YearToDate.ShrinkageShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_year_to_date.Net_GP">
                        <q-td v-if="colspan.YearToDate.NetGPShow1" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                        <q-td v-if="colspan.YearToDate.NetGPShow2" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                    </template>

                    <template v-if="division_details.Details_year_to_date.Stock">
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                        <q-td v-if="colspan.YearToDate.StockShow" style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold; font-style: normal;" :class="[division_details.Details_year_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(division_details.Details_year_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; font-weight: bold;" :class="[division_details.Details_year_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{division_details.Details_year_to_date.Stock.Stock_TY_days}}</q-td>
                        <q-td style="font-size: 13px; font-weight: bold;border-right: 1px solid black;" :class="[division_details.Details_year_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{division_details.Details_year_to_date.Stock.Stock_LY_days}}</q-td>
                    </template>
                ...
                <template v-for="child_details in division_details.Child" :key="child_details">
                    ...
                    <q-tr v-if="child_details.Details_month_to_date.Sales" :props="props" :style="[child_details.Custom == 1 ? 'background-color: #e9e9e9;' : (child_details.Custom == 0 ? 'background-color: #c9c9c9;' : '') ]">
                        ...
                        <q-td style="border: 0px;background-color: white;position:sticky;left: 20px;z-index:100;"></q-td>
                        <q-td :style="[child_details ? (child_details.Custom == 1 ? 'text-align:center;font-style: normal;' : 'padding-left:13px;font-style: normal;') : '','border: 0px;','position:sticky;left: 50px;z-index:100;']">{{child_details.Title}}</q-td>
                        
                        <template v-if="child_details.Details_month_to_date.Sales">
                        <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Sales ? (child_details.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                        <q-td v-if="colspan.MonthToDate.SalesShow" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Sales ? (child_details.Details_month_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                        <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Sales ? (child_details.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                        <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_month_to_date.Scan_GP">
                            <q-td v-if="colspan.MonthToDate.ScanGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Scan_GP ? (child_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Scan_GP ? (child_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.MonthToDate.ScanGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Scan_GP ? (child_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Scan_GP ? (child_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_month_to_date.Shrinkage">
                            <q-td v-if="colspan.MonthToDate.ShrinkageShow1" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Shrinkage ? (child_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Shrinkage ? (child_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.MonthToDate.ShrinkageShow2" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Shrinkage ? (child_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Shrinkage ? (child_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_month_to_date.Net_GP">
                            <q-td v-if="colspan.MonthToDate.NetGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Net_GP ? (child_details.Details_month_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Net_GP ? (child_details.Details_month_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.MonthToDate.NetGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Net_GP ? (child_details.Details_month_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Net_GP ? (child_details.Details_month_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_month_to_date.Stock">
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Stock ? (child_details.Details_month_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.MonthToDate.StockShow" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Stock ? (child_details.Details_month_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Stock ? (child_details.Details_month_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_month_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Stock ? (child_details.Details_month_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '') : '']">{{child_details.Details_month_to_date.Stock.Stock_TY_days}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Stock ? (child_details.Details_month_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '') : '']">{{child_details.Details_month_to_date.Stock.Stock_LY_days}}</q-td>
                        </template>
                        ...
                        <template v-if="child_details.Details_year_to_date.Sales">
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_month_to_date.Sales ? (child_details.Details_year_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.YearToDate.SalesShow" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Sales ? (child_details.Details_year_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Sales ? (child_details.Details_year_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>
<!-- until here-->
                        <template v-if="child_details.Details_year_to_date.Scan_GP">
                            <q-td v-if="colspan.YearToDate.ScanGPShow1" style="font-size: 13px; font-style: normal;" :class=" [child_details.Details_year_to_date.Scan_GP ? (child_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class=" [child_details.Details_year_to_date.Scan_GP ? (child_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.YearToDate.ScanGPShow2" style="font-size: 13px; font-style: normal;" :class=" [child_details.Details_year_to_date.Scan_GP ? (child_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class=" [child_details.Details_year_to_date.Scan_GP ? (child_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_year_to_date.Shrinkage">
                            <q-td v-if="colspan.YearToDate.ShrinkageShow1" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Shrinkage ? (child_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Shrinkage ? (child_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.YearToDate.ShrinkageShow2" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Shrinkage ? (child_details.Details_year_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Shrinkage ? (child_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_year_to_date.Net_GP">
                            <q-td v-if="colspan.YearToDate.NetGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Net_GP ? (child_details.Details_year_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Net_GP ? (child_details.Details_year_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                            <q-td v-if="colspan.YearToDate.NetGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Net_GP ? (child_details.Details_year_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Net_GP ? (child_details.Details_year_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                        </template>

                        <template v-if="child_details.Details_year_to_date.Stock">
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Stock ? (child_details.Details_year_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.YearToDate.StockShow" style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Stock ? (child_details.Details_year_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Stock ? (child_details.Details_year_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details.Details_year_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details.Details_year_to_date.Stock ? (child_details.Details_year_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '') : '']">{{child_details.Details_year_to_date.Stock.Stock_TY_days}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;border-right: 1px solid black;" :class="[child_details.Details_year_to_date.Stock ? (child_details.Details_year_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '') : '']">{{child_details.Details_year_to_date.Stock.Stock_LY_days}}</q-td>
                        </template>
                    </q-tr>

                    <template v-for="child_details_layer in child_details.Child" :key="child_details_layer">

                        <q-tr v-if="child_details_layer.Details_month_to_date.Sales" :props="props" :style="[child_details_layer.Custom == 1 ? 'background-color: #e9e9e9;' : (child_details_layer.Custom == 0 ? 'background-color: #c9c9c9;' : '') ]">
                            
                            <q-td style="background-color: white;position: sticky; left: 0;z-index: 100;">{{child_details_layer.code}}</q-td>
                            <q-td style="border: 0px;background-color: white;position:sticky;left: 20px;z-index:100;"></q-td>
                            <q-td :style="[child_details_layer ? (child_details_layer.Custom == 1 ? 'text-align:center;font-style: normal;' : 'padding-left:13px;font-style: normal;') : '','border: 0px;','position:sticky;left: 50px;z-index:100;']">{{child_details_layer.Title}}</q-td>
                            
                            <template v-if="child_details_layer.Details_month_to_date.Sales">
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Sales ? (child_details_layer.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                            <q-td v-if="colspan.MonthToDate.SalesShow" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Sales ? (child_details_layer.Details_month_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                            <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Sales ? (child_details_layer.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                            <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_month_to_date.Scan_GP">
                                <q-td v-if="colspan.MonthToDate.ScanGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Scan_GP ? (child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Scan_GP ? (child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.MonthToDate.ScanGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Scan_GP ? (child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Scan_GP ? (child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_month_to_date.Shrinkage">
                                <q-td v-if="colspan.MonthToDate.ShrinkageShow1" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Shrinkage ? (child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Shrinkage ? (child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.MonthToDate.ShrinkageShow2" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Shrinkage ? (child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Shrinkage ? (child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_month_to_date.Net_GP">
                                <q-td v-if="colspan.MonthToDate.NetGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Net_GP ? (child_details_layer.Details_month_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Net_GP ? (child_details_layer.Details_month_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.MonthToDate.NetGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Net_GP ? (child_details_layer.Details_month_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Net_GP ? (child_details_layer.Details_month_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_month_to_date.Stock">
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Stock ? (child_details_layer.Details_month_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                                <q-td v-if="colspan.MonthToDate.StockShow" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Stock ? (child_details_layer.Details_month_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Stock ? (child_details_layer.Details_month_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_month_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Stock ? (child_details_layer.Details_month_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '') : '']">{{child_details_layer.Details_month_to_date.Stock.Stock_TY_days}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Stock ? (child_details_layer.Details_month_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '') : '']">{{child_details_layer.Details_month_to_date.Stock.Stock_LY_days}}</q-td>
                            </template>

                            <q-td style="border-top: 0px;border-bottom:0px;background-color: white;"></q-td>
                            
                            <template v-if="child_details_layer.Details_year_to_date.Sales">
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_month_to_date.Sales ? (child_details_layer.Details_year_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                                <q-td v-if="colspan.YearToDate.SalesShow" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Sales ? (child_details_layer.Details_year_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Sales ? (child_details_layer.Details_year_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_year_to_date.Scan_GP">
                                <q-td v-if="colspan.YearToDate.ScanGPShow1" style="font-size: 13px; font-style: normal;" :class=" [child_details_layer.Details_year_to_date.Scan_GP ? (child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class=" [child_details_layer.Details_year_to_date.Scan_GP ? (child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.YearToDate.ScanGPShow2" style="font-size: 13px; font-style: normal;" :class=" [child_details_layer.Details_year_to_date.Scan_GP ? (child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class=" [child_details_layer.Details_year_to_date.Scan_GP ? (child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '' ) : '']">{{formatAmount(child_details_layer.Details_year_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_year_to_date.Shrinkage">
                                <q-td v-if="colspan.YearToDate.ShrinkageShow1" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Shrinkage ? (child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Shrinkage ? (child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.YearToDate.ShrinkageShow2" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Shrinkage ? (child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Shrinkage ? (child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_year_to_date.Net_GP">
                                <q-td v-if="colspan.YearToDate.NetGPShow1" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Net_GP ? (child_details_layer.Details_year_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Net_GP ? (child_details_layer.Details_year_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                                <q-td v-if="colspan.YearToDate.NetGPShow2" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Net_GP ? (child_details_layer.Details_year_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Net_GP ? (child_details_layer.Details_year_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>
                            </template>

                            <template v-if="child_details_layer.Details_year_to_date.Stock">
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Stock ? (child_details_layer.Details_year_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                                <q-td v-if="colspan.YearToDate.StockShow" style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Stock ? (child_details_layer.Details_year_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Stock ? (child_details_layer.Details_year_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                                <q-td style="font-size: 13px; font-style: normal;" :class="[child_details_layer.Details_year_to_date.Stock ? (child_details_layer.Details_year_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Stock.Stock_TY_days,'$')}}</q-td>
                                <q-td style="font-size: 13px; font-style: normal;border-right: 1px solid black;" :class="[child_details_layer.Details_year_to_date.Stock ? (child_details_layer.Details_year_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '') : '']">{{formatAmount(child_details_layer.Details_year_to_date.Stock.Stock_LY_days,'$')}}</q-td>
                            </template>
                        </q-tr>
                    </template>
            ...
            <!-- <template v-for="(division_total_details, division_index) in json_data.Division_Total" :key="division_total_details">
                <q-tr :props="props">
                    ...
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                    <q-td v-if="colspan.MonthToDate.SalesShow" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Sales.Sales_vsLY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.MonthToDate.ScanGPShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Scan_GP.Scan_GP_TY_percent}}%</q-td>
                    <q-td v-if="colspan.MonthToDate.ScanGPShow2" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Scan_GP.Scan_GP_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.MonthToDate.ShrinkageShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Shrinkage.Shrinkage_TY_percent}}%</q-td>
                    <q-td v-if="colspan.MonthToDate.ShrinkageShow2" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Shrinkage.Shrinkage_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.MonthToDate.NetGPShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Net_GP.Net_GP_TY_percent}}%</q-td>
                    <q-td v-if="colspan.MonthToDate.NetGPShow2" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Net_GP.Net_GP_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                    <q-td v-if="colspan.MonthToDate.StockShow" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_month_to_date.Stock.Stock_vsLY_percent}}%</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Stock.Stock_TY_days,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_month_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_month_to_date.Stock.Stock_LY_days,'$')}}</q-td>

                    <q-td style="border-top: 0px;border-bottom:0px;"></q-td>

                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                    <q-td v-if="colspan.YearToDate.SalesShow" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Sales.Sales_vsLY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.YearToDate.ScanGPShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Scan_GP.Scan_GP_TY_percent}}%</q-td>
                    <q-td v-if="colspan.YearToDate.ScanGPShow2" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Scan_GP.Scan_GP_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.YearToDate.ShrinkageShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Shrinkage.Shrinkage_TY_percent}}%</q-td>
                    ...
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Shrinkage.Shrinkage_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td v-if="colspan.YearToDate.NetGPShow1" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Net_GP.Net_GP_TY_percent}}%</q-td>
                    <q-td v-if="colspan.YearToDate.NetGPShow2" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Net_GP.Net_GP_LY_percent}}%</q-td>
                    <q-td style="background-color: white;padding: 0px;"></q-td>

                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                    <q-td v-if="colspan.YearToDate.StockShow" style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{division_total_details.Details_year_to_date.Stock.Stock_vsLY_percent}}%</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[division_total_details.Details_year_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Stock.Stock_TY_days,'$')}}</q-td>
                    <q-td style="font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;" :class="[division_total_details.Details_year_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{formatAmount(division_total_details.Details_year_to_date.Stock.Stock_LY_days,'$')}}</q-td>
                </q-tr>
            </template> -->
            ...
            <q-tr v-if="json_data.Division_Total.Details_month_to_date" :props="props" style="font-weight: bold;">
                ...
                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                <q-td v-if="colspan.MonthToDate.SalesShow" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.MonthToDate.ScanGPShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                <q-td v-if="colspan.MonthToDate.ScanGPShow2" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal;border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.MonthToDate.ShrinkageShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                <q-td v-if="colspan.MonthToDate.ShrinkageShow2" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.MonthToDate.NetGPShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                <q-td v-if="colspan.MonthToDate.NetGPShow2" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                <q-td v-if="colspan.MonthToDate.StockShow" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_month_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{json_data.Division_Total.Details_month_to_date.Stock.Stock_TY_days}}</q-td>
                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_month_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{json_data.Division_Total.Details_month_to_date.Stock.Stock_LY_days}}</q-td>

                <q-td style="border-top: 0px;border-bottom:0px;"></q-td>

                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Sales.Sales_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Sales.Sales_TY_amount,'$')}}</q-td>
                <q-td v-if="colspan.YearToDate.SalesShow" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Sales.Sales_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Sales.Sales_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Sales.Sales_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Sales.Sales_vsLY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.YearToDate.ScanGPShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_TY_percent,'%')}}%</q-td>
                <q-td v-if="colspan.YearToDate.ScanGPShow2" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Scan_GP.Scan_GP_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.YearToDate.ShrinkageShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_TY_percent,'%')}}%</q-td>
                ...
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Shrinkage.Shrinkage_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td v-if="colspan.YearToDate.NetGPShow1" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_TY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_TY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_TY_percent,'%')}}%</q-td>
                <q-td v-if="colspan.YearToDate.NetGPShow2" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_LY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Net_GP.Net_GP_LY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; background-color: white;padding: 0px;"></q-td>

                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Stock.Stock_TY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Stock.Stock_TY_amount,'$')}}</q-td>
                <q-td v-if="colspan.YearToDate.StockShow" style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Stock.Stock_LY_amount < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Stock.Stock_LY_amount,'$')}}</q-td>
                <q-td style="font-size: 13px; font-style: normal; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Stock.Stock_vsLY_percent < 0 ? 'negative_value' : '']">{{formatAmount(json_data.Division_Total.Details_year_to_date.Stock.Stock_vsLY_percent,'%')}}%</q-td>
                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Stock.Stock_TY_days < 0 ? 'negative_value' : '']">{{json_data.Division_Total.Details_year_to_date.Stock.Stock_TY_days}}</q-td>
                <q-td style="font-size: 13px; border-bottom: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;" :class="[json_data.Division_Total.Details_year_to_date.Stock.Stock_LY_days < 0 ? 'negative_value' : '']">{{json_data.Division_Total.Details_year_to_date.Stock.Stock_LY_days}}</q-td>
            </q-tr>
            ...
            <q-tr :props="props">
                ...
                <q-td style="background-color: black; color: white;position:sticky;left: 20px;z-index:100; font-weight: bold;">
                    ...
                    <!-- <q-btn v-if="second_division_value.length > 0" dense color="white" round icon="filter_alt" flat style="font-size: 10px;margin-top: 5px;"> -->
...
export default {
    data()
    {
        return{
            ...
            css_show: this.expand_status ? this.expand_status : true,//to determine if expand status no pass threat as normal component will default display
    ...
    props: ['pass_data','forceLoading','pass_table_title', 'pass_division_options', 'pass_second_division_options', 'pass_second_department_options', 'small_title', 'expand_status','overwrite_amount_type'],
    methods:{
