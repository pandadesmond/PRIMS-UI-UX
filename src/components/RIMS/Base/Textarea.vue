<template>
    <Textarea autocomplete="off" :id="id" :name="name" v-model="pass_value" :no_label="true" :componentBehavior="dbComponentBehavior" />
</template>
...
export default {
    ...
    props: ['text', 'value', 'dbComponentBehavior', 'id', 'name', 'type', 'no_label'],
    components: {
        Textarea,
    },
    watch:{
