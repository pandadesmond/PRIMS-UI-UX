    ...
    <!-- <div class="row"> -->
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
            <div class="component_div" v-if="json">
                ...
                <Input :no_label="json_container.no_label" :autofocusclick="true" :readonly="json_container.readonly ? true : false" v-on:change="handleChange" v-model="json_container.input1" 
