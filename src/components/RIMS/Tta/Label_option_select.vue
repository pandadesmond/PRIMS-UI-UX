        ...
        <div class="component_div custom_select" v-if="json_container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
                        <Select :no_label="true" :readonly="json_container.readonly ? true : false" v-on:receiveChange="handleChangePrefix2" v-model="json_container.prefix2.value" :options="json.prefix2.options" 
