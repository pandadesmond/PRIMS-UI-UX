...
<div class="row" style="margin:2px;margin-bottom: 10px;">
    ...
    <!-- <div class="col-xs-2" style="padding-left: 3px;">
        <Label :text="json_container.label1" style="text-align:center;margin-right:3px;padding-right:10px;" />
    </div> -->

    <!-- {{json_container.pass_json}} -->

<!-- {{json_container.pass_json}} -->
    <template v-for="json_details in json_container.pass_json" :key="json_details">
        
        <!-- <div class="col-xs-2">
            <div class="row">
                <div class="col-xs-2" :style="[row_value.style]" v-for="row_value in value" :key="row_value">
                    <Basiclabel :text="row_value.value" />
                </div>
            </div>
        </div> -->
        <!-- {{json_container}} -->
<!-- {{json_details}} -->
        <template v-for="(value, header) in json_details" :key="header">
            <div class="col-xs-2" style="padding-bottom: 5px;padding-left: 3px;" v-if="header == 'label'">
                <!-- <div class="row"> -->
                    <!-- <div class="col-xs-2" :style="[row_value.style]" v-for="row_value in value" :key="row_value"> -->
                        <Label :text="value" style="text-align:center;padding-right:10px;" />
                    <!-- </div> -->
                <!-- </div> -->
            </div>
        ...
        <!-- <div class="col-xs-5">
            <div class="row">
                <template v-for="json_details2 in json_details.second" :key="json_details2">
                    <div class="col-xs-2">
                        <Basiclabel :text="'test'" style="margin-right:3px;padding-right:10px;" />
                    </div>
                </template>
            </div>
        </div> -->
