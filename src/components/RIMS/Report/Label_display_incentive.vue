...
<div class="row" style="margin:2px;">
    ...
    <div class="col-8" style="text-align:left;">
        <Basiclabel :text="formatpercentage(json_container)" style="margin-right:3px;padding-left:10px;" />
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        formatpercentage(val) {
            ...
            } else if (val.component == 'Label_select') {
